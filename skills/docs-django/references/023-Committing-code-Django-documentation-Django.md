...
Source: https://docs.djangoproject.com/en/dev/internals/contributing/committing-code
...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/internals/contributing/committing-code/)
- [6.0](https://docs.djangoproject.com/en/6.0/internals/contributing/committing-code/)
- [5.2](https://docs.djangoproject.com/en/5.2/internals/contributing/committing-code/)
- [5.1](https://docs.djangoproject.com/en/5.1/internals/contributing/committing-code/)
- [5.0](https://docs.djangoproject.com/en/5.0/internals/contributing/committing-code/)
- [4.2](https://docs.djangoproject.com/en/4.2/internals/contributing/committing-code/)
- [4.1](https://docs.djangoproject.com/en/4.1/internals/contributing/committing-code/)
- [4.0](https://docs.djangoproject.com/en/4.0/internals/contributing/committing-code/)
- [3.2](https://docs.djangoproject.com/en/3.2/internals/contributing/committing-code/)
- [3.1](https://docs.djangoproject.com/en/3.1/internals/contributing/committing-code/)
- [3.0](https://docs.djangoproject.com/en/3.0/internals/contributing/committing-code/)
- [2.2](https://docs.djangoproject.com/en/2.2/internals/contributing/committing-code/)
- [2.1](https://docs.djangoproject.com/en/2.1/internals/contributing/committing-code/)
- [2.0](https://docs.djangoproject.com/en/2.0/internals/contributing/committing-code/)
- [1.11](https://docs.djangoproject.com/en/1.11/internals/contributing/committing-code/)
- [1.10](https://docs.djangoproject.com/en/1.10/internals/contributing/committing-code/)
- [1.9](https://docs.djangoproject.com/en/1.9/internals/contributing/committing-code/)
- [1.8](https://docs.djangoproject.com/en/1.8/internals/contributing/committing-code/)

# Committing code

This section is addressed to the mergers and to anyone interested in knowing
how code gets committed into Django. The [Committing guidelines](#committing-guidelines) apply
...
[Working with Git and GitHub](../writing-code/working-with-git/) instead.
...
the [Supported versions](../../release-process/#supported-versions-policy). A backport consists of cherry-picking a
