...
Source: https://docs.djangoproject.com/en/dev/intro/reusable-apps
...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/intro/reusable-apps/)
...
- [5.0](https://docs.djangoproject.com/en/5.0/intro/reusable-apps/)
...
- [1.9](https://docs.djangoproject.com/en/1.9/intro/reusable-apps/)
- [1.8](https://docs.djangoproject.com/en/1.8/intro/reusable-apps/)

# Advanced tutorial: How to write reusable apps

This advanced tutorial begins where [Tutorial 8](../tutorial08/)
...
on the way already. In [Tutorial 1](../tutorial01/), we saw how we
...
A Python [package](https://docs.python.org/3/glossary.html#term-package "(in Python v3.14)") provides a way of grouping related Python code for
...
You created `djangotutorial/templates` in [Tutorial 7](../tutorial07/), and `polls/templates` in
[Tutorial 3](../tutorial03/). Now perhaps it is clearer why we chose
...
Django with pip](../../topics/install/#installing-official-release). You can install `setuptools`
the same way.
...
1. First, create a parent directory for the package, outside of your Django
   ...
   application packages) *must* be unique in [`INSTALLED_APPS`](../../ref/settings/#std-setting-INSTALLED_APPS).
   Avoid using the same label as any of the Django [contrib packages](../../ref/contrib/), for example `auth`, `admin`, or
   `messages`.
2. Move the `polls` directory into `django-polls` directory, and rename it
   to `django_polls`.
3. Edit `django_polls/apps.py` so that [`name`](../../ref/applications/#django.apps.AppConfig.name "django.apps.AppConfig.name") refers to the
   new module name, add [`label`](../../ref/applications/#django.apps.AppConfig.label "django.apps.AppConfig.label") to give a short name for
   the app, and set [`default_auto_field`](../../ref/applications/#django.apps.AppConfig.default_auto_field "django.apps.AppConfig.default_auto_field") to ensure your
   migrations are not affected by changes to [`DEFAULT_AUTO_FIELD`](../../ref/settings/#std-setting-DEFAULT_AUTO_FIELD)
...
8. It’s optional, but recommended, to include detailed documentation with your
   ...
   Many Python projects, including Django and Python itself, use [Sphinx](https://www.sphinx-doc.org/en/master/usage/quickstart.html) to build
   their documentation. If you choose to use Sphinx you can link back to the
   Django documentation by configuring [Intersphinx](https://www.sphinx-doc.org/en/master/usage/quickstart.html#intersphinx)
...
- Post the package on a public repository, such as [the Python Package Index
  (PyPI)](https://pypi.org/). There is [a good tutorial](https://packaging.python.org/tutorials/packaging-projects/#uploading-the-distribution-archives)
  for doing this.
...
projects. When they do, the best solution is to use [venv](https://docs.python.org/3/tutorial/venv.html "(in Python v3.14)"). This tool allows you to maintain multiple isolated
