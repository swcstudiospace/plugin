...
Source: https://docs.djangoproject.com/en/dev/internals/organization
...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/internals/organization/)
- [6.0](https://docs.djangoproject.com/en/6.0/internals/organization/)
- [5.2](https://docs.djangoproject.com/en/5.2/internals/organization/)
- [5.1](https://docs.djangoproject.com/en/5.1/internals/organization/)
- [5.0](https://docs.djangoproject.com/en/5.0/internals/organization/)
- [4.2](https://docs.djangoproject.com/en/4.2/internals/organization/)
- [4.1](https://docs.djangoproject.com/en/4.1/internals/organization/)
- [4.0](https://docs.djangoproject.com/en/4.0/internals/organization/)
- [3.2](https://docs.djangoproject.com/en/3.2/internals/organization/)
- [3.1](https://docs.djangoproject.com/en/3.1/internals/organization/)
- [3.0](https://docs.djangoproject.com/en/3.0/internals/organization/)
- [2.2](https://docs.djangoproject.com/en/2.2/internals/organization/)
- [2.1](https://docs.djangoproject.com/en/2.1/internals/organization/)
- [2.0](https://docs.djangoproject.com/en/2.0/internals/organization/)
- [1.11](https://docs.djangoproject.com/en/1.11/internals/organization/)
- [1.10](https://docs.djangoproject.com/en/1.10/internals/organization/)
- [1.9](https://docs.djangoproject.com/en/1.9/internals/organization/)
- [1.8](https://docs.djangoproject.com/en/1.8/internals/organization/)
...
[Releasers](https://www.djangoproject.com/foundation/teams/#releasers-team) [build Django releases](../howto-release-django/) and
upload them to the [Python Package Index](https://pypi.org/project/Django/) and to the
[djangoproject.com](https://www.djangoproject.com/download/) website.

### Membership

[The steering council](https://www.djangoproject.com/foundation/teams/#steering-council-team) selects [Releasers](https://www.djangoproject.com/foundation/teams/#releasers-team) as necessary to maintain their
...
1. The steering council directs one of its members to notify the Secretary of
   ...
   appropriate venue – the [Django Forum](https://forum.djangoproject.com/) to announce the election and its
   timeline.
...
4. Registration of candidates close one week after it has opened. One week
   ...
   the roster of candidates to the [Django Forum](https://forum.djangoproject.com/), and the election begins.
...
6. The election conclude one week after it begins. The DSF Board then tally the
   ...
   the [Django Forum](https://forum.djangoproject.com/). The five candidates with the highest vote totals
...
- Determining that they did not possess the qualifications of a member of the
  ...
  members of the steering council, and the [DSF Board](https://www.djangoproject.com/foundation/#board). A valid determination
