...
Source: https://docs.djangoproject.com/en/dev/howto/windows
...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/howto/windows/)
...
- [5.0](https://docs.djangoproject.com/en/5.0/howto/windows/)
...
- [1.9](https://docs.djangoproject.com/en/1.9/howto/windows/)
...
For more details, see [Using Python on Windows](https://docs.python.org/3/using/windows.html "(in Python v3.14)") documentation.
...
Python itself comes with [venv](https://docs.python.org/3/tutorial/venv.html "(in Python v3.14)") for managing
...
See [Get your database running](../../topics/install/#database-installation) for information on database installation
with Django.
...
[`DJANGO_COLORS`](../../ref/django-admin/#envvar-DJANGO_COLORS) to `nocolor`.
...
See [Syntax coloring](../../ref/django-admin/#syntax-coloring) for more information on color settings.
...
- In general, Django assumes that `UTF-8` encoding is used for I/O. This may
  ...
  versions of Python allow setting the [`PYTHONUTF8`](https://docs.python.org/3/using/cmdline.html#envvar-PYTHONUTF8 "(in Python v3.14)") environment
