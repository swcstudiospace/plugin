...
Source: https://docs.djangoproject.com/en/dev/internals/contributing/writing-code/working-with-git
...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/internals/contributing/writing-code/working-with-git/)
- [6.0](https://docs.djangoproject.com/en/6.0/internals/contributing/writing-code/working-with-git/)
- [5.2](https://docs.djangoproject.com/en/5.2/internals/contributing/writing-code/working-with-git/)
- [5.1](https://docs.djangoproject.com/en/5.1/internals/contributing/writing-code/working-with-git/)
- [5.0](https://docs.djangoproject.com/en/5.0/internals/contributing/writing-code/working-with-git/)
- [4.2](https://docs.djangoproject.com/en/4.2/internals/contributing/writing-code/working-with-git/)
- [4.1](https://docs.djangoproject.com/en/4.1/internals/contributing/writing-code/working-with-git/)
- [4.0](https://docs.djangoproject.com/en/4.0/internals/contributing/writing-code/working-with-git/)
- [3.2](https://docs.djangoproject.com/en/3.2/internals/contributing/writing-code/working-with-git/)
- [3.1](https://docs.djangoproject.com/en/3.1/internals/contributing/writing-code/working-with-git/)
- [3.0](https://docs.djangoproject.com/en/3.0/internals/contributing/writing-code/working-with-git/)
- [2.2](https://docs.djangoproject.com/en/2.2/internals/contributing/writing-code/working-with-git/)
- [2.1](https://docs.djangoproject.com/en/2.1/internals/contributing/writing-code/working-with-git/)
- [2.0](https://docs.djangoproject.com/en/2.0/internals/contributing/writing-code/working-with-git/)
- [1.11](https://docs.djangoproject.com/en/1.11/internals/contributing/writing-code/working-with-git/)
- [1.10](https://docs.djangoproject.com/en/1.10/internals/contributing/writing-code/working-with-git/)
- [1.9](https://docs.djangoproject.com/en/1.9/internals/contributing/writing-code/working-with-git/)
- [1.8](https://docs.djangoproject.com/en/1.8/internals/contributing/writing-code/working-with-git/)

# Working with Git and GitHub

This section explains how the community can contribute code to Django via pull
requests. If you’re interested in how [mergers](../../../organization/#mergers-team) handle
them, see [Handling pull requests](../../committing-code/#handling-pull-requests).
...
guidelines](../../committing-code/#committing-guidelines) to ease the work of the merger. If you’re
...
your work is available from branch ticket\_xxxxx of your GitHub repo. Include a
link to your branch.
...
- well-formed messages for each commit: a summary line and then paragraphs
  wrapped at 72 characters thereafter – see the [committing guidelines](../../committing-code/#committing-guidelines) for more details,
...
See [Committing guidelines](../../committing-code/#committing-guidelines) for the required commit message format.
...
Note that this will rewrite history of ticket\_xxxxx - if you check the commit
...
[guidelines for mergers](../../committing-code/#handling-pull-requests).
