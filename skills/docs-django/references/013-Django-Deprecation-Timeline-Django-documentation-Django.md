...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/internals/deprecation/)
- [6.0](https://docs.djangoproject.com/en/6.0/internals/deprecation/)
- [5.2](https://docs.djangoproject.com/en/5.2/internals/deprecation/)
- [5.1](https://docs.djangoproject.com/en/5.1/internals/deprecation/)
- [5.0](https://docs.djangoproject.com/en/5.0/internals/deprecation/)
- [4.2](https://docs.djangoproject.com/en/4.2/internals/deprecation/)
- [4.1](https://docs.djangoproject.com/en/4.1/internals/deprecation/)
- [4.0](https://docs.djangoproject.com/en/4.0/internals/deprecation/)
- [3.2](https://docs.djangoproject.com/en/3.2/internals/deprecation/)
- [3.1](https://docs.djangoproject.com/en/3.1/internals/deprecation/)
- [3.0](https://docs.djangoproject.com/en/3.0/internals/deprecation/)
- [2.2](https://docs.djangoproject.com/en/2.2/internals/deprecation/)
- [2.1](https://docs.djangoproject.com/en/2.1/internals/deprecation/)
- [2.0](https://docs.djangoproject.com/en/2.0/internals/deprecation/)
- [1.11](https://docs.djangoproject.com/en/1.11/internals/deprecation/)
- [1.10](https://docs.djangoproject.com/en/1.10/internals/deprecation/)
- [1.9](https://docs.djangoproject.com/en/1.9/internals/deprecation/)
- [1.8](https://docs.djangoproject.com/en/1.8/internals/deprecation/)
...
[deprecation policy](../release-process/#internal-release-deprecation-policy). More details
about each item can often be found in the release notes of two versions prior.

## 7.1

See the [Django 6.2 release notes](../../releases/6.2/#deprecated-features-6-2) for more
details on these changes.

- The `django.utils.deprecation.MiddlewareMixin` import path will be removed.
  Use `django.middleware.MiddlewareMixin` instead.
- The `safe` parameter of [`JsonResponse`](../../ref/request-response/#django.http.JsonResponse "django.http.JsonResponse") will be removed.
- Calling `QuerySet.aiterator()` after `prefetch_related()` without
  providing a `chunk_size` will raise [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.14)").

## 7.0

See the [Django 6.0 release notes](../../releases/6.0/#deprecated-features-6-0) for more
details on these changes.
...
- The [`django.core.mail`](../../topics/email/#module-django.core.mail "django.core.mail: Helpers to send email.") APIs will no longer accept certain parameters as
...
See the [Django 6.1 release notes](../../releases/6.1/#deprecated-features-6-1) for more
details on these changes.

- Calling [`QuerySet.values_list()`](../../ref/models/querysets/#django.db.models.query.QuerySet.values_list "django.db.models.query.QuerySet.values_list") with `flat=True` and no field name
  will raise `TypeError`.
- The use of `None` when querying a [`JSONField`](../../ref/models/fields/#django.db.models.JSONField "django.db.models.JSONField")
  top-level value will compile to SQL `IS NULL`. Use
  [`JSONNull`](../../ref/models/expressions/#django.db.models.JSONNull "django.db.models.JSONNull") to query for a JSON `null` value
  instead.
...
- The `connection`, `fail_silently`, `auth_user`, and `auth_password`
  arguments will be removed from [`send_mail()`](../../topics/email/#django.core.mail.send_mail "django.core.mail.send_mail"), [`send_mass_mail()`](../../topics/email/#django.core.mail.send_mass_mail "django.core.mail.send_mass_mail"),
  [`mail_admins()`](../../topics/email/#django.core.mail.mail_admins "django.core.mail.mail_admins"), [`mail_managers()`](../../topics/email/#django.core.mail.mail_managers "django.core.mail.mail_managers"), the [`EmailMessage`](../../topics/email/#django.core.mail.EmailMessage "django.core.mail.EmailMessage")
  constructor, and [`EmailMessage.send()`](../../topics/email/#django.core.mail.EmailMessage.send "django.core.mail.EmailMessage.send"). Support for the
...
- The `email_backend` argument of [`log.AdminEmailHandler`](../../ref/logging/#django.utils.log.AdminEmailHandler "django.utils.log.AdminEmailHandler") will be
  removed.
...
- The default value of the `algorithm` argument for
  ...
  `"sha256"`.
- Calling [`QuerySet.select_related()`](../../ref/models/querysets/#django.db.models.query.QuerySet.select_related "django.db.models.query.QuerySet.select_related") without arguments will raise
  [`TypeError`](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.14)").
- [`QuerySet.select_related()`](../../ref/models/querysets/#django.db.models.query.QuerySet.select_related "django.db.models.query.QuerySet.select_related") will raise [`TypeError`](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.14)") if passed
  `True` rather than [`AttributeError`](https://docs.python.org/3/library/exceptions.html#AttributeError "(in Python v3.14)").
- [`ModelAdmin`](../../ref/contrib/admin/#django.contrib.admin.ModelAdmin "django.contrib.admin.ModelAdmin") will raise [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.14)") if subclassed with its
  [`list_select_related`](../../ref/contrib/admin/#django.contrib.admin.ModelAdmin.list_select_related "django.contrib.admin.ModelAdmin.list_select_related") attribute set to `True`.
- [`ModelAdmin`](../../ref/contrib/admin/#django.contrib.admin.ModelAdmin "django.contrib.admin.ModelAdmin") will raise [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.14)") if its
  [`get_list_select_related()`](../../ref/contrib/admin/#django.contrib.admin.ModelAdmin.get_list_select_related "django.contrib.admin.ModelAdmin.get_list_select_related") method returns `True`.
...
- Support for unpacking or indexing the dictionary values of the
  ...
  [`Action`](../../ref/contrib/admin/actions/#django.contrib.admin.Action "django.contrib.admin.Action") attributes instead.
...
See the [Django 5.2 release notes](../../releases/5.2/#deprecated-features-5-2) for more
details on these changes.
...
See the [Django 5.0 release notes](../../releases/5.0/#deprecated-features-5-0) for more
details on these changes.
...
See the [Django 5.1 release notes](../../releases/5.1/#deprecated-features-5-1) for more
details on these changes.
...
- The `OS_OPEN_FLAGS` attribute of
  [`FileSystemStorage`](../../ref/files/storage/#django.core.files.storage.FileSystemStorage "django.core.files.storage.FileSystemStorage") will be removed.
- The `get_cache_name()` method of `FieldCacheMixin` will be removed.

## 5.1

See the [Django 4.2 release notes](../../releases/4.2/#deprecated-features-4-2) for more
details on these changes.
...
See the [Django 4.0 release notes](../../releases/4.0/#deprecated-features-4-0) for more
details on these changes.
...
See the [Django 4.1 release notes](../../releases/4.1/#deprecated-features-4-1) for more
details on these changes.
...
See the [Django 3.2 release notes](../../releases/3.2/#deprecated-features-3-2) for more
details on these changes.
...
See the [Django 3.0 release notes](../../releases/3.0/#deprecated-features-3-0) for more
details on these changes.
...
See the [Django 3.1 release notes](../../releases/3.1/#deprecated-features-3-1) for more
details on these changes.

- The `PASSWORD_RESET_TIMEOUT_DAYS` setting will be removed.
- The undocumented usage of the [`isnull`](../../ref/models/querysets/#std-fieldlookup-isnull) lookup with non-boolean values
...
See the [Django 2.2 release notes](../../releases/2.2/#deprecated-features-2-2) for more
details on these changes.
...
See the [Django 2.0 release notes](../../releases/2.0/#deprecated-features-2-0) for more
details on these changes.
...
See the [Django 2.1 release notes](../../releases/2.1/#deprecated-features-2-1) for more
details on these changes.
...
See the [Django 1.11 release notes](../../releases/1.11/#deprecated-features-1-11) for more
details on these changes.
...
See the [Django 1.9 release notes](../../releases/1.9/#deprecated-features-1-9) for more
details on these changes.
...
See the [Django 1.10 release notes](../../releases/1.10/#deprecated-features-1-10) for more
details on these changes.
...
See the [Django 1.8 release notes](../../releases/1.8/#deprecated-features-1-8) for more
details on these changes.
...
- Support for [`optparse`](https://docs.python.org/3/library/optparse.html#module-optparse "(in Python v3.14)") will be dropped for custom management commands
  (replaced by [`argparse`](https://docs.python.org/3/library/argparse.html#module-argparse "(in Python v3.14)")).
- The class `django.core.management.NoArgsCommand` will be removed. Use
  [`BaseCommand`](../../howto/custom-management-commands/#django.core.management.BaseCommand "django.core.management.BaseCommand") instead, which takes no
...
- The following private APIs will be removed from
  [`django.db.models.options.Options`](../../ref/models/meta/#django.db.models.options.Options "django.db.models.options.Options") (`Model._meta`):
...
- Django template objects returned by
  [`get_template()`](../../topics/templates/#django.template.loader.get_template "django.template.loader.get_template") and
  [`select_template()`](../../topics/templates/#django.template.loader.select_template "django.template.loader.select_template") won’t accept a
  [`Context`](../../ref/templates/api/#django.template.Context "django.template.Context") in their
  [`render()`](../../topics/templates/#django.template.backends.base.Template.render "django.template.backends.base.Template.render") method anymore.
- [Template response APIs](../../ref/template-response/) will enforce the use
  of [`dict`](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)") and backend-dependent template objects instead of
  [`Context`](../../ref/templates/api/#django.template.Context "django.template.Context") and [`Template`](../../ref/templates/api/#django.template.Template "django.template.Template")
  respectively.
...
- Support for the syntax of `{% cycle %}` that uses comma-separated arguments
  will be removed.
- The warning that [`Signer`](../../topics/signing/#django.core.signing.Signer "django.core.signing.Signer") issues when given an
  invalid separator will become an exception.

## 1.9

See the [Django 1.7 release notes](../../releases/1.7/#deprecated-features-1-7) for more
details on these changes.
...
- All models will need to be defined inside an installed application or
  declare an explicit [`app_label`](../../ref/models/options/#django.db.models.Options.app_label "django.db.models.Options.app_label").
...
- `django.utils.datastructures.SortedDict` will be removed. Use
  [`collections.OrderedDict`](https://docs.python.org/3/library/collections.html#collections.OrderedDict "(in Python v3.14)") from the Python standard library instead.
...
- The `--natural` and `-n` options for [`dumpdata`](../../ref/django-admin/#django-admin-dumpdata) will be removed.
...
- `django.core.cache.get_cache` will be removed. Add suitable entries
  to [`CACHES`](../../ref/settings/#std-setting-CACHES) and use [`django.core.cache.caches`](../../topics/cache/#django.core.cache.caches "django.core.cache.caches") instead.
...
- The `cache_choices` option to [`ModelChoiceField`](../../ref/forms/fields/#django.forms.ModelChoiceField "django.forms.ModelChoiceField") and
  [`ModelMultipleChoiceField`](../../ref/forms/fields/#django.forms.ModelMultipleChoiceField "django.forms.ModelMultipleChoiceField") will be removed.
- The default value of the [`RedirectView.permanent`](../../ref/class-based-views/base/#django.views.generic.base.RedirectView.permanent "django.views.generic.base.RedirectView.permanent") attribute will change
  from `True` to `False`.
...
See the [Django 1.6 release notes](../../releases/1.6/#deprecated-features-1-6) for more
details on these changes.
...
- The [`cycle`](../../ref/templates/builtins/#std-templatetag-cycle) and [`firstof`](../../ref/templates/builtins/#std-templatetag-firstof) template tags will auto-escape their
  arguments. In 1.6 and 1.7, this behavior is provided by the version of these
  tags in the `future` template tag library.
- The `SEND_BROKEN_LINK_EMAILS` setting will be removed. Add the
  [`django.middleware.common.BrokenLinkEmailsMiddleware`](../../ref/middleware/#django.middleware.common.BrokenLinkEmailsMiddleware "django.middleware.common.BrokenLinkEmailsMiddleware") middleware to
...
See the [Django 1.5 release notes](../../releases/1.5/#deprecated-features-1-5) for more
details on these changes.

- The module `django.utils.simplejson` will be removed. The standard library
  provides [`json`](https://docs.python.org/3/library/json.html#module-json "(in Python v3.14)") which should be used instead.
- The function `django.utils.itercompat.product` will be removed. The Python
  builtin version should be used instead.
- Auto-correction of INSTALLED\_APPS and TEMPLATE\_DIRS settings when they are
  specified as a plain string instead of a tuple will be removed and raise an
  exception.
- The `mimetype` argument to the `__init__` methods of
  [`HttpResponse`](../../ref/request-response/#django.http.HttpResponse "django.http.HttpResponse"),
  [`SimpleTemplateResponse`](../../ref/template-response/#django.template.response.SimpleTemplateResponse "django.template.response.SimpleTemplateResponse"), and
  [`TemplateResponse`](../../ref/template-response/#django.template.response.TemplateResponse "django.template.response.TemplateResponse"), will be removed.
  `content_type` should be used instead. This also applies to the
  `render_to_response()` shortcut and the sitemap views,
  [`index()`](../../ref/contrib/sitemaps/#django.contrib.sitemaps.views.index "django.contrib.sitemaps.views.index") and
  [`sitemap()`](../../ref/contrib/sitemaps/#django.contrib.sitemaps.views.sitemap "django.contrib.sitemaps.views.sitemap").
- When [`HttpResponse`](../../ref/request-response/#django.http.HttpResponse "django.http.HttpResponse") is instantiated with an iterator,
  or when [`content`](../../ref/request-response/#django.http.HttpResponse.content "django.http.HttpResponse.content") is set to an iterator,
...
- The `depth` keyword argument will be removed from
  [`select_related()`](../../ref/models/querysets/#django.db.models.query.QuerySet.select_related "django.db.models.query.QuerySet.select_related").
- The undocumented `get_warnings_state()`/`restore_warnings_state()`
  functions from [`django.test.utils`](../../topics/testing/advanced/#module-django.test.utils "django.test.utils: Helpers to write custom test runners.") and the `save_warnings_state()`/
  `restore_warnings_state()`
  [django.test.\*TestCase](../../topics/testing/tools/#django-testcase-subclasses) methods are
  deprecated. Use the [`warnings.catch_warnings`](https://docs.python.org/3/library/warnings.html#warnings.catch_warnings "(in Python v3.14)") context manager
  available starting with Python 2.6 instead.
- The undocumented `check_for_test_cookie` method in
  [`AuthenticationForm`](../../topics/auth/default/#django.contrib.auth.forms.AuthenticationForm "django.contrib.auth.forms.AuthenticationForm") will be removed
...
See the [Django 1.4 release notes](../../releases/1.4/#deprecated-features-1-4) for more
details on these changes.
...
- The `IGNORABLE_404_STARTS` and `IGNORABLE_404_ENDS` settings have been
  superseded by [`IGNORABLE_404_URLS`](../../ref/settings/#std-setting-IGNORABLE_404_URLS) in the 1.4 release. They will be
  removed.
...
- Legacy ways of calling
  [`cache_page()`](../../topics/cache/#django.views.decorators.cache.cache_page "django.views.decorators.cache.cache_page") will be removed.
- The backward-compatibility shim to automatically add a debug-false
  ...
  [`LOGGING`](../../ref/settings/#std-setting-LOGGING) setting should include this filter explicitly if
  it is desired.
...
- `django.conf.urls.defaults` will be removed. The functions
  ...
  [`handler404`](../../ref/urls/#django.conf.urls.handler404 "django.conf.urls.handler404") and [`handler500`](../../ref/urls/#django.conf.urls.handler500 "django.conf.urls.handler500")
  are now available through `django.conf.urls`.
- The functions `setup_environ()` and `execute_manager()` will be removed
  from [`django.core.management`](../../howto/custom-management-commands/#module-django.core.management "django.core.management"). This also means that the old (pre-1.4)
...
See the [Django 1.3 release notes](../../releases/1.3/#deprecated-features-1-3) for more
details on these changes.

- Starting Django without a [`SECRET_KEY`](../../ref/settings/#std-setting-SECRET_KEY) will result in an exception
  rather than a `DeprecationWarning`. (This is accelerated from the usual
  deprecation path; see the [Django 1.4 release notes](../../releases/1.4/).)
- The `mod_python` request handler will be removed. The `mod_wsgi`
  handler should be used instead.
- The `template` attribute on `django.test.client.Response`
  objects returned by the [test client](../../topics/testing/tools/#test-client) will be removed.
  The [`templates`](../../topics/testing/tools/#django.test.Response.templates "django.test.Response.templates") attribute should be
  used instead.
- The `django.test.simple.DjangoTestRunner` will be removed.
  ...
  Ctrl-C test termination) can be provided by [`unittest.TextTestRunner`](https://docs.python.org/3/library/unittest.html#unittest.TextTestRunner "(in Python v3.14)").
...
- The function-based generic view modules will be removed in favor of their
  class-based equivalents, outlined [here](../../topics/class-based-views/).
...
- [`transform()`](../../ref/contrib/gis/geos/#django.contrib.gis.geos.GEOSGeometry.transform "django.contrib.gis.geos.GEOSGeometry.transform") will raise
  a [`GEOSException`](../../ref/contrib/gis/geos/#django.contrib.gis.geos.GEOSException "django.contrib.gis.geos.GEOSException") when called
...
- The [`MEDIA_URL`](../../ref/settings/#std-setting-MEDIA_URL) or [`STATIC_URL`](../../ref/settings/#std-setting-STATIC_URL) settings will be
...
- Translations located under the so-called *project path* will be ignored
  ...
  [`LOCALE_PATHS`](../../ref/settings/#std-setting-LOCALE_PATHS) setting can be used for the same task by including
...
- The `CACHE_BACKEND` setting will be removed. The cache backend(s) should be
  specified in the [`CACHES`](../../ref/settings/#std-setting-CACHES) setting.

## 1.4

See the [Django 1.2 release notes](../../releases/1.2/#deprecated-features-1-2) for more
details on these changes.
...
- The `Message` model (in `django.contrib.auth`), its related
  ...
  [messages framework](../../ref/contrib/messages/) should be used
...
See the [Django 1.1 release notes](../../releases/1.1/#deprecated-features-1-1) for more
details on these changes.
