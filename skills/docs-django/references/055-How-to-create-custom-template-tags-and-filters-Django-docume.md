...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/howto/custom-template-tags/)
- [6.0](https://docs.djangoproject.com/en/6.0/howto/custom-template-tags/)
- [5.2](https://docs.djangoproject.com/en/5.2/howto/custom-template-tags/)
- [5.1](https://docs.djangoproject.com/en/5.1/howto/custom-template-tags/)
- [5.0](https://docs.djangoproject.com/en/5.0/howto/custom-template-tags/)
- [4.2](https://docs.djangoproject.com/en/4.2/howto/custom-template-tags/)
- [4.1](https://docs.djangoproject.com/en/4.1/howto/custom-template-tags/)
- [4.0](https://docs.djangoproject.com/en/4.0/howto/custom-template-tags/)
- [3.2](https://docs.djangoproject.com/en/3.2/howto/custom-template-tags/)
- [3.1](https://docs.djangoproject.com/en/3.1/howto/custom-template-tags/)
- [3.0](https://docs.djangoproject.com/en/3.0/howto/custom-template-tags/)
- [2.2](https://docs.djangoproject.com/en/2.2/howto/custom-template-tags/)
- [2.1](https://docs.djangoproject.com/en/2.1/howto/custom-template-tags/)
- [2.0](https://docs.djangoproject.com/en/2.0/howto/custom-template-tags/)
- [1.11](https://docs.djangoproject.com/en/1.11/howto/custom-template-tags/)
- [1.10](https://docs.djangoproject.com/en/1.10/howto/custom-template-tags/)
- [1.9](https://docs.djangoproject.com/en/1.9/howto/custom-template-tags/)
- [1.8](https://docs.djangoproject.com/en/1.8/howto/custom-template-tags/)
...
available to your templates using the [`{% load %}`](../../ref/templates/builtins/#std-templatetag-load) tag.
...
to [`INSTALLED_APPS`](../../ref/settings/#std-setting-INSTALLED_APPS), any tags it defines in the conventional location
...
The app that contains the custom tags must be in [`INSTALLED_APPS`](../../ref/settings/#std-setting-INSTALLED_APPS) in
order for the [`{% load %}`](../../ref/templates/builtins/#std-templatetag-load) tag to work. This is a security feature:
...
Just keep in mind that a [`{% load %}`](../../ref/templates/builtins/#std-templatetag-load) statement will load
...
[`DjangoTemplates`](../../topics/templates/#django.template.backends.django.DjangoTemplates "django.template.backends.django.DjangoTemplates"). This is useful if
...
For more information on the [`load`](../../ref/templates/builtins/#std-templatetag-load) tag, read its documentation.
...
- **Safe strings** are strings that have been marked safe from further
  ...
  [`SafeString`](../../ref/utils/#django.utils.safestring.SafeString "django.utils.safestring.SafeString"). You can test for them
  using code like:
...
2. Alternatively, your filter code can manually take care of any necessary
   ...
   [`django.utils.safestring.mark_safe()`](../../ref/utils/#django.utils.safestring.mark_safe "django.utils.safestring.mark_safe").
...
`urlize_and_linebreaks` that combined the [`urlize`](../../ref/templates/builtins/#std-templatefilter-urlize) and
[`linebreaksbr`](../../ref/templates/builtins/#std-templatefilter-linebreaksbr) filters, the filter would look like:
...
If you write a custom filter that operates on [`datetime`](https://docs.python.org/3/library/datetime.html#datetime.datetime "(in Python v3.14)")
...
conversions in templates](../../topics/i18n/timezones/#time-zones-in-templates).
...
django.template.Library.simple\_tag()
...
[`conditional_escape()`](../../ref/utils/#django.utils.html.conditional_escape "django.utils.html.conditional_escape") if the template context is in
...
[`mark_safe()`](../../ref/utils/#django.utils.safestring.mark_safe "django.utils.safestring.mark_safe") if you are absolutely sure that your
code does not contain XSS vulnerabilities. For building small HTML snippets,
use of [`format_html()`](../../ref/utils/#django.utils.html.format_html "django.utils.html.format_html") instead of `mark_safe()` is
...
django.template.Library.simple\_block\_tag()
...
Similar to [`simple_tag()`](#django.template.Library.simple_tag "django.template.Library.simple_tag"), this function accepts
...
django.template.Library.inclusion\_tag()
...
created in the [tutorials](../../intro/tutorial02/#creating-models). We’ll use the tag like this:
...
[`django.template.Template`](../../ref/templates/api/#django.template.Template "django.template.Template") instance:
...
according to a parameter given in the tag, in [`strftime()`](https://docs.python.org/3/library/time.html#time.strftime "(in Python v3.14)") syntax.
...
[`simple_tag()`](#django.template.Library.simple_tag "django.template.Library.simple_tag") as described above). However, there
...
tag is used inside a [`{% autoescape off %}`](../../ref/templates/builtins/#std-templatetag-autoescape) block.
...
[`cycle`](../../ref/templates/builtins/#std-templatetag-cycle) template tag that cycles among a list of given strings each time
it’s rendered:
...
[`DateTimeField`](../../ref/models/fields/#django.db.models.DateTimeField "django.db.models.DateTimeField") from an object and have the template
...
[`simple_tag()`](#django.template.Library.simple_tag "django.template.Library.simple_tag") shortcut, which supports assigning
the tag results to a template variable.

### Parsing until another block tag

Template tags can work in tandem. For instance, the standard
[`{% comment %}`](../../ref/templates/builtins/#std-templatetag-comment) tag hides everything until `{% endcomment %}`.
...
The actual implementation of [`{% comment %}`](../../ref/templates/builtins/#std-templatetag-comment) is slightly
...
[`{% for %}`](../../ref/templates/builtins/#std-templatetag-for) in [django/template/defaulttags.py](https://github.com/django/django/blob/main/django/template/defaulttags.py) and
[`{% if %}`](../../ref/templates/builtins/#std-templatetag-if) in [django/template/smartif.py](https://github.com/django/django/blob/main/django/template/smartif.py).
