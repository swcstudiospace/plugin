...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/howto/csrf/)
...
- [5.0](https://docs.djangoproject.com/en/5.0/howto/csrf/)
...
1. The CSRF middleware is activated by default in the [`MIDDLEWARE`](../../ref/settings/#std-setting-MIDDLEWARE)
   ...
   [`csrf_protect()`](../../ref/csrf/#django.views.decorators.csrf.csrf_protect "django.views.decorators.csrf.csrf_protect") on particular views
   you want to protect (see below).
2. In any template that uses a POST form, use the [`csrf_token`](../../ref/templates/builtins/#std-templatetag-csrf_token) tag inside
...
3. In the corresponding view functions, ensure that
   [`RequestContext`](../../ref/templates/api/#django.template.RequestContext "django.template.RequestContext") is used to render the response so
   that `{% csrf_token %}` will work properly. If you’re using the
   [`render()`](../../topics/http/shortcuts/#django.shortcuts.render "django.shortcuts.render") function, generic views, or contrib apps,
...
[`CSRF_HEADER_NAME`](../../ref/settings/#std-setting-CSRF_HEADER_NAME) setting) to the value of the CSRF token. This is
...
the [`CSRF_USE_SESSIONS`](../../ref/settings/#std-setting-CSRF_USE_SESSIONS) and [`CSRF_COOKIE_HTTPONLY`](../../ref/settings/#std-setting-CSRF_COOKIE_HTTPONLY) settings
are enabled.

### Acquiring the token if [`CSRF_USE_SESSIONS`](../../ref/settings/#std-setting-CSRF_USE_SESSIONS) and [`CSRF_COOKIE_HTTPONLY`](../../ref/settings/#std-setting-CSRF_COOKIE_HTTPONLY) are `False`
...
the cookie name via the [`CSRF_COOKIE_NAME`](../../ref/settings/#std-setting-CSRF_COOKIE_NAME) setting.
...
explicitly included using [`csrf_token`](../../ref/templates/builtins/#std-templatetag-csrf_token) in a template. The cookie
contains the canonical, unmasked token. The
[`CsrfViewMiddleware`](../../ref/middleware/#django.middleware.csrf.CsrfViewMiddleware "django.middleware.csrf.CsrfViewMiddleware") will accept either.
However, in order to protect against [BREACH](https://www.breachattack.com/) attacks, it’s recommended to
use a masked token.

Warning

If your view is not rendering a template containing the [`csrf_token`](../../ref/templates/builtins/#std-templatetag-csrf_token)
template tag, Django might not set the CSRF token cookie. This is common in
cases where forms are dynamically added to the page. To address this case,
Django provides a view decorator which forces setting of the cookie:
[`ensure_csrf_cookie()`](../../ref/csrf/#django.views.decorators.csrf.ensure_csrf_cookie "django.views.decorators.csrf.ensure_csrf_cookie").

### Acquiring the token if [`CSRF_USE_SESSIONS`](../../ref/settings/#std-setting-CSRF_USE_SESSIONS) or [`CSRF_COOKIE_HTTPONLY`](../../ref/settings/#std-setting-CSRF_COOKIE_HTTPONLY) is `True`

If you activate [`CSRF_USE_SESSIONS`](../../ref/settings/#std-setting-CSRF_USE_SESSIONS) or
[`CSRF_COOKIE_HTTPONLY`](../../ref/settings/#std-setting-CSRF_COOKIE_HTTPONLY), you must include the CSRF token in your HTML
...
Django’s [`Jinja2`](../../topics/templates/#django.template.backends.jinja2.Jinja2 "django.template.backends.jinja2.Jinja2") template backend
...
the [`csrf_protect()`](../../ref/csrf/#django.views.decorators.csrf.csrf_protect "django.views.decorators.csrf.csrf_protect") decorator, which has
...
[`CSRF_FAILURE_VIEW`](../../ref/settings/#std-setting-CSRF_FAILURE_VIEW) setting.

CSRF failures are logged as warnings to the [django.security.csrf](../../ref/logging/#django-security-logger) logger.

## Using CSRF protection with caching

If the [`csrf_token`](../../ref/templates/builtins/#std-templatetag-csrf_token) template tag is used by a template (or the
...
[`django.views.decorators.csrf.csrf_protect()`](../../ref/csrf/#django.views.decorators.csrf.csrf_protect "django.views.decorators.csrf.csrf_protect") decorator first:
...
class-based views](../../topics/class-based-views/intro/#id1).
...
[`csrf_exempt()`](../../ref/csrf/#django.views.decorators.csrf.csrf_exempt "django.views.decorators.csrf.csrf_exempt").
...
Solution: use [`requires_csrf_token()`](../../ref/csrf/#django.views.decorators.csrf.requires_csrf_token "django.views.decorators.csrf.requires_csrf_token")
...
Solution: use [`csrf_exempt()`](../../ref/csrf/#django.views.decorators.csrf.csrf_exempt "django.views.decorators.csrf.csrf_exempt") followed by
[`requires_csrf_token()`](../../ref/csrf/#django.views.decorators.csrf.requires_csrf_token "django.views.decorators.csrf.requires_csrf_token"). (i.e.
...
Solution: use [`csrf_exempt()`](../../ref/csrf/#django.views.decorators.csrf.csrf_exempt "django.views.decorators.csrf.csrf_exempt") for the whole
view function, and [`csrf_protect()`](../../ref/csrf/#django.views.decorators.csrf.csrf_protect "django.views.decorators.csrf.csrf_protect") for the
...
with a [`csrf_token`](../../ref/templates/builtins/#std-templatetag-csrf_token) that would cause the required CSRF cookie to be sent.

Solution: use [`ensure_csrf_cookie()`](../../ref/csrf/#django.views.decorators.csrf.ensure_csrf_cookie "django.views.decorators.csrf.ensure_csrf_cookie") on the
