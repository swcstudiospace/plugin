...
Source: https://docs.djangoproject.com/en/dev/internals/security
...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/internals/security/)
- [6.0](https://docs.djangoproject.com/en/6.0/internals/security/)
...
- [1.9](https://docs.djangoproject.com/en/1.9/internals/security/)
...
Django only [officially supports](../../faq/install/#faq-python-version-support) the latest
...
input. This principle is explained in our [security documentation](../../topics/security/#sanitize-user-input).
...
Similarly, as Django’s raw SQL constructs (such as [`extra()`](../../ref/models/querysets/#django.db.models.query.QuerySet.extra "django.db.models.query.QuerySet.extra"),
[`RawSQL`](../../ref/models/expressions/#django.db.models.expressions.RawSQL "django.db.models.expressions.RawSQL"), and [keyword arguments to database functions](../../ref/models/expressions/#avoiding-sql-injection-in-query-expressions)) provide developers with full
control over the query, they are insecure if user input is not properly
handled. As explained in
our [security documentation](../../topics/security/#sql-injection-protection), it is the
...
[`RemoteUserMiddleware`](../../ref/middleware/#django.contrib.auth.middleware.RemoteUserMiddleware "django.contrib.auth.middleware.RemoteUserMiddleware") is used.

#### The request body must be under 2.5 MB

The [`DATA_UPLOAD_MAX_MEMORY_SIZE`](../../ref/settings/#std-setting-DATA_UPLOAD_MAX_MEMORY_SIZE) setting limits the default maximum
...
- The vulnerability applies to a production-grade Django application. This
  ...
  - Exploits which fail to follow security best practices, such as failure to
    ...
    documentation](../../topics/security/#cross-site-scripting).
...
report it [privately by emailing security@djangoproject.com](#reporting-security-issues). The security team will review your report and
...
- The two most recent Django release series receive security
  ...
  support will end.
- [Long-term support release](../release-process/#term-Long-term-support-release)s will receive security updates for a
  specified period.
...
First, we notify [django-announce](../mailing-lists/#django-announce-mailing-list) of the date and approximate time of the
...
4. Post a notice to the [django-announce](../mailing-lists/#django-announce-mailing-list) and [oss-security@lists.openwall.com](mailto:oss-security%40lists.openwall.com)
...
- A detailed explanation of why you are requesting security notifications.
  ...
  [django-announce](../mailing-lists/#django-announce-mailing-list) to receive advanced notice of when a security release will
