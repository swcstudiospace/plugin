...
Source: https://docs.djangoproject.com/en/dev/internals/contributing/writing-documentation
...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/internals/contributing/writing-documentation/)
- [6.0](https://docs.djangoproject.com/en/6.0/internals/contributing/writing-documentation/)
...
- [1.9](https://docs.djangoproject.com/en/1.9/internals/contributing/writing-documentation/)
...
[Differences between versions](../../../intro/whatsnext/#differences-between-doc-versions)).
...
- [Tutorials](../../../intro/) take the reader by the hand through a series
  ...
  explain afterward.
- [Topic guides](../../../topics/) aim to explain a concept or subject at a
  fairly high level.
...
- [Reference guides](../../../ref/) contain technical references for APIs.
  ...
  topic guide.
- [How-to guides](../../../howto/) are recipes that take the reader through
...
[Installing the development version](../../../topics/install/#installing-development-version)):
...
[sphinx-autobuild](https://pypi.org/project/sphinx-autobuild/) can be used to automatically rebuild the documentation
...
markup, see the [reStructuredText reference](https://www.sphinx-doc.org/en/master/usage/restructuredtext/index.html#rst-index "(in Sphinx v9.1.1)").
...
You’ll need to install [sphinxcontrib-spelling](https://pypi.org/project/sphinxcontrib-spelling/) first. The spell checker
also requires a system-level spell checking backend such as [Aspell](http://aspell.net/). Then from the `docs` directory, run:
...
auto-formatter. This is automatically run by the [pre-commit hook](../writing-code/coding-style/#coding-style-pre-commit) if configured.
...
- Use [`intersphinx`](https://www.sphinx-doc.org/en/master/usage/extensions/intersphinx.html#module-sphinx.ext.intersphinx "(in Sphinx v9.1.1)") to reference Python’s and Sphinx’
  documentation.
...
- Use these heading styles:
  ...
  ^^^^
  ```
- Use [`:rfc:`](https://www.sphinx-doc.org/en/master/usage/restructuredtext/roles.html#role-rfc "(in Sphinx v9.1.1)") to reference a Request for Comments (RFC) and
...
- Use [`:pep:`](https://www.sphinx-doc.org/en/master/usage/restructuredtext/roles.html#role-pep "(in Sphinx v9.1.1)") to reference a Python Enhancement Proposal (PEP)
  and try to link to the relevant section if possible. For example, use
  `` :pep:`20#easter-egg` `` or `` :pep:`Easter Egg <20#easter-egg>` ``.
- Use [`:mimetype:`](https://www.sphinx-doc.org/en/master/usage/restructuredtext/roles.html#role-mimetype "(in Sphinx v9.1.1)") to refer to a MIME Type unless the value
  is quoted for a code example.
- Use [`:envvar:`](https://www.sphinx-doc.org/en/master/usage/referencing.html#role-envvar "(in Sphinx v9.1.1)") to refer to an environment variable. You may
  also need to define a reference to the documentation for that environment
  variable using [`.. envvar::`](https://www.sphinx-doc.org/en/master/usage/domains/standard.html#directive-envvar "(in Sphinx v9.1.1)").
- Use [`:cve:`](https://www.sphinx-doc.org/en/master/usage/restructuredtext/roles.html#role-cve "(in Sphinx v9.1.1)") to reference a Common Vulnerabilities and
...
Besides [Sphinx’s built-in markup](https://www.sphinx-doc.org/en/master/usage/restructuredtext/index.html#rst-index "(in Sphinx v9.1.1)"), Django’s docs
...
- Next, the `topics/settings.txt` document could contain something like
  ...
  We use the Sphinx [`doc`](https://www.sphinx-doc.org/en/master/usage/referencing.html#role-doc "(in Sphinx v9.1.1)") cross-reference element when we want to
  link to another document as a whole and the [`ref`](https://www.sphinx-doc.org/en/master/usage/referencing.html#role-ref "(in Sphinx v9.1.1)") element when
...
See [Localizing the Django documentation](../localizing/#translating-documentation) if
you’d like to help translate the documentation into another language.

## `django-admin` man page

Sphinx can generate a manual page for the [django-admin](../../../ref/django-admin/) command. This is configured in `docs/conf.py`. Unlike
