...
Source: https://docs.djangoproject.com/en/dev/howto/writing-migrations
...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/howto/writing-migrations/)
- [6.0](https://docs.djangoproject.com/en/6.0/howto/writing-migrations/)
- [5.2](https://docs.djangoproject.com/en/5.2/howto/writing-migrations/)
- [5.1](https://docs.djangoproject.com/en/5.1/howto/writing-migrations/)
- [5.0](https://docs.djangoproject.com/en/5.0/howto/writing-migrations/)
- [4.2](https://docs.djangoproject.com/en/4.2/howto/writing-migrations/)
- [4.1](https://docs.djangoproject.com/en/4.1/howto/writing-migrations/)
- [4.0](https://docs.djangoproject.com/en/4.0/howto/writing-migrations/)
- [3.2](https://docs.djangoproject.com/en/3.2/howto/writing-migrations/)
- [3.1](https://docs.djangoproject.com/en/3.1/howto/writing-migrations/)
- [3.0](https://docs.djangoproject.com/en/3.0/howto/writing-migrations/)
- [2.2](https://docs.djangoproject.com/en/2.2/howto/writing-migrations/)
- [2.1](https://docs.djangoproject.com/en/2.1/howto/writing-migrations/)
- [2.0](https://docs.djangoproject.com/en/2.0/howto/writing-migrations/)
- [1.11](https://docs.djangoproject.com/en/1.11/howto/writing-migrations/)
- [1.10](https://docs.djangoproject.com/en/1.10/howto/writing-migrations/)
- [1.9](https://docs.djangoproject.com/en/1.9/howto/writing-migrations/)
- [1.8](https://docs.djangoproject.com/en/1.8/howto/writing-migrations/)

# How to create database migrations

This document explains how to structure and write database migrations for
different scenarios you might encounter. For introductory material on
migrations, see [the topic guide](../../topics/migrations/).
...
You can also provide hints that will be passed to the [`allow_migrate()`](../../topics/db/multi-db/#allow_migrate "allow_migrate")
...
non-nullable [`UUIDField`](../../ref/models/fields/#django.db.models.UUIDField "django.db.models.UUIDField") with a default value. Modify
the respective field according to your needs.

- Add the field on your model with `default=uuid.uuid4` and `unique=True`
  arguments (choose an appropriate default for the type of the field you’re
  adding).
- Run the [`makemigrations`](../../ref/django-admin/#django-admin-makemigrations) command. This should generate a migration
...
- In the first empty migration file, add a
  [`RunPython`](../../ref/migration-operations/#django.db.migrations.operations.RunPython "django.db.migrations.operations.RunPython") or
  [`RunSQL`](../../ref/migration-operations/#django.db.migrations.operations.RunSQL "django.db.migrations.operations.RunSQL") operation to generate a
  ...
  ```
- Now you can apply the migrations as usual with the [`migrate`](../../ref/django-admin/#django-admin-migrate)
  command.
...
[`atomic()`](../../topics/db/transactions/#django.db.transaction.atomic "django.db.transaction.atomic") or by passing `atomic=True` to
`RunPython`.
...
If you’ve used the [`makemigrations`](../../ref/django-admin/#django-admin-makemigrations) command you’ve probably
...
your [`AUTH_USER_MODEL`](../../ref/settings/#std-setting-AUTH_USER_MODEL) replacement.
...
Similarly, you’ll need to catch [`LookupError`](https://docs.python.org/3/library/exceptions.html#LookupError "(in Python v3.14)") in the `apps.get_model()`
...
[`RunPython`](../../ref/migration-operations/#django.db.migrations.operations.RunPython "django.db.migrations.operations.RunPython") operation accordingly.

## Changing a `ManyToManyField` to use a `through` model

If you change a [`ManyToManyField`](../../ref/models/fields/#django.db.models.ManyToManyField "django.db.models.ManyToManyField") to use a `through`
...
[`SeparateDatabaseAndState`](../../ref/migration-operations/#django.db.migrations.operations.SeparateDatabaseAndState "django.db.migrations.operations.SeparateDatabaseAndState") to rename the existing table to the new
...
[`sqlmigrate`](../../ref/django-admin/#django-admin-sqlmigrate) or [`dbshell`](../../ref/django-admin/#django-admin-dbshell). You can check the new table name
...
[`SeparateDatabaseAndState`](../../ref/migration-operations/#django.db.migrations.operations.SeparateDatabaseAndState "django.db.migrations.operations.SeparateDatabaseAndState").
...
If you want to change an unmanaged model ([`managed=False`](../../ref/models/options/#django.db.models.Options.managed "django.db.models.Options.managed")) to managed, you must remove
