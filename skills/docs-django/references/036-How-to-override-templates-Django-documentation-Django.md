...
Source: https://docs.djangoproject.com/en/dev/howto/overriding-templates
...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/howto/overriding-templates/)
...
- [5.0](https://docs.djangoproject.com/en/5.0/howto/overriding-templates/)
...
project-level directory first. In other words, [`DIRS`](../../ref/settings/#std-setting-TEMPLATES-DIRS)
is searched before [`APP_DIRS`](../../ref/settings/#std-setting-TEMPLATES-APP_DIRS).

See also

Read [Overriding built-in widget templates](../../ref/forms/renderers/#overriding-built-in-widget-templates) if you’re looking to
do that.
...
The [`TEMPLATES`](../../ref/settings/#std-setting-TEMPLATES) setting and `BASE_DIR` will already exist if you
created your project using the default project template. The setting that needs
to be modified is [`DIRS`](../../ref/settings/#std-setting-TEMPLATES-DIRS).
...
With [`APP_DIRS`](../../ref/settings/#std-setting-TEMPLATES-APP_DIRS) set to `True`, the template
...
[`{% extends %}`](../../ref/templates/builtins/#std-templatetag-extends) template tag whilst at the same time overriding
