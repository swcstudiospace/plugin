...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/internals/release-process/)
- [6.0](https://docs.djangoproject.com/en/6.0/internals/release-process/)
- [5.2](https://docs.djangoproject.com/en/5.2/internals/release-process/)
- [5.1](https://docs.djangoproject.com/en/5.1/internals/release-process/)
- [5.0](https://docs.djangoproject.com/en/5.0/internals/release-process/)
- [4.2](https://docs.djangoproject.com/en/4.2/internals/release-process/)
- [4.1](https://docs.djangoproject.com/en/4.1/internals/release-process/)
- [4.0](https://docs.djangoproject.com/en/4.0/internals/release-process/)
- [3.2](https://docs.djangoproject.com/en/3.2/internals/release-process/)
- [3.1](https://docs.djangoproject.com/en/3.1/internals/release-process/)
- [3.0](https://docs.djangoproject.com/en/3.0/internals/release-process/)
- [2.2](https://docs.djangoproject.com/en/2.2/internals/release-process/)
- [2.1](https://docs.djangoproject.com/en/2.1/internals/release-process/)
- [2.0](https://docs.djangoproject.com/en/2.0/internals/release-process/)
- [1.11](https://docs.djangoproject.com/en/1.11/internals/release-process/)
- [1.10](https://docs.djangoproject.com/en/1.10/internals/release-process/)
- [1.9](https://docs.djangoproject.com/en/1.9/internals/release-process/)
- [1.8](https://docs.djangoproject.com/en/1.8/internals/release-process/)
...
security purposes, please see [our security policies](../security/).
...
to varying levels. See [the supported versions section](https://www.djangoproject.com/download/#supported-versions) of the download
