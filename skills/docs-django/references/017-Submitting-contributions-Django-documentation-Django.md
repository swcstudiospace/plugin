...
- Documentation version:
  **development**
- [6.1](https://docs.djangoproject.com/en/6.1/internals/contributing/writing-code/submitting-patches/)
- [6.0](https://docs.djangoproject.com/en/6.0/internals/contributing/writing-code/submitting-patches/)
- [5.2](https://docs.djangoproject.com/en/5.2/internals/contributing/writing-code/submitting-patches/)
- [5.1](https://docs.djangoproject.com/en/5.1/internals/contributing/writing-code/submitting-patches/)
- [5.0](https://docs.djangoproject.com/en/5.0/internals/contributing/writing-code/submitting-patches/)
- [4.2](https://docs.djangoproject.com/en/4.2/internals/contributing/writing-code/submitting-patches/)
- [4.1](https://docs.djangoproject.com/en/4.1/internals/contributing/writing-code/submitting-patches/)
- [4.0](https://docs.djangoproject.com/en/4.0/internals/contributing/writing-code/submitting-patches/)
- [3.2](https://docs.djangoproject.com/en/3.2/internals/contributing/writing-code/submitting-patches/)
- [3.1](https://docs.djangoproject.com/en/3.1/internals/contributing/writing-code/submitting-patches/)
- [3.0](https://docs.djangoproject.com/en/3.0/internals/contributing/writing-code/submitting-patches/)
- [2.2](https://docs.djangoproject.com/en/2.2/internals/contributing/writing-code/submitting-patches/)
- [2.1](https://docs.djangoproject.com/en/2.1/internals/contributing/writing-code/submitting-patches/)
- [2.0](https://docs.djangoproject.com/en/2.0/internals/contributing/writing-code/submitting-patches/)
- [1.11](https://docs.djangoproject.com/en/1.11/internals/contributing/writing-code/submitting-patches/)
- [1.10](https://docs.djangoproject.com/en/1.10/internals/contributing/writing-code/submitting-patches/)
- [1.9](https://docs.djangoproject.com/en/1.9/internals/contributing/writing-code/submitting-patches/)
- [1.8](https://docs.djangoproject.com/en/1.8/internals/contributing/writing-code/submitting-patches/)
...
See [Working with Git and GitHub](../working-with-git/) for more
...
- If a ticket for this issue doesn’t exist yet, create one in our
  ...
  the [process for suggesting new features](../../bugs-and-features/#requesting-features).
...
request](../working-with-git/). If you can’t
...
- Double-check the proposal against the [Contribution checklist](#patch-review-checklist).
...
existing discussion) following the [process for suggesting new features](../../bugs-and-features/#requesting-features). You should explain the need for the change, go into
...
[deprecation policy](../../../release-process/#internal-release-deprecation-policy). Hence, it can
...
following the [process for suggesting new features](../../bugs-and-features/#requesting-features).
...
Once the DEP is ready, the [Steering Council](../../../organization/#steering-council) votes on
...
As the [deprecation policy](../../../release-process/#internal-release-deprecation-policy)
...
when [running the test suite](../unit-tests/#running-unit-tests) with warnings enabled:
...
1. Create a virtual environment and [install the cloned copy of Django in
   editable mode](../../../../intro/contributing/#intro-contributing-install-local-copy).
...
For information on JavaScript contributions, see the [JavaScript patches](../javascript/#javascript-patches)
documentation.
...
- Is the pull request a single squashed commit with a message that follows our
  [commit message format](../../committing-code/#committing-guidelines)?
- Are you the patch author and a new contributor? Please add yourself to the
  [AUTHORS](https://github.com/django/django/blob/main/AUTHORS) file. At your option, submit a
...
- Does the [coding style](../coding-style/) conform to our
  guidelines? Are there any `black`, `blacken-docs`, `flake8`,
  `isort`, or `zizmor` errors? You can install the [pre-commit](../coding-style/#coding-style-pre-commit) hooks to automatically catch these errors.
- If the change is backwards incompatible in any way, is there a note
  in the release notes (`docs/releases/A.B.txt`)?
- Is Django’s test suite passing?
- If there is a [code coverage report](../unit-tests/#code-coverage-on-pull-requests)
...
- If the change affects the Django admin or rendered HTML output, has
  [accessibility testing](../../accessibility/#accessibility-testing-baseline) been done?
...
- Are there any [spelling errors](../../writing-documentation/#documentation-spelling-check)?

### Bugs

- Is there a proper regression test (the test should fail before the fix
  is applied)?
- If it’s a bug that [qualifies for a backport](../../../release-process/#supported-versions-policy) to the stable version of Django, is there a
...
- Is there documentation for the feature and is it [annotated
  appropriately](../../writing-documentation/#documenting-new-features) with
