...
Source: https://gitbook.com/docs/docs-as-code/git-sync/enabling-github-sync
...
- Docs as code
  ...
  - [GitHub & GitLab Sync](/docs/docs-as-code/git-sync)
    ...
    - [Enabling GitHub Sync](/docs/docs-as-code/git-sync/enabling-github-sync)
    - [Enabling GitLab Sync](/docs/docs-as-code/git-sync/enabling-gitlab-sync)
    - [Content configuration](/docs/docs-as-code/git-sync/content-configuration)
    - [GitHub pull request preview](/docs/docs-as-code/git-sync/github-pull-request-preview)
    - [Commit messages & Autolink](/docs/docs-as-code/git-sync/commits)
    - [Monorepos](/docs/docs-as-code/git-sync/monorepos)
    - [Troubleshooting](/docs/docs-as-code/git-sync/troubleshooting)
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/docs-as-code/git-sync/enabling-github-sync.md).
...
2. [Docs as code](/docs/docs-as-code)
3. [GitHub & GitLab Sync](/docs/docs-as-code/git-sync)
...
- [Open Git Sync for your site](#open-git-sync-for-your-site)
- [Connect GitHub](#connect-github)
- [Select a repository and branch](#select-a-repository-and-branch)
- [Choose an initial sync direction](#choose-an-initial-sync-direction)
- [Set the project directory](#set-the-project-directory)
- [Map your spaces](#map-your-spaces)
- [Review advanced options](#review-advanced-options)
- [Sync your site](#sync-your-site)
- [Write and commit](#write-and-commit)
