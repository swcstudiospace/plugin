...
Source: https://gitbook.com/docs/developers/gitbook-api/errors
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/developers/gitbook-api/errors.md).
...
Learn about errors the GitBook API might return
