...
Source: https://gitbook.com/docs/changelog
...
- [2026](/docs/changelog)
- [2025](/docs/changelog/2025-product-updates)
- [2024](/docs/changelog/2024-product-updates)
- [2023](/docs/changelog/2023-product-updates)
- [2022 and earlier](/docs/changelog/2022-and-earlier-product-updates)

[Powered by GitBook](https://www.gitbook.com/?utm_source=content&utm_medium=trademark&utm_campaign=PGZZo1PCN4rYgFLPD8Cl&utm_content=site_p4Xo4)
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/changelog/readme.md).

[RSS feed](https://gitbook.com/docs/changelog/rss.xml)
...
![The developer tools screen](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FpQL96NJ5CB0ULb6LhKdE%252FDeveloper%2520tools%25402x.png%3Falt%3Dmedia%26token%3D0d70befa-df3d-491c-8335-4ca451d69738&width=768&dpr=3&quality=100&sign=ee01b433&sv=2)
...
![A screenshot showing GitBook Assistant offering to leave page feedback for a user](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FudbEjIoXcoVc5q4lwYM6%252Fassistant-feedback%25402x.png%3Falt%3Dmedia%26token%3Dabebb576-67af-4d17-b2c4-7067406bba3b&width=768&dpr=3&quality=100&sign=cb3eb968&sv=2)
...
Both types of feedback appear on in your [site’s analytics](/docs/analytics/insights) under page feedback.
...
The new [GitBook CLI](/docs/docs-as-code/gitbook-cli) (`@gitbook/cli`) brings your GitBook content and organizations to your terminal.
...
Install it globally with `npm install @gitbook/cli -g`, then run `gitbook login` to get started — or head to [the CLI docs](/docs/docs-as-code/gitbook-cli) for the full guide.
...
![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FErsPWHrpee6BvxcW2BoK%252FCleanShot%25202026-07-29%2520at%252014.09.07.png%3Falt%3Dmedia%26token%3D599dd26a-a6cc-4531-b750-bf615bd3d8f7&width=768&dpr=3&quality=100&sign=5136a2eb&sv=2)
...
You now start at your organization **Home**, and each site’s content, structure, settings, and tools live together in one sidebar. Content in a site lives in [sections](/docs/manage-your-site/site-structure/site-sections) — what you knew as spaces, now part of their site — organized into groups when your docs grow. And the new [All content](/docs/create-content/content-structure/all-content) screen gives you one place to find everything in your organization, including content that isn’t part of a site yet.
...
Read about [what’s changed](/docs/getting-started/sites-first), or jump into the [quickstart](/docs/getting-started/quickstart) to learn more.
...
You can now create a [style guide](/docs/create-content/styleguide) for your docs: a dedicated space for your team’s writing rules that GitBook Agent enforces whenever it writes, edits, or reviews content.
...
Style guides are rolling out gradually in early access. [Learn more in the style guide docs](/docs/create-content/styleguide).
...
![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FE1x6r1vIerg6wzfhkbla%252FMCP.png%3Falt%3Dmedia%26token%3D44ed227d-2ba7-4242-aeb3-0f5bd78d477f&width=768&dpr=3&quality=100&sign=5aa17598&sv=2)
...
[Discover the GitBook MCP](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/getting-started/ai-documentation/gitbook-mcp)
...
![A screenshot showing the GitBook API endpoint to update the content of a change request](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FaZQO3psoVQOYk2C7vFSO%252Fupdate-change-request-api%25402x.png%3Falt%3Dmedia%26token%3D1c724d3d-cd9e-44e6-874a-bb23b6150ce3&width=768&dpr=3&quality=100&sign=f8035b7c&sv=2)
...
![A screenshot showing the ‘New chat’ button in GitBook Agent](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FGlET4CXGeTWzZE1PsTnO%252Fmultiple-ai-chats%25402x.png%3Falt%3Dmedia%26token%3D8c04bfd3-d932-467f-9050-b02ad352464c&width=768&dpr=3&quality=100&sign=8627382d&sv=2)
...
![A GitBook editor showing a documentation page titled "System Performance Monitoring." In the bottom-right corner, a "GitBook Agent" button is visible, demonstrating the new inline Agent access point within the editor.](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252F0ej9dO5YPROpwko3s45u%252Fagentineditor.gif%3Falt%3Dmedia%26token%3D0de6dc45-8e84-4d60-b388-7172b21c0f31&width=768&dpr=3&quality=100&sign=3f981c29&sv=2)
...
We [recently](/docs/changelog#site-level-permissions) released site-level permissions, to make it easier to manage permissions for all of your content in a site. With this release, we’re tweaking the way those permissions are inherited to make them simpler and easier to manage.
...
![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252F7Fha5euZBLmGemyMMtVy%252Fimproved-colors%25402x.png%3Falt%3Dmedia%26token%3Df140f723-c051-49d6-9c14-71c1986af415&width=768&dpr=3&quality=100&sign=36ce2279&sv=2)
...
When you connect a channel to your GitBook site for support, anyone can tag **@gitbook** and ask a question. GitBook Assistant will answer based on information from your docs (and any [connections](/docs/changelog#connections-give-the-assistant-a-full-picture) you've set up).
...
![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252F8M8Rqu5dogYZzRuvR7cD%252FGitBook-assistant%25402x.png%3Falt%3Dmedia%26token%3Dffddc161-ff8a-4b6f-86f9-53b015a1fd00&width=768&dpr=3&quality=100&sign=e21c5924&sv=2)
...
- We’ve improved the archiving and unarchiving experience for change requests. You can now archive or unarchive a change request from the **Actions button** ![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FLYvwcuqE8ObZh2wuQs9V%252Factions-horizontal.svg%3Falt%3Dmedia%26token%3D039dd987-47c3-4cd8-8d67-7a39787e594d&width=300&dpr=3&quality=100&sign=55e825fd&sv=2)![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252F5kiMOUnL9YUFIJPE7EJ6%252Factions-horizontal%2520-%2520dark.svg%3Falt%3Dmedia%26token%3D473a34af-fc8d-4c65-b9c7-9b328e711a71&width=300&dpr=3&quality=100&sign=4aabaf&sv=2) with a confirmation modal that lets you undo the action quickly if needed.
...
![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FLM0lZ9O13GC1q2eI0wOL%252Ftag-improvements.png%3Falt%3Dmedia%26token%3D74b27fc8-124f-4e16-9da0-db5480c12bad&width=768&dpr=3&quality=100&sign=338c4f65&sv=2)
...
![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252Fmji0hAPzGxdBGZHt2muo%252Fai-insights%25402x.png%3Falt%3Dmedia%26token%3D9c1609c7-f412-4dcb-a2f2-ec221a580c7d&width=768&dpr=3&quality=100&sign=adf5aad9&sv=2)
...
![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FeNugXVTlLes3KZjn9WqO%252Fassistant-connections%25402x.png%3Falt%3Dmedia%26token%3D3f90bf64-494c-4211-b4b4-faae5bd9c50d&width=768&dpr=3&quality=100&sign=95790955&sv=2)
...
To copy a page, open the page’s **Actions menu** ![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252Feau6xpR5czwHgUx2Fx2I%252Factions-light.svg%3Falt%3Dmedia%26token%3D264689bb-f225-48fc-b8e5-d64dd9d7966f&width=300&dpr=3&quality=100&sign=659e8e66&sv=2)![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FkixcrcbwaIFBTlO0PGzx%252Factions-dark.svg%3Falt%3Dmedia%26token%3Dcf2d0f65-ce2b-4862-96ef-c0cb118bd456&width=300&dpr=3&quality=100&sign=e5e4b0ef&sv=2) from either the table of content or the top of the page and choose **Copy > Copy page**.
...
To edit your site’s permissions, head to your site’s Overview page and click the **Permissions** ![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FwLS2uUQuwPGEWXaQF7DG%252Fsite-permissions.svg%3Falt%3Dmedia%26token%3Dde8ca78b-7f01-4a7d-9936-31b5503ae60d&width=300&dpr=3&quality=100&sign=8dfe43a3&sv=2)![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252Ffrh2NbzpXq5vPp9HknzY%252Fsite-permissions-dark.svg%3Falt%3Dmedia%26token%3D5773d477-f052-4fd8-bc03-57d1d7eb4630&width=300&dpr=3&quality=100&sign=966aff6c&sv=2) icon in the top-right corner. You can also open your site’s **Settings** tab and select **Manage permissions**.
...
- You can now access and search through variables within the inline insert palette. Hit `/` in any text block to open the palette to find variables faster.
...
![A screenshot of a docs site published using GitBook with four social icons in the header bar](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FymXt2N69tGC765iCPMr7%252Fsocial-accounts-header%25402x.png%3Falt%3Dmedia%26token%3Db0286ddf-1304-4348-801b-1671d9498441&width=768&dpr=3&quality=100&sign=6ae8f690&sv=2)
...
![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252Fouw4ii8j40aGmOxDS0ux%252Freusable-content-dialog%25402x.png%3Falt%3Dmedia%26token%3D2e726cfc-83e8-4a20-9e2d-3bad3c288386&width=768&dpr=3&quality=100&sign=4c9966cc&sv=2)
...
There are more than 4,300 icons to choose from in the icon picker — including the GitBook icon

To change the icon, click the block’s current icon within the hint block to open the icon picker. To change the hint block style (e.g. info, warning or success), open the block’s **Options menu** ![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FGSVJN7uZvFaa8D204fO5%252Foptions-light.svg%3Falt%3Dmedia%26token%3D12cbb65e-c311-4395-808e-8ca11a0db126&width=300&dpr=3&quality=100&sign=46aeedf8&sv=2)![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FTz4cibInUfu2cb005Na8%252Foptions-dark.svg%3Falt%3Dmedia%26token%3D0849b16e-a06a-46b5-8b68-ed3c14ffaf3f&width=300&dpr=3&quality=100&sign=c8774f80&sv=2)

### Improvements

- You can now split and merge stepper blocks easily, making it easier to work with them in the editor. In any stepper block, navigate to the step’s body copy and hit `Enter` three times to create an empty block between the steps. You can also remove an empty block between steppers to merge them together.
...
- If you’re using conditional content, you can now toggle block conditions on and off more easily from the block’s **Options menu** ![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FGSVJN7uZvFaa8D204fO5%252Foptions-light.svg%3Falt%3Dmedia%26token%3D12cbb65e-c311-4395-808e-8ca11a0db126&width=300&dpr=3&quality=100&sign=46aeedf8&sv=2)![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FTz4cibInUfu2cb005Na8%252Foptions-dark.svg%3Falt%3Dmedia%26token%3D0849b16e-a06a-46b5-8b68-ed3c14ffaf3f&width=300&dpr=3&quality=100&sign=c8774f80&sv=2).
- The editor will now remember your code block preferences when you create another code block to save you time. So if you enable Line numbers, With caption, Wrap code, and/or Expandable from the code block’s **Actions menu** ![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252Feau6xpR5czwHgUx2Fx2I%252Factions-light.svg%3Falt%3Dmedia%26token%3D264689bb-f225-48fc-b8e5-d64dd9d7966f&width=300&dpr=3&quality=100&sign=659e8e66&sv=2)![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FkixcrcbwaIFBTlO0PGzx%252Factions-dark.svg%3Falt%3Dmedia%26token%3Dcf2d0f65-ce2b-4862-96ef-c0cb118bd456&width=300&dpr=3&quality=100&sign=e5e4b0ef&sv=2) those settings will be maintained when you create another code block.
...
![Search bar and Ask AI bar button variants on a documentation page](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252F94CRxbjE8PxJUUVdBqHK%252Finline-assistant-button%25402x.png%3Falt%3Dmedia%26token%3Ded11b1d0-f1ab-403c-8624-0da0313ca160&width=768&dpr=3&quality=100&sign=9574c3b4&sv=2)
...
![The Insert menu showing options to add a search bar or an Ask AI bar](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FG4LOb8x4lDivnNkfKHHF%252Finsert-palette-assistant%25402x.png%3Falt%3Dmedia%26token%3D9d54d9c1-fc6f-45be-a902-1af78d15ef3a&width=768&dpr=3&quality=100&sign=41d06c84&sv=2)
...
- We’ve added a new option to [expandable blocks](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/creating-content/blocks/expandable) — you can now have them expanded by default on your site. So if you want expandables to be collapsible, but open when visitors first view your page, you can. The new option is available in the **Block options** ![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FGSVJN7uZvFaa8D204fO5%252Foptions-light.svg%3Falt%3Dmedia%26token%3D12cbb65e-c311-4395-808e-8ca11a0db126&width=300&dpr=3&quality=100&sign=46aeedf8&sv=2)![](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FTz4cibInUfu2cb005Na8%252Foptions-dark.svg%3Falt%3Dmedia%26token%3D0849b16e-a06a-46b5-8b68-ed3c14ffaf3f&width=300&dpr=3&quality=100&sign=c8774f80&sv=2) menu.
...
Want to set a separate theme for your [API blocks](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/api-references)? No problem — you can override them by clicking the **Customize per block type** ![Customize per block type icon](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FsszxJbVwDObQIY2eFDeE%252Fsettings%2520-%2520light.svg%3Falt%3Dmedia%26token%3Dafd2a3d2-2c4e-49ab-bee3-f9b8827ad737&width=300&dpr=3&quality=100&sign=22dc6e9f&sv=2)![Customize per block type icon](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FVcOvRJC3EAr05oYwadaw%252Fsettings%2520-%2520dark.svg%3Falt%3Dmedia%26token%3Db11ee2c4-9a73-4fa9-8ca0-24a989b9a554&width=300&dpr=3&quality=100&sign=51cc7e3c&sv=2) button in the **Customization** screen.
...
![The Sharing tab in Customization with fields for adding social accounts](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FUnfr06sjeQipOfltXTDq%252Fsocial-accounts%25402x.png%3Falt%3Dmedia%26token%3D9f20054c-e72f-4245-a48b-81bd840b9d21&width=768&dpr=3&quality=100&sign=2008fe8c&sv=2)
...
- Fixed a bug with images that meant, if an image block was selected and you tried to open the image menu on a *different* image block, the focus would jump back to the selected block rather than the image you just clicked.
...
![The Library panel showing an item you can jump to in Library](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FajUayCtuD9yWMT8wpRzd%252Fshow-in-library%25402x.png%3Falt%3Dmedia%26token%3D6777e3b3-9ba0-4d2f-939a-d630071479d7&width=768&dpr=3&quality=100&sign=f5b2aa3d&sv=2)
...
![The updated table of contents with Pages and Library sections](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FpAxYdRWvQX2mWuu7hlHB%252Ftoc-library%25402x.png%3Falt%3Dmedia%26token%3Da47d0e90-14fd-4e16-bfec-9bdc87474ae2&width=768&dpr=3&quality=100&sign=63cab381&sv=2)
...
![The Improve menu showing preset prompts for editing a page with AI](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FyG14hTKvLRhq3vwUDpNO%252Fpage-actions.png%3Falt%3Dmedia%26token%3Da9aa1f93-442c-47c5-be72-b337d28f9b65&width=768&dpr=3&quality=100&sign=6184d6a4&sv=2)

You can now tell GitBook Agent to complete common actions using [a new **Improve** menu](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/gitbook-agent/write-and-edit-with-ai#improve-page-content-with-gitbook-agent) that offers quick presets to improve your page. You can access the new menu from the editor by hovering over the page title, or from the page’s **Actions menu** ![Actions menu icon](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252Feau6xpR5czwHgUx2Fx2I%252Factions-light.svg%3Falt%3Dmedia%26token%3D264689bb-f225-48fc-b8e5-d64dd9d7966f&width=300&dpr=3&quality=100&sign=659e8e66&sv=2)![Actions menu icon](https://gitbook.com/docs/~gitbook/image?url=https%3A%2F%2F2672413337-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FPGZZo1PCN4rYgFLPD8Cl%252Fuploads%252FkixcrcbwaIFBTlO0PGzx%252Factions-dark.svg%3Falt%3Dmedia%26token%3Dcf2d0f65-ce2b-4862-96ef-c0cb118bd456&width=300&dpr=3&quality=100&sign=e5e4b0ef&sv=2).
...
- [One-click MCP connectors and a redesigned Developer tools screen](#one-click-mcp-connectors-and-a-redesigned-developer-tools-screen)
- [A more capable Content API](#a-more-capable-content-api)
- [Your docs can now collect feedback from readers and AI agents](#your-docs-can-now-collect-feedback-from-readers-and-ai-agents)
- [Ask questions through your site’s MCP server](#ask-questions-through-your-sites-mcp-server)
- [Custom instructions for GitBook Assistant](#custom-instructions-for-gitbook-assistant)
- [Improvements](#improvements-1)
- [Fixes](#fixes)
- [Meet the GitBook CLI](#meet-the-gitbook-cli)
- [A more powerful page cover system](#a-more-powerful-page-cover-system)
- [Improvements](#improvements-2)
- [Fixes](#fixes-1)
- [Meet the sites-first GitBook](#meet-the-sites-first-gitbook)
- [Introducing style guides](#introducing-style-guides)
- [GitBook Agent: broader context and hidden-page editing](#gitbook-agent-broader-context-and-hidden-page-editing)
- [New connections for HubSpot, Front and more](#new-connections-for-hubspot-front-and-more)
- [Improvements](#improvements-3)
- [Fixes](#fixes-2)
- [Introducing GitBook MCP](#gitbook-mcp)
- [Private agent conversations](#private-agent-conversations)
- [Team management in site members](#team-management-in-site-members)
- [Git LFS support for Git Sync](#git-lfs-support-for-git-sync)
- [Improvements](#improvements-4)
- [Fixes](#fixes-3)
- [Faster change request reviews with improved diff navigation](#faster-change-request-reviews-with-improved-diff-navigation)
- [AI-generated change request titles and descriptions](#ai-generated-change-request-titles-and-descriptions)
- [Improvements](#improvements-5)
- [Fixes](#fixes-4)
- [Update change request content via the API](#update-change-request-content-via-the-api)
- [GitBook Agent can ask multiple-choice questions in change requests](#gitbook-agent-can-ask-multiple-choice-questions-in-change-requests)
- [Improvements](#improvements-6)
- [Fixes](#fixes-5)
- [Multiple AI chats per change request](#multiple-ai-chats-per-change-request)
- [Mermaid diagrams: fullscreen view and improved controls](#mermaid-diagrams-fullscreen-view-and-improved-controls)
- [OpenAPI: one operation per page](#openapi-one-operation-per-page)
- [Improvements](#improvements-7)
- [Fixes](#fixes-6)
- [GitBook Agent can now work with variables](#gitbook-agent-can-now-work-with-variables)
- [Improved matching in full-text search](#improved-matching-in-full-text-search)
- [Multiple custom merge rules](#multiple-custom-merge-rules)
- [Improvements](#improvements-8)
- [Fixes](#fixes-7)
- [Reusable content diffs in change requests](#reusable-content-diffs-in-change-requests)
- [Improvements](#improvements-9)
- [Fixes](#fixes-8)
- [Improved GitBook Agent inside the editor](#improved-gitbook-agent-inside-the-editor)
- [Filter update blocks by tag on your published site](#filter-update-blocks-by-tag-on-your-published-site)
- [Improvements](#improvements-10)
- [Fixes](#fixes-9)
- [Integration blocks inside reusable content](#integration-blocks-inside-reusable-content)
- [Improvements](#improvements-11)
- [Fixes](#fixes-10)
- [Diff-style highlighting in code blocks](#diff-style-highlighting-in-code-blocks)
- [Improvements](#improvements-12)
- [Fixes](#fixes-11)
- [An update to site permissions and inheritance](#an-update-to-site-permissions-and-inheritance)
- [Improvements](#improvements-13)
- [Fixes](#fixes-12)
- [Faster site search, with better results](#faster-site-search-with-better-results)
- [Text, background, tag, and tint color improvements](#text-background-tag-and-tint-color-improvements)
- [Improvements](#improvements-14)
- [Fixes](#fixes-13)
- [Introducing channels: Integrate GitBook Assistant and GitBook Agent into other tools](#introducing-channels-integrate-gitbook-assistant-and-gitbook-agent-into-other-tools)
- [Channels for support](#channels-for-support)
- [Channels for collaboration](#channels-for-collaboration)
- [GitBook Assistant’s answers are now more elaborative and creative](#gitbook-assistants-answers-are-now-more-elaborative-and-creative)
- [Collapsible page groups](#collapsible-page-groups)
- [Improvements](#improvements-15)
- [Fixes](#fixes-14)
- [Page tag improvements](#page-tag-improvements)
- [Improvements](#improvements-16)
- [Fixes](#fixes-15)
- [AI insights: Identify opportunities for improvement in your docs](#ai-insights-identify-opportunities-for-improvement-in-your-docs)
- [Connections: give the Assistant a full picture](#connections-give-the-assistant-a-full-picture)
- [Some smaller improvements and fixes](#some-smaller-improvements-and-fixes)
- [Improvements](#improvements-17)
- [Fixes](#fixes-16)
- [Copy and paste pages between spaces and change requests](#copy-and-paste-pages-between-spaces-and-change-requests)
- [Site level permissions](#site-level-permissions)
- [Add tags to your pages, update blocks and table of contents](#add-tags-to-your-pages-update-blocks-and-table-of-contents)
- [Improvements](#improvements-19)
- [Fixes](#fixes-18)
- [Update blocks with RSS and tag support for changelogs](#update-blocks-with-rss-and-tag-support-for-changelogs)
- [Add social accounts to your site header](#add-social-accounts-to-your-site-header)
- [Improvements](#improvements-20)
- [Fixes](#fixes-19)
- [Edit and manage reusable content more easily](#edit-and-manage-reusable-content-more-easily)
- [Custom icons in hint blocks](#custom-icons-in-hint-blocks)
- [Improvements](#improvements-21)
- [Fixes](#fixes-20)
- [Add a search or Ask AI bar to your page in two clicks](#add-a-search-or-ask-ai-bar-to-your-page-in-two-clicks)
- [Improvements](#improvements-22)
- [Fixes](#fixes-21)
- [Code themes for published docs](#code-themes-for-published-docs)
- [Improvements](#improvements-23)
- [Fixes](#fixes-22)
- [Improved side sheets and sidebar navigation for your docs site on mobile](#improved-side-sheets-and-sidebar-navigation-for-your-docs-site-on-mobile)
- [Add social accounts to your docs site](#add-social-accounts-to-your-docs-site)
- [Fixed](#fixed)
- [Jump to any image, file, variable or reusable content in the new Library](#jump-to-any-image-file-variable-or-reusable-content-in-the-new-library)
- [Improvements](#improvements-24)
- [Fixes](#fixes-23)
- [TOC improvements: a new and improved home for files, variables and reusable content](#toc-improvements-a-new-and-improved-home-for-files-variables-and-reusable-content)
- [Quickly improve any page with AI using preset prompts](#quickly-improve-any-page-with-ai-using-preset-prompts)
- [Improvements](#improvements-25)
- [Fixes](#fixes-24)
- [New Year improvements and bug fixes 🎉](#new-year-improvements-and-bug-fixes)
