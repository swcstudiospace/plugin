# Custom fonts | Developers

Source: https://gitbook.com/docs/developers/gitbook-api/api-reference/custom-fonts
...
- GitBook API
  ...
  - [API reference](/docs/developers/gitbook-api/api-reference)
    ...
    - [Custom fonts](/docs/developers/gitbook-api/api-reference/custom-fonts)
      ...
      - [getList all custom fonts](/docs/developers/gitbook-api/api-reference/custom-fonts/list-all-custom-fonts)
      - [putCreate a custom font](/docs/developers/gitbook-api/api-reference/custom-fonts/create-a-custom-font)
      - [getGet a custom font by its ID](/docs/developers/gitbook-api/api-reference/custom-fonts/get-a-custom-font-by-its-id)
      - [postUpdate a custom font](/docs/developers/gitbook-api/api-reference/custom-fonts/update-a-custom-font)
      - [DELDelete a custom font](/docs/developers/gitbook-api/api-reference/custom-fonts/delete-a-custom-font)
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/developers/gitbook-api/api-reference/custom-fonts.md).
...
fontFacesobject · FontFace[] · min: 1Required
