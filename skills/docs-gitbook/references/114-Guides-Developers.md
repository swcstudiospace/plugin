...
Source: https://gitbook.com/docs/developers/gitbook-api/guides
...
- GitBook API
  ...
  - [Guides](/docs/developers/gitbook-api/guides)
    ...
    - [Pull analytics from your site](/docs/developers/gitbook-api/guides/pull-analytics-from-your-site)
    - [Work on your site with an AI agent](/docs/developers/gitbook-api/guides/work-on-your-site-with-an-ai-agent)
    - [Manage your team with the API](/docs/developers/gitbook-api/guides/manage-your-team-with-the-api)
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/developers/gitbook-api/guides.md).
...
Read specific guides on using the GitBook API

[Pull analytics from your site](/docs/developers/gitbook-api/guides/pull-analytics-from-your-site)[Work on your site with an AI agent](/docs/developers/gitbook-api/guides/work-on-your-site-with-an-ai-agent)[Manage your team with the API](/docs/developers/gitbook-api/guides/manage-your-team-with-the-api)[Track advanced analytics with GitBook's Events Aggregation API](https://gitbook.com/docs/guides/docs-analytics/track-advanced-analytics-with-gitbooks-events-aggregation-api)
