...
Source: https://gitbook.com/docs/developers/gitbook-api/api-reference/translations
...
- GitBook API
  ...
  - [API reference](/docs/developers/gitbook-api/api-reference)
    ...
    - [Translations](/docs/developers/gitbook-api/api-reference/translations)
      ...
      - [Glossary](/docs/developers/gitbook-api/api-reference/translations/glossary)
      - [getList all the translations](/docs/developers/gitbook-api/api-reference/translations/list-all-the-translations)
      - [postCreate a translation](/docs/developers/gitbook-api/api-reference/translations/create-a-translation)
      - [getGet a translation by its ID](/docs/developers/gitbook-api/api-reference/translations/get-a-translation-by-its-id)
      - [putUpdate a translation](/docs/developers/gitbook-api/api-reference/translations/update-a-translation)
      - [DELDelete a translation](/docs/developers/gitbook-api/api-reference/translations/delete-a-translation)
      - [postRun a translation again](/docs/developers/gitbook-api/api-reference/translations/run-a-translation-again)
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/developers/gitbook-api/api-reference/translations.md).
