...
Source: https://gitbook.com/docs/docs-as-code/git-sync/monorepos
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/docs-as-code/git-sync/monorepos.md).
...
- [How site-wide Git Sync works](#how-site-wide-git-sync-works)
- [Map spaces to directories](#map-spaces-to-directories)
- [Keep space content self-contained](#keep-space-content-self-contained)
- [Move a mapped directory](#move-a-mapped-directory)
- [Use individual space Git Sync](#use-individual-space-git-sync)
