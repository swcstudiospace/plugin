# Custom hostnames | Developers

Source: https://gitbook.com/docs/developers/gitbook-api/api-reference/custom-hostnames
...
- GitBook API
  ...
  - [API reference](/docs/developers/gitbook-api/api-reference)
    ...
    - [Custom hostnames](/docs/developers/gitbook-api/api-reference/custom-hostnames)
      ...
      - [getGet a custom hostname](/docs/developers/gitbook-api/api-reference/custom-hostnames/get-a-custom-hostname)
      - [DELRemove a custom hostname](/docs/developers/gitbook-api/api-reference/custom-hostnames/remove-a-custom-hostname)
      - [patchRevalidate a custom hostname DNS](/docs/developers/gitbook-api/api-reference/custom-hostnames/revalidate-a-custom-hostname-dns)
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/developers/gitbook-api/api-reference/custom-hostnames.md).
...
objectstring · enumRequiredPossible values: `custom-hostname`
...
object · OrganizationPointerOptional

Show properties

or

object · SitePointerOptional
...
string · enumOptionalPossible values: `dns_passed``dns_wrong_cname``dns_no_cname``dns_cloudflare_proxied``dns_wrong_caa``live``ssl_unknown``ssl_pending``ssl_failed``ssl_retry_expired``invalid_domain``internal_error`
