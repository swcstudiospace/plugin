...
Source: https://gitbook.com/docs/developers/gitbook-api/authentication
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/developers/gitbook-api/authentication.md).
...
Authenticate your requests with your user account when using the GitBook API
