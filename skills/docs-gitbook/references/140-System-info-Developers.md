# System info | Developers

Source: https://gitbook.com/docs/developers/gitbook-api/api-reference/system-info
...
- GitBook API
  ...
  - [API reference](/docs/developers/gitbook-api/api-reference)
    ...
    - [System info](/docs/developers/gitbook-api/api-reference/system-info)
      ...
      - [getGet API information](/docs/developers/gitbook-api/api-reference/system-info/get-api-information)
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/developers/gitbook-api/api-reference/system-info.md).
