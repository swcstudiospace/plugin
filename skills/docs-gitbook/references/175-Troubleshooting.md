...
Source: https://gitbook.com/docs/help/troubleshooting
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/help/troubleshooting.md).
...
Resolve loading, connection, and caching issues in the GitBook app
...
2. If you don't want to disable it entirely, add the domains under [Allowed domains](/docs/help/troubleshooting#allowed-domains) to your extension's allowlist.
...
5. **Check your firewall or security software** against [Allowed domains](/docs/help/troubleshooting#allowed-domains).
