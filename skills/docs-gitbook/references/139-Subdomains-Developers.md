...
Source: https://gitbook.com/docs/developers/gitbook-api/api-reference/subdomains
...
- GitBook API
  ...
  - [API reference](/docs/developers/gitbook-api/api-reference)
    ...
    - [Subdomains](/docs/developers/gitbook-api/api-reference/subdomains)
      ...
      - [getGet a subdomain](/docs/developers/gitbook-api/api-reference/subdomains/get-a-subdomain)
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/developers/gitbook-api/api-reference/subdomains.md).
