...
Source: https://gitbook.com/docs/developers/gitbook-api/api-reference
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/developers/gitbook-api/api-reference.md).
...
[Published docs sites](/docs/developers/gitbook-api/api-reference/docs-sites)

Manage members, teams, and permissions

[Organization members](/docs/developers/gitbook-api/api-reference/organizations/organization-members)

Import and export pages, files, and reusable content

[Content import and export](/docs/developers/gitbook-api/api-reference/imports)
...
[Comments](/docs/developers/gitbook-api/api-reference/change-requests/change-request-comments)

Configure custom hostnames, URLs, and search

[Site customization](/docs/developers/gitbook-api/api-reference/custom-hostnames)

Monitor content performance

[Analytics](/docs/developers/gitbook-api/api-reference/docs-sites/site-insights)
...
You can view GitBook’s hosted OpenAPI spec used to generate our API docs [here](https://api.gitbook.com/openapi.json). Learn more about creating your own API references in our [product docs](/docs/create-content/openapi).
