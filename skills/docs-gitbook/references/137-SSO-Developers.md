...
Source: https://gitbook.com/docs/developers/gitbook-api/api-reference/sso
...
- GitBook API
  ...
  - [API reference](/docs/developers/gitbook-api/api-reference)
    ...
    - [SSO](/docs/developers/gitbook-api/api-reference/sso)
      ...
      - [getList all SAML providers](/docs/developers/gitbook-api/api-reference/sso/list-all-saml-providers)
      - [postCreate a new SAML provider](/docs/developers/gitbook-api/api-reference/sso/create-a-new-saml-provider)
      - [getGet a SAML provider by its ID](/docs/developers/gitbook-api/api-reference/sso/get-a-saml-provider-by-its-id)
      - [DELDelete a SAML provider](/docs/developers/gitbook-api/api-reference/sso/delete-a-saml-provider)
      - [patchUpdate a SAML provider](/docs/developers/gitbook-api/api-reference/sso/update-a-saml-provider)
      - [getList all SSO provider login infos](/docs/developers/gitbook-api/api-reference/sso/list-all-sso-provider-login-infos)
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/developers/gitbook-api/api-reference/sso.md).
...
objectstring · enumRequiredPossible values: `subdomain`
