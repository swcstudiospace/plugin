...
Source: https://gitbook.com/docs/gitbook-agent/review-change-requests-with-gitbook-agent
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/gitbook-agent/review-change-requests-with-gitbook-agent.md).
...
- [Review change requests with GitBook Agent](#review-change-requests-with-gitbook-agent)
- [Update change requests with GitBook Agent](#update-change-requests-with-gitbook-agent)
