...
Source: https://gitbook.com/docs/skill/configure-site
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/skill/configure-site.md).
...
Create and maintain entire GitBook documentation sites end-to-end — design the site structure from source content, scaffold a Git repository in monorepo layout, set up the GitHub/GitLab remote, drive
...
Conditional content via `{% if visitor.claims... %}`
...
`.gitbook/vars.yaml` variables

Any space's `.gitbook/vars.yaml`

Grouped SUMMARY.md (sections via `## Heading`)

Any of the per-space `SUMMARY.md` files
...
- [How you can talk to GitBook](#how-you-can-talk-to-gitbook)
- [The fundamental constraint](#the-fundamental-constraint)
- [Inputs you should gather up front](#inputs-you-should-gather-up-front)
- [Verify the content source before building](#verify-the-content-source-before-building)
- [Confirmation gates for state-changing operations](#confirmation-gates-for-state-changing-operations)
- [After a change-request push: two links are mandatory](#after-a-change-request-push-two-links-are-mandatory)
- [Designing the site structure](#designing-the-site-structure)
- [Scaffolding the repository](#scaffolding-the-repository)
- [The repo-level README and .gitignore](#the-repo-level-readme-and-.gitignore)
- [Generating SUMMARY.md — gather the nav, don't infer it from folders](#generating-summary.md-gather-the-nav-dont-infer-it-from-folders)
- [Per-page markdown — defer to write-docs, but reach for the rich blocks](#per-page-markdown-defer-to-write-docs-but-reach-for-the-rich-blocks)
- [Choosing the right block — actively, not by default](#choosing-the-right-block-actively-not-by-default)
- [Cross-space links](#cross-space-links)
- [Where to look for example content](#where-to-look-for-example-content)
- [Migration and content quality](#migration-and-content-quality)
- [Driving GitBook to build the site](#driving-gitbook-to-build-the-site)
- [The standard sequence for a new site](#the-standard-sequence-for-a-new-site)
- [Multi-language sites and auto-translated spaces](#multi-language-sites-and-auto-translated-spaces)
- [Section groups](#section-groups)
- [Updating an existing site](#updating-an-existing-site)
- [When to use content import vs. Git Sync](#when-to-use-content-import-vs.-git-sync)
- [Branding and customization](#branding-and-customization)
- [The Git Sync handoff](#the-git-sync-handoff)
