...
Source: https://gitbook.com/docs/developers/gitbook-api/api-reference/imports
...
- GitBook API
  ...
  - [API reference](/docs/developers/gitbook-api/api-reference)
    ...
    - [Imports](/docs/developers/gitbook-api/api-reference/imports)
      ...
      - [getList the import runs of an organization](/docs/developers/gitbook-api/api-reference/imports/list-the-import-runs-of-an-organization)
      - [postImport content into a space from a website](/docs/developers/gitbook-api/api-reference/imports/import-content-into-a-space-from-a-website)
      - [getGet an import run](/docs/developers/gitbook-api/api-reference/imports/get-an-import-run)
      - [postCancel an import run](/docs/developers/gitbook-api/api-reference/imports/cancel-an-import-run)
...
For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). This page is also available as [Markdown](https://gitbook.com/docs/developers/gitbook-api/api-reference/imports.md).
