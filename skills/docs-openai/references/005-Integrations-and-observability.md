...
Source: https://developers.openai.com/api/docs/guides/agents/integrations-observability.md
...
"server\_url": "https://gitmcp.io/openai/codex",
...
fullCommand:
"npx -y @modelcontextprotocol/server-filesystem fixtures/sample\_files",
});
...
agent,
f"Rate this joke: {first.final\_output}",
)
print(first.final\_output)
print(second.final\_output)
if \_\_name\_\_ == "\_\_main\_\_":
asyncio.run(main())
```
