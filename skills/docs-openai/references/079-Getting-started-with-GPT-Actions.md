...
Source: https://developers.openai.com/api/docs/actions/getting-started.md
...
1. \_Context\_ to explain to the model what the GPT Action(s) is doing
2. \_Instructions\_ on the sequence of steps – this is where you reference the Action name and any parameters the API call needs to pay attention to
3. \_Additional Notes\_ if there’s anything to keep in mind
