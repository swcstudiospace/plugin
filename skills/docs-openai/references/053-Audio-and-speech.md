...
Source: https://developers.openai.com/api/docs/guides/audio.md
...
apiKey: "ek\_...(ephemeral key from your server)",
});
```
...
{
type: "input\_audio",
input\_audio: { data: base64str, format: "wav" },
},
],
},
],
...
{
"type": "input\_audio",
"input\_audio": {"data": encoded\_string, "format": "wav"},
},
],
},
],
