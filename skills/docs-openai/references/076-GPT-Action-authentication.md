...
Source: https://developers.openai.com/api/docs/actions/authentication.md
...
- The `authorization\_url` endpoint should return a response that looks like:
`{ "access\_token": "example\_token", "token\_type": "bearer", "refresh\_token": "example\_token", "expires\_in": 59 }`
