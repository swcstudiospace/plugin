...
Source: https://developers.openai.com/api/docs/assistants/tools/code-interpreter.md
...
file\_id = os.environ["OPENAI\_FILE\_ID"]
client = OpenAI()
image\_data = client.files.content(file\_id)
...
run\_id = os.environ["OPENAI\_RUN\_ID"]
