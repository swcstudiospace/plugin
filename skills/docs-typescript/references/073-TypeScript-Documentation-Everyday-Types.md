...
Step one in learning TypeScript: The basic types.](/docs/handbook/2/basic-types.html)[### Narrowing

Understand how TypeScript uses JavaScript knowledge to reduce the amount of type syntax in your projects.](/docs/handbook/2/narrowing.html)

The TypeScript docs are an open source project. Help us improve these pages [by sending a Pull Request](https://github.com/microsoft/TypeScript-Website/blob/v2/packages/documentation/copy/en/handbook-v2/Everyday Types.md) ❤
