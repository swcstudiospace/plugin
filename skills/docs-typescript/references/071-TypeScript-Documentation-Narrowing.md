...
This kind of expression is always truthy.2872This kind of expression is always truthy.Try
```
...
The language primitives.](/docs/handbook/2/everyday-types.html)[### More on Functions

Learn about how Functions work in TypeScript.](/docs/handbook/2/functions.html)
