...
'createCatName' cannot be used as a value because it was imported using 'import type'.1361'createCatName' cannot be used as a value because it was imported using 'import type'.Try
```
...
How classes work in TypeScript](/docs/handbook/2/classes.html)
