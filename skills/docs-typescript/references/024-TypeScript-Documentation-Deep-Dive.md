...
Recommendations for writing d.ts files](/docs/handbook/declaration-files/do-s-and-don-ts.html)[### Publishing

How to get your d.ts files to users](/docs/handbook/declaration-files/publishing.html)

The TypeScript docs are an open source project. Help us improve these pages [by sending a Pull Request](https://github.com/microsoft/TypeScript-Website/blob/v2/packages/documentation/copy/en/declaration-files/Deep Dive.md) ❤
