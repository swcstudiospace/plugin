...
How do d.ts files work, a deep dive](/docs/handbook/declaration-files/deep-dive.html)

The TypeScript docs are an open source project. Help us improve these pages [by sending a Pull Request](https://github.com/microsoft/TypeScript-Website/blob/v2/packages/documentation/copy/en/declaration-files/Do's and Don'ts.md) ❤
