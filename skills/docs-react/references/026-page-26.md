...
```
Since `` has built-in support for transitions, pending state, and optimistically updating the count, you just need to tell the Action \_what\_ to change, and \_how\_ to change it is handled for you.
---
...
---
### Using with `` Action props {/\*use-with-a-form\*/}
