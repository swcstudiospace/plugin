...
Source: https://react.dev/learn/state-a-components-memory.md
...
Are there any limitations on \_where\_ Hooks may be called? Does this component break any rules? Check if there are any comments disabling the linter checks--this is where the bugs often hide!
