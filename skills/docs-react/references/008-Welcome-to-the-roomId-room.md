...
Source: https://react.dev/reference/react/StrictMode.md
...
\* `UNSAFE\_` class lifecycle methods like [`UNSAFE\_componentWillMount`](/reference/react/Component#unsafe\_componentwillmount). [See alternatives.](https://reactjs.org/blog/2018/03/27/update-on-async-rendering.html#migrating-from-legacy-lifecycles)
