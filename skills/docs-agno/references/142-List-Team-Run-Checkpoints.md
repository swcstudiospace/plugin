...
Source: https://docs.agno.com/api-reference/teams/list-team-run-checkpoints.md
...
## OpenAPI
````yaml /reference-api/openapi.yaml get /teams/{team\_id}/runs/{run\_id}/checkpoints
openapi: 3.1.0
info:
...
security: []
paths:
/teams/{team\_id}/runs/{run\_id}/checkpoints:
get:
tags:
- Teams
...
transcript.
operationId: list\_team\_run\_checkpoints
parameters:
- name: team\_id
in: path
required: true
