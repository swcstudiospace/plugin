# Step with Function using Additional Data - Agno

Source: https://docs.agno.com/workflows/usage/step-with-function-additional-data
...
step\_with\_function\_additional\_data.py
