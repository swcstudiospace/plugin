# Resume Workflow Run Stream - Agno

Source: https://docs.agno.com/reference-api/schema/workflows/resume-workflow-run-stream
...
```
curl --request POST \
  --url https://api.example.com/workflows/{workflow_id}/runs/{run_id}/resume \
...
fetch('https://api.example.com/workflows/{workflow_id}/runs/{run_id}/resume', options)
  .then(res => res.json())
...
curl_setopt_array($curl, [
  CURLOPT_URL => "https://api.example.com/workflows/{workflow_id}/runs/{run_id}/resume",
...
```
HttpResponse<String> response = Unirest.post("https://api.example.com/workflows/{workflow_id}/runs/{run_id}/resume")
  .header("Authorization", "Bearer <token>")
  .header("Content-Type", "application/x-www-form-urlencoded")
...
url = URI("https://api.example.com/workflows/{workflow_id}/runs/{run_id}/resume")
