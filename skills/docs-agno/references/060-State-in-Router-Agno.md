# State in Router - Agno

Source: https://docs.agno.com/state/workflows/access-session-state-in-router-selector-function
...
access\_session\_state\_in\_router\_selector\_function.py
