...
Source: https://docs.agno.com/api-reference/agents/list-all-agents.md
...
## OpenAPI
````yaml /reference-api/openapi.yaml get /agents
openapi: 3.1.0
info:
...
- id: main-agent
name: Main Agent
db\_id: c6bf0644-feb8-4930-a305-380dae5ad6aa
model:
name: OpenAIChat
model: gpt-4o
provider: OpenAI
