# List Agent Runs - Agno

Source: https://docs.agno.com/reference-api/schema/agents/list-agent-runs
...
```
HttpResponse<String> response = Unirest.get("https://api.example.com/agents/{agent_id}/runs")
  .header("Authorization", "Bearer <token>")
  .asString();
```
