...
curl_setopt_array($curl, [
  ...
  CURLOPT_POSTFIELDS => "message=%3Cstring%3E&stream=true&background=false&session_id=%3Cstring%3E&user_id=%3Cstring%3E&version=123&factory_input=%3Cstring%3E",
  CURLOPT_HTTPHEADER => [
    "Authorization: Bearer <token>",
    "Content-Type: application/x-www-form-urlencoded"
  ],
...
func main() {
	...
	payload := strings.NewReader("message=%3Cstring%3E&stream=true&background=false&session_id=%3Cstring%3E&user_id=%3Cstring%3E&version=123&factory_input=%3Cstring%3E")
...
```
HttpResponse<String> response = Unirest.post("https://api.example.com/workflows/{workflow_id}/runs")
  .header("Authorization", "Bearer <token>")
  .header("Content-Type", "application/x-www-form-urlencoded")
  .body("message=%3Cstring%3E&stream=true&background=false&session_id=%3Cstring%3E&user_id=%3Cstring%3E&version=123&factory_input=%3Cstring%3E")
  .asString();
```
...
request.body = "message=%3Cstring%3E&stream=true&background=false&session_id=%3Cstring%3E&user_id=%3Cstring%3E&version=123&factory_input=%3Cstring%3E"
