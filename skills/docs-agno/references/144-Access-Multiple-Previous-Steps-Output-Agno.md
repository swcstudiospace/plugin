# Access Multiple Previous Steps Output - Agno

Source: https://docs.agno.com/workflows/usage/access-multiple-previous-steps-output
...
access\_multiple\_previous\_steps\_output.py
