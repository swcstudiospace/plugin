# Condition and Parallel Steps Workflow - Agno

Source: https://docs.agno.com/workflows/usage/condition-and-parallel-steps-stream
...
condition\_and\_parallel\_steps\_stream.py
