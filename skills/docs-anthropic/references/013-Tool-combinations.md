...
Source: https://platform.claude.com/docs/en/agents-and-tools/tool-use/tool-combinations.md
...
{ "type": "code\_execution\_20260521", "name": "code\_execution" }
]
}
```
...
"tools": [
{ "type": "web\_search\_20260209", "name": "web\_search" },
{ "type": "web\_fetch\_20260209", "name": "web\_fetch" }
]
}
```
