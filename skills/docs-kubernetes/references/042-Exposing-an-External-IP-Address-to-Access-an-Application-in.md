...
1. Run a Hello World application in your cluster:
   ...
   [`service/load-balancer-example.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/service/load-balancer-example.yaml)![](/images/copycode.svg "Copy service/load-balancer-example.yaml to clipboard")
