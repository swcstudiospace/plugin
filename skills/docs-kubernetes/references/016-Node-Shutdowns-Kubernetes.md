...
In a Kubernetes cluster, a [node](/docs/concepts/architecture/nodes/ "A node is a worker machine in Kubernetes.")
...
[toleration](/docs/concepts/scheduling-eviction/taint-and-toleration/ "A core object consisting of three required properties: key, value, and effect. Tolerations enable the scheduling of pods on nodes or node groups that have a matching taint.") for
...
that are part of a [StatefulSet](/docs/concepts/workloads/controllers/statefulset/ "A StatefulSet manages deployment and scaling of a set of Pods, with durable storage and persistent identifiers for each Pod.")
...
Last modified March 13, 2026 at 5:55 PM PST: [Add unattended-upgrades conflict warning to node shutdown docs (ec61f9f3e4)](https://github.com/kubernetes/website/commit/ec61f9f3e481636a470c1abfc3bddcf95f9887da)
