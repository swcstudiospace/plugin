...
2. Runs commands under the cloned repositories to prepare the docs generator and
   then generates the HTML and Markdown files.
3. Copies the generated HTML and Markdown files to a local clone of the `<web-base>`
   repository under locations specified in the configuration file.
4. Updates `kubectl` command links from `kubectl`.md to the refer to
...
Last modified August 15, 2025 at 10:36 AM PST: [docs: call out kubelet ref is manual (a6a64f4a80)](https://github.com/kubernetes/website/commit/a6a64f4a80af99a3202e2db5f9dfbeca24466222)
