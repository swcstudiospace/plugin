...
[`pods/simple-pod.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/simple-pod.yaml)![](/images/copycode.svg "Copy pods/simple-pod.yaml to clipboard")
...
- Pod is a top-level resource in the Kubernetes REST API.
  The
  [Pod](/docs/reference/kubernetes-api/core/pod-v1/)
...
Last modified July 18, 2026 at 8:41 PM PST: [Clarify what .spec.os.name constrains in the Pod OS section (3a6b036358)](https://github.com/kubernetes/website/commit/3a6b0363580a1ecfac7861d8adf4c64a93674cbf)
