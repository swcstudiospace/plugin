...
by placing [containers](/docs/concepts/containers/ "A lightweight and portable executable image that contains software and all of its dependencies.") into Pods to run on *Nodes*.
...
- [API definition for Node](/docs/reference/generated/kubernetes-api/v1.36/#node-v1-core).
...
Last modified May 17, 2026 at 2:33 PM PST: [docs: use glossary tooltip shortcode for containers on Nodes page (2646f8153a)](https://github.com/kubernetes/website/commit/2646f8153a6477e1f28f8b8f6aa9e9bcfaecd41f)
