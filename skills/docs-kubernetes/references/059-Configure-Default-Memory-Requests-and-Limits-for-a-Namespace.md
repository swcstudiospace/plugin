# Configure Default Memory Requests and Limits for a Namespace | Kubernetes
...
[`admin/resource/memory-defaults.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/admin/resource/memory-defaults.yaml)![](/images/copycode.svg "Copy admin/resource/memory-defaults.yaml to clipboard")
...
[`admin/resource/memory-defaults-pod.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/admin/resource/memory-defaults-pod.yaml)![](/images/copycode.svg "Copy admin/resource/memory-defaults-pod.yaml to clipboard")
...
[`admin/resource/memory-defaults-pod-2.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/admin/resource/memory-defaults-pod-2.yaml)![](/images/copycode.svg "Copy admin/resource/memory-defaults-pod-2.yaml to clipboard")
...
[`admin/resource/memory-defaults-pod-3.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/admin/resource/memory-defaults-pod-3.yaml)![](/images/copycode.svg "Copy admin/resource/memory-defaults-pod-3.yaml to clipboard")
