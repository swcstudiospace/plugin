...
1. Go to <https://github.com/kubernetes/website/pulls>.
...
3. Once you've selected a PR to review, understand the change by:
   ...
   - Previewing the changes in the Netlify preview build by scrolling to the PR's build check
     ...
     on a tablet or smartphone device, the GitHub web UI is slightly different):![GitHub pull request details including link to Netlify preview](/images/docs/github_netlify_deploy_preview.png)To open the preview, click on the **Details** link of the **deploy/netlify** line in the
     list of checks.
4. Go to the **Files changed** tab to start your review.

   1. Click on the `+` symbol beside the line you want to comment on.
   2. Fill in any comments you have about the line and click either **Add single comment**
...
Last modified April 17, 2026 at 1:10 PM PST: [docs: mandate production builds and add preview verification (326f46f91e)](https://github.com/kubernetes/website/commit/326f46f91ec0ec8904b18f66c1ca409cb801b5df)
