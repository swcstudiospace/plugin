...
7. Create a Pod in the default namespace:
   ...
   [`security/example-baseline-pod.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/security/example-baseline-pod.yaml)![](/images/copycode.svg "Copy security/example-baseline-pod.yaml to clipboard")
...
Last modified April 12, 2026 at 7:00 PM PST: [--amend (97dfb65beb)](https://github.com/kubernetes/website/commit/97dfb65bebd27dbb54215464dff7931151e6fffa)
