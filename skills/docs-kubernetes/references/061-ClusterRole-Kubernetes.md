...
| `rules` *[PolicyRule array](https://kubernetes.io/docs/reference/kubernetes-api/definitions/policy-rule-v1-rbac/#PolicyRule)* | Rules holds all the PolicyRules for this ClusterRole |
...
| --- | --- |
| `apiVersion` *string* | APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |
| `items` **\*** *[ClusterRole array](https://kubernetes.io/docs/reference/kubernetes-api/rbac/cluster-role-v1/#ClusterRole)* | Items is a list of ClusterRoles |
| `kind` *string* | Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds |
| `metadata` *[ListMeta](https://kubernetes.io/docs/reference/kubernetes-api/definitions/list-meta-v1-meta/#ListMeta)* | Standard object's metadata. |
...
| Field | Description |
| --- | --- |
| `clusterRoleSelectors` *[LabelSelector array](https://kubernetes.io/docs/reference/kubernetes-api/definitions/label-selector-v1-meta/#LabelSelector)* | ClusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole's permissions will be added |
...
| Name | Type | Description |
| --- | --- | --- |
| `body` | *[ClusterRole](https://kubernetes.io/docs/reference/kubernetes-api/rbac/cluster-role-v1/#ClusterRole)* |  |

#### Response

| Status | Description | Response |
| --- | --- | --- |
| 200 | OK | *[ClusterRole](https://kubernetes.io/docs/reference/kubernetes-api/rbac/cluster-role-v1/#ClusterRole)* |
| 201 | Created | *[ClusterRole](https://kubernetes.io/docs/reference/kubernetes-api/rbac/cluster-role-v1/#ClusterRole)* |
| 202 | Accepted | *[ClusterRole](https://kubernetes.io/docs/reference/kubernetes-api/rbac/cluster-role-v1/#ClusterRole)* |
...
| Status | Description | Response |
| --- | --- | --- |
| 200 | OK | *[ClusterRoleList](https://kubernetes.io/docs/reference/kubernetes-api/rbac/cluster-role-v1/#ClusterRoleList)* |
