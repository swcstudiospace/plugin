...
| `MaxUnavailableStatefulSet` | `false` | Beta | 1.35.4 | – |
...
:   Enables CSI drivers to opt-in for receiving service account tokens from kubelet
    through the dedicated secrets field in NodePublishVolumeRequest instead of the volume\_context field.
...
Last modified January 27, 2026 at 10:03 AM PST: [fix: currentVersion skew in feature flag docs (#54170) (8d4885bbb0)](https://github.com/kubernetes/website/commit/8d4885bbb055ec4558520a021ab1ac65064cd896)
