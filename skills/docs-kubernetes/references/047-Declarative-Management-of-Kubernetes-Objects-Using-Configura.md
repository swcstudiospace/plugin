# Declarative Management of Kubernetes Objects Using Configuration Files | Kubernetes
...
[`application/simple_deployment.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/application/simple_deployment.yaml)![](/images/copycode.svg "Copy application/simple_deployment.yaml to clipboard")
...
[`application/update_deployment.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/application/update_deployment.yaml)![](/images/copycode.svg "Copy application/update_deployment.yaml to clipboard")
...
- [Kubernetes API Reference](/docs/reference/generated/kubernetes-api/v1.36/)
