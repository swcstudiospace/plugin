...
- Read the
  [Deployment](/docs/reference/kubernetes-api/apps/deployment-v1/) to understand the Deployment API.
- Read about [PodDisruptionBudget](/docs/concepts/workloads/pods/disruptions/) and how
  you can use it to manage application availability during disruptions.
- Use kubectl to [create a Deployment](/docs/tutorials/kubernetes-basics/deploy-app/deploy-intro/).

Last modified June 18, 2026 at 9:21 PM PST: [add cascade deletion description (a03054abc6)](https://github.com/kubernetes/website/commit/a03054abc6670d709271bb840dbdd1101eb4db87)
