# Agentic Payments (MPP & x402) - Parallel
...
### [​](#option-1-pay-with-stripe) Option 1: Pay with Stripe
...
### [​](#option-2-pay-with-tempo-stablecoins-pathusd-/-usdc) Option 2: Pay with Tempo stablecoins (pathUSD / USDC)
...
### [​](#option-3-pay-with-x402) Option 3: Pay with x402
...
### [​](#make-paid-requests) Make paid requests
...
### [​](#poll-async-task-results) Poll async task results
...
### [​](#skill-md-contents) SKILL.md contents
...
[Pi Extension](/integrations/pi-extension)[AWS Marketplace](/integrations/aws-marketplace)
