...
Source: https://docs.parallel.ai/api-reference/findall/get-findall-run-schema.md
...
# Get FindAll Run Schema
## OpenAPI
````yaml /public-openapi.json get /v1beta/findall/runs/{findall\_id}/schema
openapi: 3.1.0
info:
title: Parallel API
...
const schema = await
client.beta.findall.schema("findall\_56ccc4d188fb41a0803a935cf485c774");
