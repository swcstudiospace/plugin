# Parallel MCP Server Quickstart - Parallel

Source: https://docs.parallel.ai/integrations/mcp/quickstart

## [​](#when-to-use-parallel-mcps) When to use Parallel MCPs?
...
### [​](#search-mcp) [Search MCP](/integrations/mcp/search-mcp)
...
### [​](#task-mcp) [Task MCP](/integrations/mcp/task-mcp)
...
### [​](#let-your-agent-install-it-for-you) Let your agent install it for you
...
[LangChain](/integrations/langchain)[Programmatic Use](/integrations/mcp/programmatic-use)
