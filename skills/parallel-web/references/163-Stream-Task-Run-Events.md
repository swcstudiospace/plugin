...
Source: https://docs.parallel.ai/api-reference/tasks/stream-task-run-events.md
...
## OpenAPI
````yaml /public-openapi.json get /v1/tasks/runs/{run\_id}/events
openapi: 3.1.0
info:
title: Parallel API
...
for the task
run.
For task runs that did not have enable\_events set to true during
creation, the
frequency of events will be reduced.
...
$ref: '#/components/schemas/ErrorEvent'
title: >-
Response 200 Tasks Runs Events Get V1 Tasks Runs Run Id
Events Get
example:
