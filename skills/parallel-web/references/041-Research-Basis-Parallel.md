...
## [​](#task-run-result) Task Run Result
...
## [​](#research-basis-structure) Research Basis Structure
...
## [​](#the-fieldbasis-object) The FieldBasis object
...
### [​](#per-element-basis-beta) Per-element Basis (beta)
...
### [​](#output-with-research-basis) Output with Research Basis
...
### [​](#high-vs-low-confidence-outputs) High vs. Low Confidence Outputs
...
### [​](#per-element-basis) Per-Element Basis
...
[Task Runs Lifecycle](/task-api/guides/execute-task-run)[Interactions](/task-api/guides/interactions)
