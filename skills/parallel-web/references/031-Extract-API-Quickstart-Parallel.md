...
## [​](#1-set-up-prerequisites) 1. Set Up Prerequisites
...
## [​](#2-execute-your-first-extract) 2. Execute Your First Extract
...
[Upgrade from Beta to GA](/search/search-migration-guide)[Best Practices](/extract/best-practices)
