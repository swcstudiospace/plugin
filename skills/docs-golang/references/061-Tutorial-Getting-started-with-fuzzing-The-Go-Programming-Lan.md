...
3. Beneath the package declaration, paste the following function declaration.
   ...
   *Note:* This code is based on the `stringutil.Reverse` function within
...
1. Using your text editor, create a file called reverse\_test.go in the fuzz
   directory.
...
In your text editor, replace the unit test in reverse\_test.go with the following
fuzz test.
...
2. Since the Reverse function now returns an error, modify the `main` function to
...
3. You will need to import the errors and the unicode/utf8 packages.
   ...
   ```
4. Modify the reverse\_test.go file to check for errors and skip the test if
