...
The [`go` `version`](/cmd/go/#hdr-Print_Go_version) command now accepts arguments naming
...
the [Error Values proposal](https://go.googlesource.com/proposal/+/master/design/29934-error-values.md) and discussed on [the
...
Support for SSL version 3.0 (SSLv3) [is now deprecated and will be removed in Go 1.14](/issue/32716). Note that SSLv3 is the
