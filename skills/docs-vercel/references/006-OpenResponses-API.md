...
canonical\_url: "https://vercel.com/docs/ai-gateway/sdks-and-apis/openresponses"
...
- `top\_p` (number): Nucleus sampling. Range: 0-1
- `max\_output\_tokens` (integer): Maximum tokens to generate
- `tools` (array): Tool definitions for function calling
- `tool\_choice` (string): Tool selection mode: `auto`, `required`, or `none`
...
max\_output\_tokens: 500, // limit response length
reasoning: {
