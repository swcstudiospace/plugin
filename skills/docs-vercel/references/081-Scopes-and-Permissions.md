...
canonical\_url: "https://vercel.com/docs/sign-in-with-vercel/scopes-and-permissions"
...
| `offline\_access` | Enabling this scope issues a [Refresh Token](/docs/sign-in-with-vercel/tokens#refresh-token). |
## Permissions
