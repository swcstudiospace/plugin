...
product: vercel
url: /docs/saml
canonical\_url: "https://vercel.com/docs/saml"
...
```text
https://vercel.com/login?saml=team\_id
```
...
- [VMware](https://techdocs.broadcom.com/us/en/vmware-cis/other/vmware-identity-manager/3-3.html)
...
- [Salesforce](https://help.salesforce.com/s/articleView?id=sf.sso\_about.htm\&type=5)
