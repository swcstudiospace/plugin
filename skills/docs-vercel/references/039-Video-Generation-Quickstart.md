...
canonical\_url: "https://vercel.com/docs/ai-gateway/getting-started/video"
...
frameImages: [
{ image: 'https://example.com/your-image.png', frameType: 'first\_frame' },
],
duration: 5,
});
fs.writeFileSync('output.mp4', result.videos[0].uint8Array);
...
6. Copy the `BLOB\_READ\_WRITE\_TOKEN` to your `.env.local` file
```bash filename=".env.local"
AI\_GATEWAY\_API\_KEY=your\_ai\_gateway\_api\_key
BLOB\_READ\_WRITE\_TOKEN=your\_blob\_token
```
