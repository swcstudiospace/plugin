...
product: vercel
url: /docs/accounts
canonical\_url: "https://vercel.com/docs/accounts"
...
--header "Authorization: Bearer $VERCEL\_TOKEN" \
...
- Navigate to the following URL, replacing `your\_team\_name\_here` with your actual team's name: `https://vercel.com/teams/your\_team\_name\_here/settings#team-id`.
...
Your primary email address is the email address that will be used to send you notifications, such as when you receive a new [preview comment](/docs/comments) or when you are [invited to a team](/docs/rbac/managing-team-members#adding-team-members-and-assigning-roles).
