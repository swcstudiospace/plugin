...
canonical\_url: "https://vercel.com/docs/sign-in-with-vercel/tokens"
last\_updated: 2026-03-30
type: how-to
prerequisites:
...
"aud": "cl\_be6c3c8b9f340d4a20feefab2862a49a",
"exp": 1519948800,
"iat": 1519945200,
"nbf": 1519945200,
"jti": "50e67781-c8b6-4391-98d1-89d755bb095a",
"name": "Timmy Triangle",
"preferred\_username": "timmy-triangle",
...
audience: [process.env.NEXT\_PUBLIC\_VERCEL\_APP\_CLIENT\_ID],
});
return payload;
}
```
...
| `aud` | string | \*\*Audience\*\* - The ID of the Vercel application | `"cl\_be6c3c8b9f340d4a20feefab2862a49a"` |
...
| `profile` | `preferred\_username` | The user's username on Vercel | `"timmy-triangle"` |
...
vca\_BQuu9ChDu3n6Pfh6YQnCshpoYkWDSFKogLqmBtQ0tC8NAA5rXt340sjz
```
...
vcr\_BQuu9ChDu3n6Pfh6YQnCshpoYkWDSFKogLqmBtQ0tC8NAA5rXt340sjz
```
