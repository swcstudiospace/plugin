...
canonical\_url: "https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/protection-bypass-automation"
last\_updated: 2026-04-30
type: how-to
prerequisites:
...
You can create multiple bypass secrets per project to manage access independently for different tools (for example, "CI/CD pipeline" or "Playwright tests"). Vercel automatically sets one secret as the `VERCEL\_AUTOMATION\_BYPASS\_SECRET` [system environment variable](/docs/environment-variables/system-environment-variables#VERCEL\_AUTOMATION\_BYPASS\_SECRET) in your deployments. When you have multiple secrets, you can choose which one to use as the environment variable.
...
"request\_url": "https://your-app.vercel.app/api/slack/events?x-vercel-protection-bypass=your-generated-secret"
},
"interactivity": {
"request\_url": "https://your-app.vercel.app/api/slack/interactions?x-vercel-protection-bypass=your-generated-secret"
}
}
}
```
