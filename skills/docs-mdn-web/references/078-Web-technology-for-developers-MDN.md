...
## [Documentation for Web developers](#documentation_for_web_developers)
...
## [Web technology references](#web_technology_references)
...
## [Developer tools documentation](#developer_tools_documentation)
...
[Chrome DevTools](https://developer.chrome.com/docs/devtools/ "External link (opens in new tab)")
:   Documentation for the set of web-developer tools built into Chrome.

[Safari Web Inspector](https://webkit.org/web-inspector/ "External link (opens in new tab)")
:   Documentation for the set of web-developer tools built into Safari.

[Edge DevTools](https://learn.microsoft.com/en-us/microsoft-edge/devtools/landing/ "External link (opens in new tab)")
