...
A [`for`](/en-US/docs/Web/JavaScript/Reference/Statements/for) loop repeats until a specified condition evaluates to false. The JavaScript `for` loop is similar to the Java and C `for` loop.
...
The [`do...while`](/en-US/docs/Web/JavaScript/Reference/Statements/do...while) statement repeats until a
...
A [`while`](/en-US/docs/Web/JavaScript/Reference/Statements/while) statement executes its statements as long as a
...
A [`label`](/en-US/docs/Web/JavaScript/Reference/Statements/label) provides a statement with an identifier that
...
Use the [`break`](/en-US/docs/Web/JavaScript/Reference/Statements/break) statement to terminate a loop,
...
The [`continue`](/en-US/docs/Web/JavaScript/Reference/Statements/continue) statement can be used to restart a
...
The [`for...in`](/en-US/docs/Web/JavaScript/Reference/Statements/for...in) statement iterates a specified
...
Although it may be tempting to use this as a way to iterate over [`Array`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array)
elements, the `for...in` statement will return the name of your user-defined
properties in addition to the numeric indexes.

Therefore, it is better to use a traditional [`for`](/en-US/docs/Web/JavaScript/Reference/Statements/for) loop
...
The [`for...of`](/en-US/docs/Web/JavaScript/Reference/Statements/for...of) statement creates a loop Iterating
over [iterable objects](/en-US/docs/Web/JavaScript/Reference/Iteration_protocols) (including
[`Array`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array), [`Map`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map), [`Set`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set),
[`arguments`](/en-US/docs/Web/JavaScript/Reference/Functions/arguments) object and so on), invoking a custom
...
[`for...in`](/en-US/docs/Web/JavaScript/Reference/Statements/for...in) loop. While `for...in` iterates
...
The `for...of` and `for...in` statements can also be used with [destructuring](/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring). For example, you can simultaneously loop over the keys and values of an object using [`Object.entries()`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/entries).
...
- [Previous](/en-US/docs/Web/JavaScript/Guide/Control_flow_and_error_handling)
- [Next](/en-US/docs/Web/JavaScript/Guide/Functions)
