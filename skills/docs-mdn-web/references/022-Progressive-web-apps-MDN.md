...
:   This intermediate-level tutorial walks through the creation of a PWA that lists information about games submitted to the A-Frame category in the [js13kGames 2017](https://js13kgames.com/2017/ "External link (opens in new tab)") competition. This tutorial includes all the basics for creating a PWA, with additional features, including notifications, push, and app performance.
...
### [Web app manifest](#web_app_manifest)
...
### [Service Worker APIs](#service_worker_apis)
...
- [Progressive web apps](https://web.dev/explore/progressive-web-apps "External link (opens in new tab)") on web.dev
- [Learn PWA](https://web.dev/learn/pwa/ "External link (opens in new tab)") on web.dev
- [Progressive web apps](https://learn.microsoft.com/en-us/microsoft-edge/progressive-web-apps/ "External link (opens in new tab)") on learn.microsoft.com (2023)
