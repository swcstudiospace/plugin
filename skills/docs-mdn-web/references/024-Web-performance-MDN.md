...
## [Web performance guides](#web_performance_guides)
...
:   Animations are critical for a pleasurable user experience on many applications. There are many ways to implement web animations, such as CSS [`transitions`](/en-US/docs/Web/CSS/Reference/Properties/transition)/[`animations`](/en-US/docs/Web/CSS/Reference/Properties/animation) or JavaScript-based animations (using [`requestAnimationFrame()`](/en-US/docs/Web/API/Window/requestAnimationFrame "requestAnimationFrame()")). In this article, we analyze the performance differences between CSS-based and JavaScript-based animation.

[Animation performance and frame rate](/en-US/docs/Web/Performance/Guides/Animation_performance_and_frame_rate)
:   Animation on the web can be done via [`SVG`](/en-US/docs/Web/API/SVGAnimationElement "SVG"), [`JavaScript`](/en-US/docs/Web/API/Window/requestAnimationFrame "JavaScript"), including [`<canvas>`](/en-US/docs/Web/HTML/Reference/Elements/canvas) and [`WebGL`](/en-US/docs/Web/API/WebGL_API "WebGL"), CSS [`animation`](/en-US/docs/Web/CSS/Reference/Properties/animation), [`<video>`](/en-US/docs/Web/HTML/Reference/Elements/video), animated GIFs and even animated PNGs and other image types.
    The performance cost of animating a CSS property can vary from one property to another, and animating expensive CSS properties can result in [Jank](/en-US/docs/Glossary/Jank) as the browser struggles to hit a smooth [frame rate](/en-US/docs/Glossary/FPS).

## [Tutorials for beginners](#tutorials_for_beginners)
...
## [Performance APIs](#performance_apis)
...
:   The Performance API allows high precision measurements that are based on time in potential sub-millisecond resolution and a stable monotonic clock that is not subject to system clock skew or adjustments.
    The high resolution timers are needed for accurate benchmarking instead of the less precise and non-monotonic [`Date`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) timestamps.
...
:   **Long animation frames** (LoAFs) can impact the user experience of a website.
    ...
    The [Long Animation Frames API](https://w3c.github.io/long-animation-frames/ "External link (opens in new tab)") allows developers to get information about the long animation frames and better understand their root causes. This article shows how to use the Long Animation Frames API.

[Monitoring bfcache blocking reasons](/en-US/docs/Web/API/Performance_API/Monitoring_bfcache_blocking_reasons)
:   The [`PerformanceNavigationTiming.notRestoredReasons`](/en-US/docs/Web/API/PerformanceNavigationTiming/notRestoredReasons) property reports information on why the current document was blocked from using the [bfcache](/en-US/docs/Glossary/bfcache) on navigation.
...
:   Navigation Timing provides metrics associated with navigating from one page to another via the [PerformanceNavigationTiming](/en-US/docs/Web/API/PerformanceNavigationTiming) API.
    For example, you can determine how much time it takes to load or unload a document, or log the time it took until [DOM](/en-US/docs/Glossary/DOM) construction has finished and interaction with the DOM is possible.
...
:   Resource Timing enables retrieving and analyzing detailed network timing data for the loading of an application's resources.
    An application can use the timing metrics to determine, for example, the length of time it takes to load a specific resource (such as an image or a script) either implicitly as part of page load or explicitly from JavaScript, for example using the [`fetch()`](/en-US/docs/Web/API/Window/fetch "fetch()") API.
...
:   The Intersection Observer API provides a way to asynchronously observe changes in the intersection of a target element with an ancestor element or with a top-level document's [Viewport](/en-US/docs/Glossary/Viewport).
...
:   The **`deviceMemory`** read-only property of the [`Navigator`](/en-US/docs/Web/API/Navigator) interface returns the approximate amount of device memory in gigabytes.

[FetchEvent.preloadResponse](/en-US/docs/Web/API/FetchEvent/preloadResponse)
:   The **`preloadResponse`** read-only property of the [`FetchEvent`](/en-US/docs/Web/API/FetchEvent) interface returns a [`Promise`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) that resolves to the navigation preload [`Response`](/en-US/docs/Web/API/Response) if [navigation preload](/en-US/docs/Web/API/NavigationPreloadManager) was triggered, or `undefined` otherwise.

## [Profiling and tooling](#profiling_and_tooling)

[Firefox Profiler Performance Features](https://profiler.firefox.com/docs/#/ "External link (opens in new tab)")
:   This website provides information on how to use and understand the performance features in your developer tools, including [Call Tree](https://profiler.firefox.com/docs/#/./guide-ui-tour-panels?id=the-call-tree "External link (opens in new tab)"), [Flame Graph](https://profiler.firefox.com/docs/#/./guide-ui-tour-panels?id=the-flame-graph "External link (opens in new tab)"), [Stack Chart](https://profiler.firefox.com/docs/#/./guide-ui-tour-panels?id=the-stack-chart "External link (opens in new tab)"), [Marker Chart](https://profiler.firefox.com/docs/#/./guide-ui-tour-panels?id=the-marker-chart "External link (opens in new tab)") and [Network Chart](https://profiler.firefox.com/docs/#/./guide-ui-tour-panels?id=the-network-chart "External link (opens in new tab)").

[Profiling with the built-in profiler](https://profiler.firefox.com/docs/#/./guide-getting-started "External link (opens in new tab)")
...
- Glossary terms:
  ...
  - [Brotli compression](/en-US/docs/Glossary/Brotli_compression)
  - [Content Delivery Networks (CDN)](/en-US/docs/Glossary/CDN)
  - [Cumulative Layout Shifts (CLS)](/en-US/docs/Glossary/CLS)
  - [Code splitting](/en-US/docs/Glossary/Code_splitting)
  - [CSSOM](/en-US/docs/Glossary/CSSOM)
  - [Domain sharding](/en-US/docs/Glossary/Domain_sharding)
  - [Effective connection type](/en-US/docs/Glossary/Effective_connection_type)
  - [First contentful paint (FCP)](/en-US/docs/Glossary/First_contentful_paint)
  - [First CPU idle](/en-US/docs/Glossary/First_CPU_idle)
  - [First paint](/en-US/docs/Glossary/First_paint)
  - [gzip\_compression](/en-US/docs/Glossary/gzip_compression)
  - [HTTP/2](/en-US/docs/Glossary/HTTP_2)
  - [HTTP](/en-US/docs/Glossary/HTTP)
  - [Interaction to next paint (INP)](/en-US/docs/Glossary/Interaction_to_next_paint)
  - [Jank](/en-US/docs/Glossary/Jank)
  - [Largest Contentful Paint (LCP)](/en-US/docs/Glossary/Largest_contentful_paint)
  - [Latency](/en-US/docs/Glossary/Latency)
  - [Lazy load](/en-US/docs/Glossary/Lazy_load)
  - [Long task](/en-US/docs/Glossary/Long_task)
  - [Lossless compression](/en-US/docs/Glossary/Lossless_compression)
  - [Lossy compression](/en-US/docs/Glossary/Lossy_compression)
  - [Main thread](/en-US/docs/Glossary/Main_thread)
  - [Minification](/en-US/docs/Glossary/Minification)
  - [Network throttling](/en-US/docs/Glossary/Network_throttling)
  - [Packet](/en-US/docs/Glossary/Packet)
  - [Page load time](/en-US/docs/Glossary/Page_load_time)
  - [Page prediction](/en-US/docs/Glossary/Page_prediction)
  - [Parse](/en-US/docs/Glossary/Parse)
  ...
  - [QUIC](/en-US/docs/Glossary/QUIC)
  - [RAIL](/en-US/docs/Glossary/RAIL)
  - [Real User Monitoring (RUM)](/en-US/docs/Glossary/Real_User_Monitoring)
  - [Resource Timing](/en-US/docs/Glossary/Resource_Timing)
  - [Round Trip Time (RTT)](/en-US/docs/Glossary/Round_Trip_Time)
  - [Server Timing](/en-US/docs/Glossary/Server_Timing)
  - [Speculative parsing](/en-US/docs/Glossary/Speculative_parsing)
  - [Speed index](/en-US/docs/Glossary/Speed_index) (and Perceptual Speed Index)
  - [SSL](/en-US/docs/Glossary/SSL)
  - [Synthetic monitoring](/en-US/docs/Glossary/Synthetic_monitoring)
  - [TCP handshake](/en-US/docs/Glossary/TCP_handshake)
  - [TCP slow start](/en-US/docs/Glossary/TCP_slow_start)
  - [Transmission Control Protocol (TCP)](/en-US/docs/Glossary/TCP)
  - [Time to first byte (TTFB)](/en-US/docs/Glossary/Time_to_first_byte)
  - [Time to interactive (TTI)](/en-US/docs/Glossary/Time_to_interactive)
  - [TLS](/en-US/docs/Glossary/TLS)
  - [Tree shaking](/en-US/docs/Glossary/Tree_shaking)
  - [Web performance](/en-US/docs/Glossary/Web_performance)
- [Performance in Firefox Developer Tools](https://profiler.firefox.com/docs/#/ "External link (opens in new tab)")
