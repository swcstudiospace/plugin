...
## [How to use the tool](#how_to_use_the_tool)

Enter a color in any format or pick one in the sRGB [color space](/en-US/docs/Glossary/Color_space). You can also adjust the opacity (alpha channel).
