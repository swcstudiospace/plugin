...
This scoping effect can be mitigated by using [`let`](/en-US/docs/Web/JavaScript/Reference/Statements/let) or [`const`](/en-US/docs/Web/JavaScript/Reference/Statements/const).
...
[`Boolean`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean) object!
...
- [Previous](/en-US/docs/Web/JavaScript/Guide/Grammar_and_types)
- [Next](/en-US/docs/Web/JavaScript/Guide/Loops_and_iteration)
