...
## [​](#the-nitpick-problem) The Nitpick Problem
...
## [​](#how-greptile-learns-to-filter-noise) How Greptile Learns to Filter Noise

### [​](#1-commit-analysis) 1. Commit Analysis

Greptile reads the **first** and **last** commit of every PR to see which comments were addressed:

### [​](#2-learning-from-reactions) 2. Learning from Reactions
...
### [​](#3-learning-examples) 3. Learning Examples
...
### [​](#what-gets-suppressed-vs-what-doesn’t) What Gets Suppressed vs. What Doesn’t
...
## [​](#the-result-focused-reviews) The Result: Focused Reviews
