...
| [C](https://en.wikipedia.org/wiki/C\_(programming\_language)) | [`hiredis`](https://github.com/redis/hiredis) | [`hiredis` guide](https://redis.io/docs/latest/develop/clients/hiredis) | Yes |
...
See [Client library support and versioning policy](https://redis.io/docs/latest/develop/clients/version-support)
...
| [Dart](https://dart.dev/) | redis\_dart\_link | https://github.com/toolsetlink/redis\_dart\_link | https://github.com/toolsetlink/redis\_dart\_link |
...
(see [Install Redis Open Source](https://redis.io/docs/latest/operate/oss\_and\_stack/install/install-stack/)) or with a free trial of [Redis Cloud](https://redis.io/docs/latest/operate/rc).
