...
"group": "di",
"tableOfContents": {"sections":[{"id":"rdi-in-redis-cloud","title":"RDI in Redis Cloud"},{"id":"features","title":"Features"},{"id":"when-to-use-rdi","title":"When to use RDI"},{"id":"supported-source-databases","title":"Supported source databases"},{"id":"continue-learning-with-redis-university","title":"Continue learning with Redis University"},{"id":"documentation","title":"Documentation"}]}
,
"codeExamples": []
}
```
...
[\*Change Data Capture (CDC)\*](https://en.wikipedia.org/wiki/Change\_data\_capture) mechanism.
...
See [Data Integration](https://redis.io/docs/latest/operate/rc/rdi) in the Redis Cloud documentation for
...
disconnection. See [Backpressure mechanism](https://redis.io/docs/latest/integrate/redis-data-integration/architecture#backpressure-mechanism) for more information.
...
[When to use RDI](https://redis.io/docs/latest/integrate/redis-data-integration/when-to-use)
