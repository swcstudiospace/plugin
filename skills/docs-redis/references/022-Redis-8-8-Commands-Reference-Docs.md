# Redis 8.8 Commands Reference | Docs

Source: https://redis.io/docs/latest/commands/redis-8-8-commands
...
**[INCREX](/commands/increx/)** - Increments the numeric value of a key by a number and sets its expiration time. Uses 0 as initial value if the key doesn't exist. ⭐ New in 8.8

**Syntax:** `INCREX key [BYFLOAT float | BYINT integer] [LBOUND lowerbound] [UBOUND upperbound] [OVERFLOW <FAIL | SAT | REJECT>] [EX seconds | PX milliseconds| EXAT unix-time-seconds | PXAT unix-time-milliseconds | PERSIST] [ENX]`
...
**Syntax:** `ZINTER numkeys key [key ...] [WEIGHTS weight [weight ...]] [AGGREGATE <SUM | MIN | MAX | COUNT>] [WITHSCORES]`
...
**Syntax:** `ZINTERSTORE destination numkeys key [key ...] [WEIGHTS weight [weight ...]] [AGGREGATE <SUM | MIN | MAX | COUNT>]`
...
**Syntax:** `ZUNION numkeys key [key ...] [WEIGHTS weight [weight ...]] [AGGREGATE <SUM | MIN | MAX | COUNT>] [WITHSCORES]`
...
**Syntax:** `ZUNIONSTORE destination numkeys key [key ...] [WEIGHTS weight [weight ...]] [AGGREGATE <SUM | MIN | MAX | COUNT>]`
...
**[XCFGSET](/commands/xcfgset/)** - Sets the IDMP configuration parameters for a stream.

**Syntax:** `XCFGSET key [IDMP-DURATION idmp-duration] [IDMP-MAXSIZE idmp-maxsize]`
...
**[XIDMPRECORD](/commands/xidmprecord/)** - An internal command for setting IDMP metadata on an existing stream message. ⭐ New in 8.8
...
**[XNACK](/commands/xnack/)** - Releases pending messages back to the group's PEL without acknowledging them, making them available for re-delivery. ⭐ New in 8.8

**Syntax:** `XNACK key group <SILENT | FAIL | FATAL> IDS numids id [id ...] [RETRYCOUNT count] [FORCE]`
...
**[ARCOUNT](/commands/arcount/)** - Returns the number of non-empty elements in an array. ⭐ New in 8.8
...
**[ARDEL](/commands/ardel/)** - Deletes elements at the specified indices in an array. ⭐ New in 8.8
...
**[ARDELRANGE](/commands/ardelrange/)** - Deletes elements in one or more ranges. ⭐ New in 8.8
...
**[ARGET](/commands/arget/)** - Gets the value at an index in an array. ⭐ New in 8.8
...
**[ARGETRANGE](/commands/argetrange/)** - Gets values in a range of indices. ⭐ New in 8.8
...
**[ARGREP](/commands/argrep/)** - Searches array elements in a range using textual predicates. ⭐ New in 8.8

**Syntax:** `ARGREP key start end <EXACT string | MATCH string | GLOB pattern | RE pattern [...]> [AND | OR | LIMIT limit | WITHVALUES | NOCASE [...]]`
...
**[ARINFO](/commands/arinfo/)** - Returns metadata about an array. ⭐ New in 8.8
...
**[ARINSERT](/commands/arinsert/)** - Inserts one or more values at consecutive indices. ⭐ New in 8.8
...
**[ARLASTITEMS](/commands/arlastitems/)** - Returns the most recently inserted elements. ⭐ New in 8.8
...
**[ARLEN](/commands/arlen/)** - Returns the length of an array (max index + 1). ⭐ New in 8.8
...
**[ARMGET](/commands/armget/)** - Gets values at multiple indices in an array. ⭐ New in 8.8
...
**[ARMSET](/commands/armset/)** - Sets multiple index-value pairs in an array. ⭐ New in 8.8
...
**[ARNEXT](/commands/arnext/)** - Returns the next index ARINSERT would use. ⭐ New in 8.8
...
**[AROP](/commands/arop/)** - Performs aggregate operations on array elements in a range. ⭐ New in 8.8

**Syntax:** `AROP key start end <SUM | MIN | MAX | AND | OR | XOR | MATCH value | USED>`
...
**[ARRING](/commands/arring/)** - Inserts values into a ring buffer of specified size, wrapping and truncating as needed. ⭐ New in 8.8
...
**[ARSCAN](/commands/arscan/)** - Iterates existing elements in a range, returning index-value pairs. ⭐ New in 8.8
...
**[ARSEEK](/commands/arseek/)** - Sets the ARINSERT / ARRING cursor to a specific index. ⭐ New in 8.8
...
**[ARSET](/commands/arset/)** - Sets one or more contiguous values starting at an index in an array. ⭐ New in 8.8
...
**[JSON.OBJKEYS](/commands/json.objkeys/)** - Returns the key names of JSON objects at the paths matching a given path expression
...
**[JSON.OBJLEN](/commands/json.objlen/)** - Returns the number of keys in JSON objects at the paths matching a given path expression
...
**[JSON.STRAPPEND](/commands/json.strappend/)** - Appends a string to JSON strings at the paths matching a given path expression
...
**[JSON.STRLEN](/commands/json.strlen/)** - Returns the length of JSON strings at the paths matching a given path expression
...
**Syntax:** `TS.MRANGE fromTimestamp toTimestamp [LATEST] [FILTER BY TS Timestamp [Timestamp ...]] [FILTER BY VALUE min max] [WITHLABELS | SELECTED LABELS label1 [label1 ...]] [COUNT count] [[ALIGN value] AGGREGATION aggregators bucketDuration [BUCKETTIMESTAMP] [EMPTY]] FILTER <l=v | l!=v | l= | l!= | l=(v1,v2,...) | l!=(v1,v2,...) [l=v | l!=v | l= | l!= | l=(v1,v2,...) | l!=(v1,v2,...) ...]> [GROUPBY label REDUCE reducer]`
...
**Syntax:** `TS.MREVRANGE fromTimestamp toTimestamp [LATEST] [FILTER BY TS Timestamp [Timestamp ...]] [FILTER BY VALUE min max] [WITHLABELS | SELECTED LABELS label1 [label1 ...]] [COUNT count] [[ALIGN value] AGGREGATION aggregators bucketDuration [BUCKETTIMESTAMP] [EMPTY]] FILTER <l=v | l!=v | l= | l!= | l=(v1,v2,...) | l!=(v1,v2,...) [l=v | l!=v | l= | l!= | l=(v1,v2,...) | l!=(v1,v2,...) ...]> [GROUPBY label REDUCE reducer]`
...
**Syntax:** `TS.RANGE key fromTimestamp toTimestamp [LATEST] [FILTER BY TS Timestamp [Timestamp ...]] [FILTER BY VALUE min max] [COUNT count] [[ALIGN value] AGGREGATION aggregators bucketDuration [BUCKETTIMESTAMP] [EMPTY]]`
...
**Syntax:** `TS.REVRANGE key fromTimestamp toTimestamp [LATEST] [FILTER BY TS Timestamp [Timestamp ...]] [FILTER BY VALUE min max] [COUNT count] [[ALIGN value] AGGREGATION aggregators bucketDuration [BUCKETTIMESTAMP] [EMPTY]]`
...
**[HOTKEYS](/commands/hotkeys/)** - A container for hotkeys tracking commands.
...
**[HOTKEYS GET](/commands/hotkeys-get/)** - Returns lists of top K hotkeys depending on metrics chosen in HOTKEYS START command.
...
**[HOTKEYS RESET](/commands/hotkeys-reset/)** - Release the resources used for hotkey tracking.
...
**[HOTKEYS START](/commands/hotkeys-start/)** - Starts hotkeys tracking.
...
**[HOTKEYS STOP](/commands/hotkeys-stop/)** - Stops hotkeys tracking.
