...
- [SLSA Build Level 3 provenance](/dhi/explore/security-concepts/slsa/),
  [signed
  SBOMs](/dhi/explore/security-concepts/sbom/),
  [VEX statements](/dhi/explore/security-concepts/vex/),
  and
  [cryptographic signatures](/dhi/explore/security-concepts/signatures/) on every image
- Built on Alpine and Debian with
  [glibc and musl
...
## [Select and Enterprise features](#select-and-enterprise-features)
...
[Understand the secure supply chain principles that make Docker Hardened Images production-ready.](/dhi/explore/security-concepts/)

[Browse and manage Docker Hardened Images using Docker Hub, the CLI, MCP server, or Terraform.](/dhi/tools/)

[Guides, GitHub repositories, community channels, and how to give feedback.](/dhi/resources/)
