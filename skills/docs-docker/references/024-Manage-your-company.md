...
Source: https://docs.docker.com/admin/company/manage.md
...
seats, see [Company roles](/admin/company/#company-roles).
### Add a company owner
...
[Manage members on a team](/admin/organization/manage/members/#manage-members-on-a-team).
