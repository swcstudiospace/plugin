...
Source: https://docs.docker.com/accounts/manage-account.md
...
organization](/admin/organization/setup/convert-account/).
## Deactivate your account
For information on deactivating your account, see
[Deactivate a Docker account](/accounts/deactivate-user-account/).
## What's next
- [Docker accounts overview](/accounts/)
