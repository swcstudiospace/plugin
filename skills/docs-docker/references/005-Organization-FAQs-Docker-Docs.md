# Organization FAQs | Docker Docs

Source: https://docs.docker.com/admin/organization/organization-faqs
...
- Ensures security features like
  ...
  [Registry Access Management](https://docs.docker.com/enterprise/security/hardened-desktop/registry-access-management/) are applied.
