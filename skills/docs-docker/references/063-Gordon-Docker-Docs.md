...
Requires:
Docker Desktop
[4.74.0](https://docs.docker.com/desktop/release-notes/#4740) or later
...
4. Type a question: "What containers are running?"
   ...
   ![Gordon running in Docker Desktop](https://docs.docker.com/ai/gordon/images/gordon_gui.avif)
...
2. Type a question: "what containers are running?" and press `Enter`.
   ...
   ![Gordon running in the terminal](https://docs.docker.com/ai/gordon/images/gordon_tui.avif)
...
![Gordon permission request](https://docs.docker.com/ai/gordon/images/gordon_permissions_prompt.avif)
