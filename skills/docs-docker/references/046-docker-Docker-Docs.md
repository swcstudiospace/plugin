...
the
[installation](/install/) instructions for your operating system.
...
see the
[**Credential stores** section in the `docker login` documentation](/reference/cli/docker/login/#credential-stores)
...
[Daemon proxy configuration](/engine/daemon/proxy/)
...
[create a context](/reference/cli/docker/context/create/),
