...
Source: https://docs.docker.com/accounts/deactivate-user-account.md
...
[Deactivate an organization](/admin/organization/deactivate-account/).
> [!WARNING]
>
...
subscription](/subscription/plans/docker/#cancel-a-docker-plan).
- Download any images and tags you want to keep. Use
`docker pull -a ` to pull all tags, or `docker pull :`
