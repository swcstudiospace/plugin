# calendar — General calendar-related functions — Python 3.14.6 documentation

Source: https://docs.python.org/3/library/calendar.html
...
:   A subclass of [`ValueError`](exceptions.html#ValueError "ValueError") and [`IndexError`](exceptions.html#IndexError "IndexError"),
    raised when the given month number is outside of the range 1-12 (inclusive).

    Changed in version 3.12: `IllegalMonthError` is now also a subclass of
    [`ValueError`](exceptions.html#ValueError "ValueError"). New code should avoid catching
    [`IndexError`](exceptions.html#IndexError "IndexError").
