...
**Source code:** [Lib/tkinter/\_\_init\_\_.py](https://github.com/python/cpython/tree/3.14/Lib/tkinter/__init__.py)
...
See the source code for the [`_tkinter`](#module-_tkinter "_tkinter: A binary module that contains the low-level interface to Tcl/Tk.") module for more information about
supported versions.
...
along with a new API to use them (see [`tkinter.ttk`](tkinter.ttk.html#module-tkinter.ttk "tkinter.ttk: Tk themed widget set")).
...
- [Tk commands](https://www.tcl-lang.org/man/tcl9.0/TkCmd/index.html)
...
main `tkinter` module, as well as the [`tkinter.ttk`](tkinter.ttk.html#module-tkinter.ttk "tkinter.ttk: Tk themed widget set") module, which provides
...
[`tkinter.colorchooser`](tkinter.colorchooser.html#module-tkinter.colorchooser "tkinter.colorchooser: Color choosing dialog")
:   Dialog to let the user choose a color.

[`tkinter.commondialog`](dialog.html#module-tkinter.commondialog "tkinter.commondialog: Tkinter base class for dialogs")
:   Base class for the dialogs defined in the other modules listed here.

[`tkinter.filedialog`](dialog.html#module-tkinter.filedialog "tkinter.filedialog: Dialog classes for file selection")
:   Common dialogs to allow the user to specify a file to open or save.

[`tkinter.font`](tkinter.font.html#module-tkinter.font "tkinter.font: Tkinter font-wrapping class")
:   Utilities to help work with fonts.

[`tkinter.messagebox`](tkinter.messagebox.html#module-tkinter.messagebox "tkinter.messagebox: Various types of alert dialogs")
:   Access to standard Tk dialog boxes.

[`tkinter.scrolledtext`](tkinter.scrolledtext.html#module-tkinter.scrolledtext "tkinter.scrolledtext: Text widget with a vertical scroll bar.")
:   Text widget with a vertical scroll bar built in.

[`tkinter.simpledialog`](dialog.html#module-tkinter.simpledialog "tkinter.simpledialog: Simple dialog windows")
:   Basic dialogs and convenience functions.

[`tkinter.ttk`](tkinter.ttk.html#module-tkinter.ttk "tkinter.ttk: Tk themed widget set")
...
[`idlelib`](idle.html#module-idlelib "idlelib: Implementation package for the IDLE shell/editor.")
...
[`tkinter.dnd`](tkinter.dnd.html#module-tkinter.dnd "tkinter.dnd: Tkinter drag-and-drop interface")
:   (experimental) Drag-and-drop support for `tkinter`. This will
    become deprecated when it is replaced with the Tk DND.

[`turtle`](turtle.html#module-turtle "turtle: An educational framework for simple graphics applications")
...
After the imports, the next line creates an instance of the [`Tk`](#tkinter.Tk "tkinter.Tk") class,
...
The [`grid()`](#tkinter.Grid.grid "tkinter.Grid.grid") method is used to specify the relative layout (position)
...
When pressed, it will call the [`destroy()`](#tkinter.Misc.destroy "tkinter.Misc.destroy") method of the root window.

Finally, the [`mainloop()`](#tkinter.mainloop "tkinter.mainloop") method puts everything on the display, and
...
:   A Tkinter user interface is made up of individual *widgets*. Each widget is
    ...
    [`ttk.Frame`](tkinter.ttk.html#tkinter.ttk.Frame "tkinter.ttk.Frame"), [`ttk.Label`](tkinter.ttk.html#tkinter.ttk.Label "tkinter.ttk.Label"), and [`ttk.Button`](tkinter.ttk.html#tkinter.ttk.Button "tkinter.ttk.Button").
...
commands in the Tcl interpreter attached to your application’s [`Tk`](#tkinter.Tk "tkinter.Tk")
instance.
...
[`configure()`](#tkinter.Misc.configure "tkinter.Misc.configure") method, which returns a dictionary containing a variety
of information about each object, including its default and current values.
Use [`keys()`](#tkinter.Misc.keys "tkinter.Misc.keys") to get just the names of each option.
...
Each [`Tk`](#tkinter.Tk "tkinter.Tk") object created by `tkinter` contains a Tcl interpreter.
...
[`Tk.mainloop`](#tkinter.Misc.mainloop "tkinter.Misc.mainloop")) and responds to events.
...
- While `tkinter` allows you to create more than one instance of a [`Tk`](#tkinter.Tk "tkinter.Tk")
...
belong to the classic `tkinter` widgets.
The themed [`tkinter.ttk`](tkinter.ttk.html#module-tkinter.ttk "tkinter.ttk: Tk themed widget set") widgets recommended in the introduction
do not accept them;
style a themed widget through the [`ttk.Style`](tkinter.ttk.html#tkinter.ttk.Style "tkinter.ttk.Style")
class instead.
...
or can be queried at runtime by calling the [`config()`](#tkinter.Misc.config "tkinter.Misc.config") method without
arguments, or by calling the [`keys()`](#tkinter.Misc.keys "tkinter.Misc.keys") method on that widget.
...
Classic and themed [`tkinter.ttk`](tkinter.ttk.html#module-tkinter.ttk "tkinter.ttk: Tk themed widget set") widgets can be managed interchangeably.

Warning

Do not apply `pack()` and `grid()` to two widgets that share the same container.
...
is documented under [`Grid.grid_configure()`](#tkinter.Grid.grid_configure "tkinter.Grid.grid_configure"), [`Pack.pack_configure()`](#tkinter.Pack.pack_configure "tkinter.Pack.pack_configure")
and [`Place.place_configure()`](#tkinter.Place.place_configure "tkinter.Place.place_configure");
see also the *[grid(3tk)](https://manpages.debian.org/grid(3tk))*, *[pack(3tk)](https://manpages.debian.org/pack(3tk))* and *[place(3tk)](https://manpages.debian.org/place(3tk))*
man pages.
...
A widget can be linked only to a [`Variable`](#tkinter.Variable "tkinter.Variable") object,
not to an ordinary Python variable.
This is not a limitation of `tkinter`
...
A `Variable` sidesteps this by keeping its value inside the Tcl interpreter
and exposing it through explicit [`get()`](#tkinter.Variable.get "tkinter.Variable.get") and [`set()`](#tkinter.Variable.set "tkinter.Variable.set") methods.

Ready-made subclasses cover the common types:
[`StringVar`](#tkinter.StringVar "tkinter.StringVar"), [`IntVar`](#tkinter.IntVar "tkinter.IntVar"), [`DoubleVar`](#tkinter.DoubleVar "tkinter.DoubleVar") and [`BooleanVar`](#tkinter.BooleanVar "tkinter.BooleanVar").
Pass one as a widget’s `textvariable` (or `variable`) option,
then read and update it with [`get()`](#tkinter.Variable.get "tkinter.Variable.get") and [`set()`](#tkinter.Variable.set "tkinter.Variable.set");
...
A [`Variable`](#tkinter.Variable "tkinter.Variable") that is garbage collected removes its underlying Tcl variable,
breaking the connection to the widget (see `Variable`).
...
Tk gives access to these through the [`Wm`](#tkinter.Wm "tkinter.Wm") mixin,
which is inherited by the [`Tk`](#tkinter.Tk "tkinter.Tk") root window and by every [`Toplevel`](#tkinter.Toplevel "tkinter.Toplevel").
...
for example [`title()`](#tkinter.Wm.title "tkinter.Wm.title") and [`wm_title()`](#tkinter.Wm.wm_title "tkinter.Wm.wm_title").

These methods act on the top-level window
whether its content is built from the classic widgets or the themed [`tkinter.ttk`](tkinter.ttk.html#module-tkinter.ttk "tkinter.ttk: Tk themed widget set") widgets.
To reach the top-level window containing an arbitrary widget,
call its [`winfo_toplevel()`](#tkinter.Misc.winfo_toplevel "tkinter.Misc.winfo_toplevel") method.
...
See [`Wm`](#tkinter.Wm "tkinter.Wm") for the full set of window-manager methods.
...
:   Colors can be given as the names of X colors in the rgb.txt file, or as strings
    ...
    represent any legal hex digit. See the *[colors(3tk)](https://manpages.debian.org/colors(3tk))* man page for
...
:   The name of the mouse cursor to display while the pointer is over the widget.
    ...
    the standard X cursor names from `cursorfont.h` may also be used,
    without the `XC_` prefix (so `XC_hand2` becomes `"hand2"`).
    The full list of names, including the platform-specific ones,
    is given in the *[cursors(3tk)](https://manpages.debian.org/cursors(3tk))* manual page.
    You can also specify a bitmap and mask file of your own.
    On Windows a cursor file (`.cur` or `.ani`) may be used directly,
...
:   Tk uses a font description such as `{courier 10 bold}`; in
    `tkinter` this is most naturally passed as a tuple of
...
:   is a string that denotes the target kind of event. Physical events use the
    ...
    *[bind(3tk)](https://manpages.debian.org/bind(3tk))* man page for details.)
...
for example a [`Text`](#tkinter.Text "tkinter.Text") widget binds `Control`-`t`
to transpose two characters.
These are described in the bindings section of the widget’s Tk man page
(such as *[text(3tk)](https://manpages.debian.org/text(3tk))* or *[entry(3tk)](https://manpages.debian.org/entry(3tk))*).
...
of [`tkinter.Image`](#tkinter.Image "tkinter.Image"):

- [`BitmapImage`](#tkinter.BitmapImage "tkinter.BitmapImage") for images in XBM format.
- [`PhotoImage`](#tkinter.PhotoImage "tkinter.PhotoImage") for images in PGM, PPM, GIF and PNG formats. The latter
...
*class* tkinter.Misc
:   The `Misc` class is a mix-in inherited by [`Tk`](#tkinter.Tk "tkinter.Tk") and, through
    [`BaseWidget`](#tkinter.BaseWidget "tkinter.BaseWidget"), by every widget.
    ...
    :   Query or modify the configuration options of the widget.
        ...
        *cnf*, set each named option to the corresponding value; the expression
        ...
        [`config()`](#tkinter.Misc.config "tkinter.Misc.config") is an alias of `configure()`.
    ...
    :   Interpret the string *s* as a Tcl boolean and return the corresponding
        ...
        `'true'` and `'false'`.
        Raise [`ValueError`](exceptions.html#ValueError "ValueError") if *s* is not a valid boolean.

    getdouble(*s*)
    :   Interpret the string *s* as a Tcl floating-point number and return it as
        a [`float`](functions.html#float "float").
        Raise [`ValueError`](exceptions.html#ValueError "ValueError") if *s* is not a valid number.
    ...
    :   Interpret the string *s* as a Tcl integer and return it as an
        ...
        Raise [`ValueError`](exceptions.html#ValueError "ValueError") if *s* is not a valid integer.
    ...
    :   Set the Tcl global variable named *name* to *value*.
        ...
        variables.
        In most code you will instead use a [`Variable`](#tkinter.Variable "tkinter.Variable") subclass such as
        [`StringVar`](#tkinter.StringVar "tkinter.StringVar") or [`IntVar`](#tkinter.IntVar "tkinter.IntVar"), which wraps a Tcl variable and
    ...
    :   Delete the Tcl command named *name*, such as one previously returned by
        [`register()`](#tkinter.Misc.register "tkinter.Misc.register").
    ...
    :   Lower this widget in the stacking order so that it is drawn beneath its
        ...
        [`tkraise()`](#tkinter.Misc.tkraise "tkinter.Misc.tkraise")/[`lift()`](#tkinter.Misc.lift "tkinter.Misc.lift") and `lower()` are overridden by the
        [`Canvas`](#tkinter.Canvas "tkinter.Canvas") widget,
    ...
    :   Return the names of all images that currently exist in the Tcl
        ...
        This is overridden by the [`Text`](#tkinter.Text "tkinter.Text") widget,
        where `image_names()` returns the names of its embedded images
        instead.

    image\_types()
    :   Return the available image types, such as `'photo'` and `'bitmap'`.

    grid\_anchor(*anchor=None*)
    ...
    :   Return the bounding box, in pixels, of a region of the grid laid out in
        ...
        [`bbox()`](#tkinter.Misc.bbox "tkinter.Misc.bbox") is an alias of `grid_bbox()`,
        except on [`Canvas`](#tkinter.Canvas "tkinter.Canvas"), [`Listbox`](#tkinter.Listbox "tkinter.Listbox"), [`Spinbox`](#tkinter.Spinbox "tkinter.Spinbox"),
        [`Text`](#tkinter.Text "tkinter.Text"), [`ttk.Entry`](tkinter.ttk.html#tkinter.ttk.Entry "tkinter.ttk.Entry") and
        [`ttk.Treeview`](tkinter.ttk.html#tkinter.ttk.Treeview "tkinter.ttk.Treeview"),
        which provide their own `bbox()` method.

    grid\_columnconfigure(*index*, *cnf={}*, *\*\*kw*)
    ...
    grid\_rowconfigure(*index*, *cnf={}*, *\*\*kw*)
    :   Query or set the properties of the row (or rows) *index* of the grid
        managed by this container.
        *index* is interpreted as for [`grid_columnconfigure()`](#tkinter.Misc.grid_columnconfigure "tkinter.Misc.grid_columnconfigure"), and the
    ...
    :   Return the size of the grid managed by this container as a
        ...
        [`size()`](#tkinter.Misc.size "tkinter.Misc.size") is an alias of `grid_size()`,
        except on the [`Listbox`](#tkinter.Listbox "tkinter.Listbox") widget,
        which provides its own `size()` method.
    ...
    :   Bind the event pattern *sequence* on this widget to the callable *func*.
        ...
        *sequence* is an event pattern, such as `'<Button-1>'` (a mouse click)
        ...
        When the event occurs, *func* is called with an [`Event`](#tkinter.Event "tkinter.Event") instance
        ...
        *sequence*; otherwise it replaces them.
        ...
        `bind()` returns a string identifier (a *funcid*) that can later be
        passed to [`unbind()`](#tkinter.Misc.unbind "tkinter.Misc.unbind") to remove the binding without leaking the
    ...
    bind\_class(*className*, *sequence=None*, *func=None*, *add=None*)
    :   Like [`bind()`](#tkinter.Misc.bind "tkinter.Misc.bind"), but bind *func* to the binding tag *className* rather
        ...
        *className* is usually the name of a widget class, such as `'Button'`,
        ...
        [`bindtags()`](#tkinter.Misc.bindtags "tkinter.Misc.bindtags").

        The remaining arguments and the return value are as for [`bind()`](#tkinter.Misc.bind "tkinter.Misc.bind").

    bind\_all(*sequence=None*, *func=None*, *add=None*)
    :   Like [`bind()`](#tkinter.Misc.bind "tkinter.Misc.bind"), but bind *func* to the special binding tag `'all'`,
    ...
    :   Remove bindings for the event pattern *sequence* on this widget.
        ...
        returned from a previous call to [`bind()`](#tkinter.Misc.bind "tkinter.Misc.bind")) is removed, and its
        associated Tcl command is deleted.
        Otherwise all bindings for *sequence* are destroyed, leaving it unbound.

        Changed in version 3.13: If *funcid* is given, only that callback is unbound; other callbacks
        bound to *sequence* are kept.

    unbind\_class(*className*, *sequence*)
    :   Remove all bindings for the event pattern *sequence* from the binding tag
        *className*.
        See [`bind_class()`](#tkinter.Misc.bind_class "tkinter.Misc.bind_class").

    unbind\_all(*sequence*)
    :   Remove all bindings for the event pattern *sequence* from the special
        binding tag `'all'`.
        See [`bind_all()`](#tkinter.Misc.bind_all "tkinter.Misc.bind_all").
    ...
    event\_delete(*virtual*, *\*sequences*)
    ...
    :   Schedule the callable *func* to be called after *ms* milliseconds, with
        *args* and *kw* passed to it as positional and keyword arguments.
        Return an identifier that can be passed to [`after_cancel()`](#tkinter.Misc.after_cancel "tkinter.Misc.after_cancel") to cancel
        the call.
    ...
    after\_cancel(*id*)
    :   Cancel a callback previously scheduled with [`after()`](#tkinter.Misc.after "tkinter.Misc.after") or
        [`after_idle()`](#tkinter.Misc.after_idle "tkinter.Misc.after_idle").
        *id* must be an identifier returned by one of those methods; passing a
        value that is not such an identifier raises [`ValueError`](exceptions.html#ValueError "ValueError").
        If the callback has already run or been cancelled, this has no effect.

        Changed in version 3.7: Passing `None` (or any false value) as *id* now raises
        [`ValueError`](exceptions.html#ValueError "ValueError").

    after\_idle(*func*, *\*args*, *\*\*kw*)
    ...
    :   If *id* is omitted, return a tuple of the identifiers of all callbacks
        currently scheduled with [`after()`](#tkinter.Misc.after "tkinter.Misc.after") and [`after_idle()`](#tkinter.Misc.after_idle "tkinter.Misc.after_idle") for this
        interpreter.
        ...
        *script* refers to the function to be called and *type* is either
        `'idle'` or `'timer'`.
        A [`TclError`](#tkinter.TclError "tkinter.TclError") is raised if *id* does not exist.
    ...
    :   Wait until the Tcl variable *name* is modified, continuing to process
        ...
        *name* is usually a [`Variable`](#tkinter.Variable "tkinter.Variable") instance, such as an
        [`IntVar`](#tkinter.IntVar "tkinter.IntVar") or [`StringVar`](#tkinter.StringVar "tkinter.StringVar").

        [`waitvar()`](#tkinter.Misc.waitvar "tkinter.Misc.waitvar") is an alias of `wait_variable()`.

    wait\_window(*window=None*)
    ...
    :   Direct the keyboard input focus for this widget’s display to this widget.
        ...
        `focus()` is an alias of `focus_set()`,
        except on the [`Canvas`](#tkinter.Canvas "tkinter.Canvas") and
        [`ttk.Treeview`](tkinter.ttk.html#tkinter.ttk.Treeview "tkinter.ttk.Treeview") widgets,
        which provide their own `focus()` method.
    ...
    :   Return the widget that currently has the keyboard focus in the
        ...
        Use [`focus_displayof()`](#tkinter.Misc.focus_displayof "tkinter.Misc.focus_displayof") to work correctly with several displays.
    ...
    :   Return the next widget after this one in the keyboard traversal order, or
        ...
        This method is used in the default bindings for the `Tab` key.

    tk\_focusPrev()
    :   Return the previous widget before this one in the keyboard traversal
        order, or `None` if there is none.
        See [`tk_focusNext()`](#tkinter.Misc.tk_focusNext "tkinter.Misc.tk_focusNext") for how the order is defined.
        This method is used in the default bindings for the `Shift`-`Tab` key.
    ...
    :   Set a global grab on this widget.
        A global grab is like the local grab set by [`grab_set()`](#tkinter.Misc.grab_set "tkinter.Misc.grab_set"), but it
    ...
    :   Clear the X selection, so that no window owns it anymore.
        ...
        This is overridden by the [`Entry`](#tkinter.Entry "tkinter.Entry"), [`Listbox`](#tkinter.Listbox "tkinter.Listbox") and
        [`Spinbox`](#tkinter.Spinbox "tkinter.Spinbox") widgets,
        where `selection_clear()` clears the widget’s own selection instead.
    ...
    :   Append *string* to the Tk clipboard and claim ownership of the clipboard
        ...
        [`clipboard_clear()`](#tkinter.Misc.clipboard_clear "tkinter.Misc.clipboard_clear"); all appends should be completed before returning
        ...
        The contents can be retrieved with [`clipboard_get()`](#tkinter.Misc.clipboard_get "tkinter.Misc.clipboard_get") or
        [`selection_get()`](#tkinter.Misc.selection_get "tkinter.Misc.selection_get").
    ...
    option\_add(*pattern*, *value*, *priority=None*)
    ...
    :   Clear the Tk option database.
        ...
        `.Xdefaults` file are reloaded automatically the next time an
        option is added to or removed from the database.

    option\_get(*name*, *className*)
    ...
    option\_readfile(*fileName*, *priority=None*)
    :   Read the file named *fileName*, which should have the standard format for
        an X resource database such as `.Xdefaults`, and add all the
        options it specifies to the Tk option database.
        *priority* is interpreted as for [`option_add()`](#tkinter.Misc.option_add "tkinter.Misc.option_add") and defaults to
        `interactive`.
    ...
    :   Make this widget appear busy.
        ...
        Normally [`update()`](#tkinter.Misc.update "tkinter.Misc.update") should be called immediately afterwards to ensure
        ...
        [`busy_hold()`](#tkinter.Misc.busy_hold "tkinter.Misc.busy_hold"), [`busy()`](#tkinter.Misc.busy "tkinter.Misc.busy") and [`tk_busy()`](#tkinter.Misc.tk_busy "tkinter.Misc.tk_busy") are aliases of
        `tk_busy_hold()`.

        Added in version 3.13.

    tk\_busy\_configure(*cnf=None*, *\*\*kw*)
    :   Query or modify the configuration options of the busy window.
        The widget must have been previously made busy by [`tk_busy_hold()`](#tkinter.Misc.tk_busy_hold "tkinter.Misc.tk_busy_hold").
        ...
        For example, if a [`Frame`](#tkinter.Frame "tkinter.Frame") widget named `frame` is to be made
        ...
        [`busy_configure()`](#tkinter.Misc.busy_configure "tkinter.Misc.busy_configure"), [`busy_config()`](#tkinter.Misc.busy_config "tkinter.Misc.busy_config") and [`tk_busy_config()`](#tkinter.Misc.tk_busy_config "tkinter.Misc.tk_busy_config")
        are aliases of `tk_busy_configure()`.

        Added in version 3.13.

    tk\_busy\_cget(*option*)
    ...
    tk\_busy\_current(*pattern=None*)
    ...
    winfo\_atomname(*id*, *displayof=0*)
    :   Return the textual name for the atom whose integer identifier is *id*.
        This is the inverse of [`winfo_atom()`](#tkinter.Misc.winfo_atom "tkinter.Misc.winfo_atom").
    ...
    winfo\_containing(*rootX*, *rootY*, *displayof=0*)
    ...
    :   Return a floating-point value giving the number of pixels in the widget
        ...
        [`winfo_pixels()`](#tkinter.Misc.winfo_pixels "tkinter.Misc.winfo_pixels").

    winfo\_geometry()
    :   Return the geometry of the widget, in the form `widthxheight+x+y`.
        All dimensions are in pixels.
        An offset can be negative; see [`geometry()`](#tkinter.Wm.geometry "tkinter.Wm.geometry").

    winfo\_height()
    :   Return the height of the widget in pixels.
        When a window is first created its height is 1 pixel; it is eventually
        changed by a geometry manager.
        See also [`winfo_reqheight()`](#tkinter.Misc.winfo_reqheight "tkinter.Misc.winfo_reqheight").
    ...
    :   Return the number of pixels in the widget corresponding to the screen
        ...
        [`winfo_fpixels()`](#tkinter.Misc.winfo_fpixels "tkinter.Misc.winfo_fpixels").
    ...
    :   Return the top-of-hierarchy window containing the widget.
        In standard Tk this is always a [`Toplevel`](#tkinter.Toplevel "tkinter.Toplevel") widget.
    ...
    winfo\_visualsavailable(*includeids=False*)
    :   Return a list describing the visuals available for the widget’s screen.
        Each item consists of a visual class (see [`winfo_visual()`](#tkinter.Misc.winfo_visual "tkinter.Misc.winfo_visual")) followed
        by an integer depth.
    ...
    :   Return the width of the widget in pixels.
        ...
        changed by a geometry manager.
        See also [`winfo_reqwidth()`](#tkinter.Misc.winfo_reqwidth "tkinter.Misc.winfo_reqwidth").
    ...
    :   Return the Tcl/Tk patch level as a named tuple with the same five fields
        as [`sys.version_info`](sys.html#sys.version_info "sys.version_info"): *major*, *minor*, *micro*, *releaselevel*
        and *serial*.
...
:   The `Wm` mixin provides access to the window manager, allowing an
    ...
    manager protocols.
    It is mixed into [`Tk`](#tkinter.Tk "tkinter.Tk") and [`Toplevel`](#tkinter.Toplevel "tkinter.Toplevel"), so its methods are
    available on every top-level window.
    Each method has two equivalent spellings: a short name and a
    `wm_`-prefixed name (for example, [`title()`](#tkinter.Wm.title "tkinter.Wm.title") and [`wm_title()`](#tkinter.Wm.wm_title "tkinter.Wm.wm_title")).
    See also [The window manager](#tkinter-window-manager).
    ...
    :   Constrain the aspect ratio (the ratio of width to height) of the window.
        ...
        [`wm_aspect()`](#tkinter.Wm.wm_aspect "tkinter.Wm.wm_aspect") is an alias of `aspect()`.

    attributes(*\*args*, *return\_python\_dict=False*, *\*\*kwargs*)
    :   Query or set platform-specific attributes of the window.
        ...
        pass *return\_python\_dict* as true to get them as a dictionary.
        ...
        *class*, *stylemask*, *tabbingid* and *tabbingmode* attributes.
        ...
        [`wm_attributes()`](#tkinter.Wm.wm_attributes "tkinter.Wm.wm_attributes") is an alias of `attributes()`.

        Changed in version 3.13: A single attribute may now be queried by name without the leading
        `-`, and attributes may be set using keyword arguments.
        The *return\_python\_dict* parameter was added.

        Deprecated since version 3.13: Setting an attribute by passing the option name (with a leading
    ...
    :   Store *name*, which should be the name of the host on which the
        ...
        [`wm_client()`](#tkinter.Wm.wm_client "tkinter.Wm.wm_client") is an alias of `client()`.
    ...
    :   Manipulate the `WM_COLORMAP_WINDOWS` property, which tells the window
        ...
        property.
        [`wm_colormapwindows()`](#tkinter.Wm.wm_colormapwindows "tkinter.Wm.wm_colormapwindows") is an alias of `colormapwindows()`.
    ...
    :   Store *value* in the window’s `WM_COMMAND` property for use by the
        ...
        [`wm_command()`](#tkinter.Wm.wm_command "tkinter.Wm.wm_command") is an alias of `command()`.
    ...
    :   Display the window in normal (non-iconified) form by mapping it.
        ...
        [`wm_deiconify()`](#tkinter.Wm.wm_deiconify "tkinter.Wm.wm_deiconify") is an alias of `deiconify()`.
    ...
    :   Set or query the focus model for the window.
        *model* is either `'active'` (the window claims the input focus for
        ...
        The default is `'passive'`, which is what the `focus()` command
        assumes.
        [`wm_focusmodel()`](#tkinter.Wm.wm_focusmodel "tkinter.Wm.wm_focusmodel") is an alias of `focusmodel()`.

    forget(*window*)
    :   Unmap *window* from the screen so that it is no longer managed by the
        window manager.
        A [`Toplevel`](#tkinter.Toplevel "tkinter.Toplevel") is then treated like a [`Frame`](#tkinter.Frame "tkinter.Frame"), although its
        `-menu` configuration is remembered and the menu reappears if the
        widget is managed again.
        [`wm_forget()`](#tkinter.Wm.wm_forget "tkinter.Wm.wm_forget") is an alias of `forget()`.
    ...
    :   Return the platform-specific window identifier for the outermost
        ...
        window itself.
        [`wm_frame()`](#tkinter.Wm.wm_frame "tkinter.Wm.wm_frame") is an alias of `frame()`.
    ...
    :   Set or query the geometry of the window.
        ...
        *width* and *height* are in pixels (or grid units for a gridded window);
        ...
        `'200x200+10+10'`.
        [`wm_geometry()`](#tkinter.Wm.wm_geometry "tkinter.Wm.wm_geometry") is an alias of `geometry()`.
    ...
    :   Manage the window as a gridded window and define the relationship between
        ...
        *baseWidth* and *baseHeight* are the numbers of grid units for the
        ...
        [`wm_grid()`](#tkinter.Wm.wm_grid "tkinter.Wm.wm_grid") is an alias of `grid()`.
    ...
    :   Set or query the leader of a group of related windows.
        *pathName* gives the path name of the group leader; the window manager
        ...
        empty string.
        [`wm_group()`](#tkinter.Wm.wm_group "tkinter.Wm.wm_group") is an alias of `group()`.
    ...
    :   Set or query the bitmap used by the window manager for the window’s icon.
        *bitmap* names a bitmap in one of the standard forms accepted by Tk; an
        ...
        [`wm_iconbitmap()`](#tkinter.Wm.wm_iconbitmap "tkinter.Wm.wm_iconbitmap") is an alias of `iconbitmap()`.
    ...
    :   Iconify the window.
        ...
        [`wm_iconify()`](#tkinter.Wm.wm_iconify "tkinter.Wm.wm_iconify") is an alias of `iconify()`.

    iconmask(*bitmap=None*)
    :   Set or query the bitmap used as a mask for the icon (see
        [`iconbitmap()`](#tkinter.Wm.iconbitmap "tkinter.Wm.iconbitmap")).
        ...
        string.
        [`wm_iconmask()`](#tkinter.Wm.wm_iconmask "tkinter.Wm.wm_iconmask") is an alias of `iconmask()`.
    ...
    :   Set or query the name displayed by the window manager inside the window’s
        ...
        window’s title).
        [`wm_iconname()`](#tkinter.Wm.wm_iconname "tkinter.Wm.wm_iconname") is an alias of `iconname()`.

    iconphoto(*default=False*, *\*images*)
    :   Set the titlebar icon for the window from one or more [`PhotoImage`](#tkinter.PhotoImage "tkinter.PhotoImage")
        ...
        [`wm_iconphoto()`](#tkinter.Wm.wm_iconphoto "tkinter.Wm.wm_iconphoto") is an alias of `iconphoto()`.
    ...
    :   Set or query a hint to the window manager about where the window’s icon
        ...
        [`wm_iconposition()`](#tkinter.Wm.wm_iconposition "tkinter.Wm.wm_iconposition") is an alias of `iconposition()`.
    ...
    :   Make *widget* a stand-alone top-level window, decorated by the window
        ...
        Only [`Frame`](#tkinter.Frame "tkinter.Frame"), [`LabelFrame`](#tkinter.LabelFrame "tkinter.LabelFrame") and [`Toplevel`](#tkinter.Toplevel "tkinter.Toplevel") widgets
        may be used (the [`tkinter.ttk`](tkinter.ttk.html#module-tkinter.ttk "tkinter.ttk: Tk themed widget set") versions are **not** accepted);
        passing any other widget type raises an error.
        [`wm_manage()`](#tkinter.Wm.wm_manage "tkinter.Wm.wm_manage") is an alias of `manage()`.
    ...
    :   Set or query the maximum permissible dimensions of the window, in pixels
        ...
        *height*.
        ...
        [`wm_maxsize()`](#tkinter.Wm.wm_maxsize "tkinter.Wm.wm_maxsize") is an alias of `maxsize()`.
    ...
    :   Set or query the minimum permissible dimensions of the window, in pixels
        ...
        *height*.
        ...
        [`wm_minsize()`](#tkinter.Wm.wm_minsize "tkinter.Wm.wm_minsize") is an alias of `minsize()`.
    ...
    :   Set or query the override-redirect flag for the window.
        ...
        [`wm_overrideredirect()`](#tkinter.Wm.wm_overrideredirect "tkinter.Wm.wm_overrideredirect") is an alias of `overrideredirect()`.
    ...
    :   Set or query the source of the window’s current position.
        *who* is either `'program'` or `'user'` and indicates whether the
        ...
        has been set.
        Tk automatically sets the source to `'user'` when [`geometry()`](#tkinter.Wm.geometry "tkinter.Wm.geometry") is
    ...
    :   Set or query the source of the window’s current size.
        *who* is either `'program'` or `'user'` and indicates whether the
        ...
        With no argument, return the current source, or an empty string if none
        has been set.
        [`wm_sizefrom()`](#tkinter.Wm.wm_sizefrom "tkinter.Wm.wm_sizefrom") is an alias of `sizefrom()`.
    ...
    :   Set or query the state of the window.
        ...
        [`iconwindow()`](#tkinter.Wm.iconwindow "tkinter.Wm.iconwindow")); the `'icon'` state cannot be set.
        [`wm_state()`](#tkinter.Wm.wm_state "tkinter.Wm.wm_state") is an alias of `state()`.

        Not to be confused with [`ttk.Widget.state`](tkinter.ttk.html#tkinter.ttk.Widget.state "tkinter.ttk.Widget.state").
    ...
    :   Set or query the title for the window, which the window manager should
        ...
        [`wm_title()`](#tkinter.Wm.wm_title "tkinter.Wm.wm_title") is an alias of `title()`.
    ...
    :   Withdraw the window from the screen, unmapping it and causing the window
        ...
        example with [`deiconify()`](#tkinter.Wm.deiconify "tkinter.Wm.deiconify")) to make some window managers notice
        changes to window attributes.
        [`wm_withdraw()`](#tkinter.Wm.wm_withdraw "tkinter.Wm.wm_withdraw") is an alias of `withdraw()`.
...
:   Geometry manager that arranges widgets by packing them against the sides of
    ...
    [`Widget`](#tkinter.Widget "tkinter.Widget")) and provides the methods for managing a widget with the
    *pack* geometry manager.
    See also [Geometry management](#tkinter-geometry-management).

    Note

    `Pack`, [`Place`](#tkinter.Place "tkinter.Place") and [`Grid`](#tkinter.Grid "tkinter.Grid") all define the short
    method names `forget()`, `info()`, `slaves()`,
    `content()` and `propagate()`.
    On a widget the bare names resolve to the *pack* manager’s versions,
    since `Pack` and [`Misc`](#tkinter.Misc "tkinter.Misc") precede `Place` and
    ...
    :   Pack the widget inside its container, positioning it relative to the
        ...
        *in\_*
        ...
        `pack()`, [`configure()`](#tkinter.Pack.configure "tkinter.Pack.configure") and [`config()`](#tkinter.Pack.config "tkinter.Pack.config") are aliases of
        `pack_configure()`.

    pack\_forget()
    :   Unmap the widget and remove it from the packing order, forgetting its
        packing options.
        It can be packed again later with [`pack_configure()`](#tkinter.Pack.pack_configure "tkinter.Pack.pack_configure").
        [`forget()`](#tkinter.Pack.forget "tkinter.Pack.forget") is an alias of `pack_forget()`,
        except on [`PanedWindow`](#tkinter.PanedWindow "tkinter.PanedWindow"),
        [`ttk.Notebook`](tkinter.ttk.html#tkinter.ttk.Notebook "tkinter.ttk.Notebook") and
        [`ttk.PanedWindow`](tkinter.ttk.html#tkinter.ttk.PanedWindow "tkinter.ttk.PanedWindow"),
        which provide their own `forget()` method.
    ...
    :   Return a dictionary of the widget’s current packing options.
        [`info()`](#tkinter.Pack.info "tkinter.Pack.info") is an alias of `pack_info()`.

    pack\_propagate()

    pack\_propagate(*flag*)
    :   Same as [`Misc.pack_propagate()`](#tkinter.Misc.pack_propagate "tkinter.Misc.pack_propagate"), treating this widget as a container:
        enable or disable geometry propagation.
        [`propagate()`](#tkinter.Pack.propagate "tkinter.Pack.propagate") is an alias of `pack_propagate()`.

    pack\_slaves()
    :   Same as [`Misc.pack_slaves()`](#tkinter.Misc.pack_slaves "tkinter.Misc.pack_slaves"): return the list of widgets packed in
        this widget.
        [`slaves()`](#tkinter.Pack.slaves "tkinter.Pack.slaves") is an alias of `pack_slaves()`.

*class* tkinter.Place
:   Geometry manager that places widgets at explicit positions and sizes within
    their container.
    The `Place` mix-in is inherited by all widgets (through
    [`Widget`](#tkinter.Widget "tkinter.Widget")).
    See also [Geometry management](#tkinter-geometry-management).

    place\_configure(*cnf={}*, *\*\*kw*)
    ...
    :   Place the widget inside its container at an absolute or relative
        ...
        *in\_*
        ...
        `place()`, [`configure()`](#tkinter.Place.configure "tkinter.Place.configure") and [`config()`](#tkinter.Place.config "tkinter.Place.config") are aliases of
        `place_configure()`.
    ...
    place\_slaves()
    :   Same as [`Misc.place_slaves()`](#tkinter.Misc.place_slaves "tkinter.Misc.place_slaves"): return the list of widgets placed in
        this widget.

*class* tkinter.Grid
:   Geometry manager that arranges widgets in a two-dimensional grid of rows and
    columns within their container.
    The `Grid` mix-in is inherited by all widgets (through
    [`Widget`](#tkinter.Widget "tkinter.Widget")).
    See also [Geometry management](#tkinter-geometry-management).

    grid\_configure(*cnf={}*, *\*\*kw*)
    ...
    :   Position the widget in a cell of its container’s grid.
        ...
        *row*, *column*
        :   The row and column of the cell to place the widget in, counting from
            ...
            *column* defaults to the column after the previous widget placed in
            the same `grid_configure()` call (or `0`), and *row* defaults
        ...
        *in\_*
        ...
        `grid()`, [`configure()`](#tkinter.Grid.configure "tkinter.Grid.configure") and [`config()`](#tkinter.Grid.config "tkinter.Grid.config") are aliases of
        `grid_configure()`.
    ...
    grid\_bbox(*column=None*, *row=None*, *col2=None*, *row2=None*)
    :   Same as [`Misc.grid_bbox()`](#tkinter.Misc.grid_bbox "tkinter.Misc.grid_bbox").
        [`bbox()`](#tkinter.Grid.bbox "tkinter.Grid.bbox") is an alias of `grid_bbox()`,
        except on [`Canvas`](#tkinter.Canvas "tkinter.Canvas"), [`Listbox`](#tkinter.Listbox "tkinter.Listbox"), [`Spinbox`](#tkinter.Spinbox "tkinter.Spinbox"),
        [`Text`](#tkinter.Text "tkinter.Text"), [`ttk.Entry`](tkinter.ttk.html#tkinter.ttk.Entry "tkinter.ttk.Entry") and
        [`ttk.Treeview`](tkinter.ttk.html#tkinter.ttk.Treeview "tkinter.ttk.Treeview"),
        which provide their own `bbox()` method.
    ...
    grid\_columnconfigure(*index*, *cnf={}*, *\*\*kw*)
    :   Same as [`Misc.grid_columnconfigure()`](#tkinter.Misc.grid_columnconfigure "tkinter.Misc.grid_columnconfigure"): query or set the options (such
        as *weight*, *minsize*, *pad* and *uniform*) of a grid column.
        [`columnconfigure()`](#tkinter.Grid.columnconfigure "tkinter.Grid.columnconfigure") is an alias of `grid_columnconfigure()`.

    grid\_rowconfigure(*index*, *cnf={}*, *\*\*kw*)
    :   Same as [`Misc.grid_rowconfigure()`](#tkinter.Misc.grid_rowconfigure "tkinter.Misc.grid_rowconfigure"): query or set the options of a
        grid row.
        [`rowconfigure()`](#tkinter.Grid.rowconfigure "tkinter.Grid.rowconfigure") is an alias of `grid_rowconfigure()`.

    grid\_location(*x*, *y*)
    :   Same as [`Misc.grid_location()`](#tkinter.Misc.grid_location "tkinter.Misc.grid_location"): return the `(column, row)` of the
        cell that covers the pixel at *x*, *y*.
        [`location()`](#tkinter.Grid.location "tkinter.Grid.location") is an alias of `grid_location()`.

    grid\_size()
    :   Same as [`Misc.grid_size()`](#tkinter.Misc.grid_size "tkinter.Misc.grid_size"): return a `(columns, rows)` tuple giving
        the size of the grid.
        [`size()`](#tkinter.Grid.size "tkinter.Grid.size") is an alias of `grid_size()`,
        except on the [`Listbox`](#tkinter.Listbox "tkinter.Listbox") widget,
        which provides its own `size()` method.
    ...
    grid\_slaves(*row=None*, *column=None*)
    :   Same as [`Misc.grid_slaves()`](#tkinter.Misc.grid_slaves "tkinter.Misc.grid_slaves"): return the widgets managed in the grid,
        optionally restricted to a *row* and/or *column*.

*class* tkinter.XView
:   Mix-in providing the horizontal-scrolling interface shared by widgets such
    as [`Entry`](#tkinter.Entry "tkinter.Entry"), [`Canvas`](#tkinter.Canvas "tkinter.Canvas"), [`Listbox`](#tkinter.Listbox "tkinter.Listbox"), [`Text`](#tkinter.Text "tkinter.Text") and
    [`Spinbox`](#tkinter.Spinbox "tkinter.Spinbox").
    A widget’s [`xview()`](#tkinter.XView.xview "tkinter.XView.xview") method is registered as the *command* of a
    horizontal [`Scrollbar`](#tkinter.Scrollbar "tkinter.Scrollbar").
    ...
    :   Query or change the horizontal position of the view.
        ...
        are usually generated by a scrollbar; [`xview_moveto()`](#tkinter.XView.xview_moveto "tkinter.XView.xview_moveto") and
        [`xview_scroll()`](#tkinter.XView.xview_scroll "tkinter.XView.xview_scroll") provide a more convenient interface.
...
:   Mix-in providing the vertical-scrolling interface shared by widgets such as
    [`Canvas`](#tkinter.Canvas "tkinter.Canvas"), [`Listbox`](#tkinter.Listbox "tkinter.Listbox") and [`Text`](#tkinter.Text "tkinter.Text").
    A widget’s [`yview()`](#tkinter.YView.yview "tkinter.YView.yview") method is registered as the *command* of a vertical
    ...
    :   Query or change the vertical position of the view.
        ...
        usually generated by a scrollbar; [`yview_moveto()`](#tkinter.YView.yview_moveto "tkinter.YView.yview_moveto") and
        [`yview_scroll()`](#tkinter.YView.yview_scroll "tkinter.YView.yview_scroll") provide a more convenient interface.
...
:   Internal base class for all widgets.
    It inherits from [`Misc`](#tkinter.Misc "tkinter.Misc") and adds the machinery that creates the
    underlying Tk widget; application code normally uses [`Widget`](#tkinter.Widget "tkinter.Widget") or a
...
:   Internal base class for the standard widgets.
    It combines [`BaseWidget`](#tkinter.BaseWidget "tkinter.BaseWidget") with the geometry-manager mix-ins
    [`Pack`](#tkinter.Pack "tkinter.Pack"), [`Place`](#tkinter.Place "tkinter.Place") and [`Grid`](#tkinter.Grid "tkinter.Grid"), so that every widget can be
    managed by any of the three geometry managers.
    The concrete widget classes ([`Button`](#tkinter.Button "tkinter.Button"), [`Label`](#tkinter.Label "tkinter.Label"), and so on)
    derive from `Widget`.
...
:   Construct a toplevel Tk widget, which is usually the main window of an
    ...
    Inherits from [`Misc`](#tkinter.Misc "tkinter.Misc") and [`Wm`](#tkinter.Wm "tkinter.Wm").

    To create a Tcl interpreter without initializing the Tk subsystem, use the
    [`Tcl()`](#tkinter.Tcl "tkinter.Tcl") factory function instead.
    ...
    *useTk*
    :   If `True`, initialize the Tk subsystem. The [`tkinter.Tcl()`](#tkinter.Tcl "tkinter.Tcl")
    ...
    *use*
    :   Specifies the *id* of the window in which to embed the application,
        ...
        [`winfo_id()`](#tkinter.Misc.winfo_id "tkinter.Misc.winfo_id")).
    ...
    interpreter and calls [`exec()`](functions.html#exec "exec") on the contents of
    `.className.py` and `.baseName.py`. The path for the
    profile files is the `HOME` environment variable or, if that
    isn’t defined, then [`os.curdir`](os.html#os.curdir "os.curdir").

    Note

    On Windows, creating a Tcl interpreter (by instantiating `Tk` or
    calling [`Tcl()`](#tkinter.Tcl "tkinter.Tcl")) sets the `HOME` environment variable for
    ...
    :   The Tk application object created by instantiating `Tk`. This
        ...
        the same instance of `Tk` has the same value for its [`tk`](#tkinter.Tk.tk "tkinter.Tk.tk")
        attribute.

    master
    :   The widget object that contains this widget.
        For `Tk`, the `master` is [`None`](constants.html#None "None") because it is the
        main window.
        The terms *master* and *parent* are similar and sometimes used
        interchangeably as argument names; however, calling
        [`winfo_parent()`](#tkinter.Misc.winfo_parent "tkinter.Misc.winfo_parent") returns a string of the widget name whereas
        `master` returns the object.
        *parent*/*child* reflects the tree-like relationship while *master* (or
        *container*)/*content* reflects the container structure.

    children
    :   The immediate descendants of this widget as a [`dict`](stdtypes.html#dict "dict") with the
    ...
    :   Finish loading and initializing the Tk subsystem.
        ...
        example through [`Tcl()`](#tkinter.Tcl "tkinter.Tcl")); it is called automatically when *useTk* is
        true.
    ...
    :   Read and source the user’s profile files `.className.tcl` and
        ...
        corresponding `.className.py` and `.baseName.py` files.
        This is called during initialization; see the description of the
        constructor above.

    report\_callback\_exception(*exc*, *val*, *tb*)
    :   Report a callback exception.
        ...
        *exc*, *val* and *tb* are the exception type, value and traceback as
        returned by [`sys.exc_info()`](sys.html#sys.exc_info "sys.exc_info").
        The default implementation prints a traceback to [`sys.stderr`](sys.html#sys.stderr "sys.stderr").
...
:   A `Toplevel` widget is a top-level window, similar to a
    [`Frame`](#tkinter.Frame "tkinter.Frame") except that its X parent is the root window of a screen
    ...
    optional 3-D border.
    Notable options include *menu*, which installs a [`Menu`](#tkinter.Menu "tkinter.Menu") as the
    window’s menubar.
    Inherits from [`BaseWidget`](#tkinter.BaseWidget "tkinter.BaseWidget") and [`Wm`](#tkinter.Wm "tkinter.Wm"), so a toplevel is managed
...
:   A `Button` widget displays a textual string, bitmap or image and
    ...
    Inherits from [`Widget`](#tkinter.Widget "tkinter.Widget").
...
:   A `Canvas` widget implements structured graphics.
    ...
    Inherits from [`Widget`](#tkinter.Widget "tkinter.Widget"), [`XView`](#tkinter.XView "tkinter.XView") and [`YView`](#tkinter.YView "tkinter.YView"), so the
    view can be scrolled horizontally and vertically with [`xview()`](#tkinter.XView.xview "tkinter.XView.xview")
    and [`yview()`](#tkinter.YView.yview "tkinter.YView.yview").
    ...
    changed with [`tag_raise()`](#tkinter.Canvas.tag_raise "tkinter.Canvas.tag_raise") and [`tag_lower()`](#tkinter.Canvas.tag_lower "tkinter.Canvas.tag_lower").

    create\_arc(*\*args*, *\*\*kw*)

    create\_bitmap(*\*args*, *\*\*kw*)

    create\_image(*\*args*, *\*\*kw*)

    create\_line(*\*args*, *\*\*kw*)

    create\_oval(*\*args*, *\*\*kw*)

    create\_polygon(*\*args*, *\*\*kw*)

    create\_rectangle(*\*args*, *\*\*kw*)

    create\_text(*\*args*, *\*\*kw*)

    create\_window(*\*args*, *\*\*kw*)
    ...
    :   Query or modify the coordinates of an item.
        ...
        Changed in version 3.12: The arguments are now flattened: the coordinates may be given as
    ...
    :   Return the current value of the configuration option *option* for the
        ...
        This is like [`cget()`](#tkinter.Misc.cget "tkinter.Misc.cget") but applies to an individual item.

    itemconfigure(*tagOrId*, *cnf=None*, *\*\*kw*)
    :   Query or modify the configuration options of the items given by
        *tagOrId*.
        This mirrors [`configure()`](#tkinter.Misc.configure "tkinter.Misc.configure"), except that it applies to
        ...
        method.
        [`itemconfig()`](#tkinter.Canvas.itemconfig "tkinter.Canvas.itemconfig") is an alias of `itemconfigure()`.
    ...
    addtag\_below(*newtag*, *tagOrId*)
    :   Add the tag *newtag* to the item just below (before) *tagOrId* in the
        display list.

    addtag\_closest(*newtag*, *x*, *y*, *halo=None*, *start=None*)
    ...
    :   Return a tuple of the ids of all items selected by the search
        ...
        The search specification has any of the forms accepted by [`addtag()`](#tkinter.Canvas.addtag "tkinter.Canvas.addtag").
    ...
    :   Move all items given by *tagOrId* to a new position in the display list
        ...
        controlled by [`Misc.tkraise()`](#tkinter.Misc.tkraise "tkinter.Misc.tkraise") and [`Misc.lower()`](#tkinter.Misc.lower "tkinter.Misc.lower") instead.
        [`lift()`](#tkinter.Canvas.lift "tkinter.Canvas.lift") and [`tkraise()`](#tkinter.Canvas.tkraise "tkinter.Canvas.tkraise") are aliases of `tag_raise()`.

    tag\_lower(*tagOrId*, *belowThis=None*, */*)
    :   Move all items given by *tagOrId* to a new position in the display list
        ...
        [`lower()`](#tkinter.Canvas.lower "tkinter.Canvas.lower") is an alias of `tag_lower()`.

        Note

        On a `Canvas`, [`tkraise()`](#tkinter.Canvas.tkraise "tkinter.Canvas.tkraise")/[`lift()`](#tkinter.Canvas.lift "tkinter.Canvas.lift") and [`lower()`](#tkinter.Canvas.lower "tkinter.Canvas.lower")
        restack canvas items,
        shadowing the inherited [`Misc.tkraise()`](#tkinter.Misc.tkraise "tkinter.Misc.tkraise")/[`Misc.lift()`](#tkinter.Misc.lift "tkinter.Misc.lift") and
        [`Misc.lower()`](#tkinter.Misc.lower "tkinter.Misc.lower") methods that restack the widget itself,
        which are therefore not available.

    tag\_bind(*tagOrId*, *sequence=None*, *func=None*, *add=None*)
    :   Bind the callback *func* to the event *sequence* for all items given by
        *tagOrId*, so that *func* is invoked whenever that event occurs for one
        of the items.
        This is like [`Widget.bind`](#tkinter.Misc.bind "tkinter.Misc.bind") but operates on canvas items
        ...
        focus item (see [`focus()`](#tkinter.Canvas.focus "tkinter.Canvas.focus")).
        ...
        [`tag_unbind()`](#tkinter.Canvas.tag_unbind "tkinter.Canvas.tag_unbind").

    tag\_unbind(*tagOrId*, *sequence*, *funcid=None*)
    :   Remove for all items given by *tagOrId* the binding for the event
        *sequence*.
        If *funcid* is given, only that callback (as returned by
        [`tag_bind()`](#tkinter.Canvas.tag_bind "tkinter.Canvas.tag_bind")) is unbound and deregistered.
    ...
    :   Return a 4-tuple `(x1, y1, x2, y2)` giving an approximate bounding box,
        ...
        *tagOrIds*.
        ...
        This shadows the inherited `Misc.bbox()`;
        use [`grid_bbox()`](#tkinter.Misc.grid_bbox "tkinter.Misc.grid_bbox") for the grid bounding box.
    ...
    :   With *tagOrId*, set the keyboard focus for the canvas to the first item
        ...
        This shadows the inherited `Misc.focus()`;
        use [`focus_set()`](#tkinter.Misc.focus_set "tkinter.Misc.focus_set") to focus the widget itself.
    ...
    :   Adjust the end of the selection in *tagOrId* nearest to *index* so that
        ...
        [`select_to()`](#tkinter.Canvas.select_to "tkinter.Canvas.select_to") calls.
    ...
    :   Set the selection anchor point to just before the character given by
        *index* in the item given by *tagOrId*.
        ...
        future [`select_to()`](#tkinter.Canvas.select_to "tkinter.Canvas.select_to") calls.

    select\_item()
    :   Return the id of the item that holds the selection, or `None` if the
        selection is not in this canvas.
        Unlike [`find()`](#tkinter.Canvas.find "tkinter.Canvas.find") and the `find_*` methods, this returns the id as a
        string rather than an integer.

    select\_to(*tagOrId*, *index*)
    :   Set the selection to the characters of *tagOrId* between the selection
        anchor point and *index*, inclusive of *index*.
        The anchor point is the one set by the most recent [`select_adjust()`](#tkinter.Canvas.select_adjust "tkinter.Canvas.select_adjust")
        or [`select_from()`](#tkinter.Canvas.select_from "tkinter.Canvas.select_from") call.

    scan\_mark(*x*, *y*)
    :   Record *x*, *y* and the current view, for use with later
        [`scan_dragto()`](#tkinter.Canvas.scan_dragto "tkinter.Canvas.scan_dragto") calls.
        This is typically bound to a mouse button press in the widget.

    scan\_dragto(*x*, *y*, *gain=10*)
    :   Scroll the canvas by *gain* times the difference between *x*, *y* and the
        coordinates passed to the last [`scan_mark()`](#tkinter.Canvas.scan_mark "tkinter.Canvas.scan_mark") call.
    ...
    :   Generate a PostScript (Encapsulated PostScript, version 3.0)
        ...
        it is usually necessary either to call [`update()`](#tkinter.Misc.update "tkinter.Misc.update") first or to
...
:   An `Entry` widget displays a single line of text and lets the user
    edit it.
    Inherits from [`Widget`](#tkinter.Widget "tkinter.Widget") and [`XView`](#tkinter.XView "tkinter.XView"); since entries can hold
    strings too long to fit in the window, they support horizontal scrolling
    through [`xview()`](#tkinter.XView.xview "tkinter.XView.xview").
    ...
    *validate* and *validatecommand* (which together let a callback accept or
    ...
    :   Locate the end of the selection nearest to the character given by
        *index*, and adjust that end to be at *index* (including but not going
        ...
        [`selection_to()`](#tkinter.Entry.selection_to "tkinter.Entry.selection_to") calls.
        If there is no selection in the entry, a new one is created between
        *index* and the most recent anchor point, inclusive.
        [`select_adjust()`](#tkinter.Entry.select_adjust "tkinter.Entry.select_adjust") is an alias of `selection_adjust()`.

    selection\_clear()
    :   Clear the selection if it is currently in this widget.
        If the selection is not in this widget the method has no effect.
        [`select_clear()`](#tkinter.Entry.select_clear "tkinter.Entry.select_clear") is an alias of `selection_clear()`.

        Note

        This shadows the inherited [`Misc.selection_clear()`](#tkinter.Misc.selection_clear "tkinter.Misc.selection_clear"),
        which clears the X selection;
        that method is not available on an `Entry`.

    selection\_from(*index*)
    :   Set the selection anchor point to just before the character given by
        *index*, without changing the selection.
        [`select_from()`](#tkinter.Entry.select_from "tkinter.Entry.select_from") is an alias of `selection_from()`.

    selection\_present()
    :   Return `True` if there are characters selected in the entry, `False`
        otherwise.
        [`select_present()`](#tkinter.Entry.select_present "tkinter.Entry.select_present") is an alias of `selection_present()`.
    ...
    :   Set the selection to include the characters starting with the one indexed
        ...
        [`select_range()`](#tkinter.Entry.select_range "tkinter.Entry.select_range") is an alias of `selection_range()`.
    ...
    :   Set the selection between the anchor point and *index*: if *index* is
        ...
        The anchor point is the one set by the most recent [`selection_from()`](#tkinter.Entry.selection_from "tkinter.Entry.selection_from")
        or [`selection_adjust()`](#tkinter.Entry.selection_adjust "tkinter.Entry.selection_adjust") call.
        If there is no selection in the entry, a new one is created using the
        most recent anchor point.
        [`select_to()`](#tkinter.Entry.select_to "tkinter.Entry.select_to") is an alias of `selection_to()`.

    scan\_mark(*x*)
    :   Record *x* and the current view in the entry window, for use with later
        [`scan_dragto()`](#tkinter.Entry.scan_dragto "tkinter.Entry.scan_dragto") calls.
        Typically associated with a mouse button press in the widget.

    scan\_dragto(*x*)
    :   Compute the difference between *x* and the *x* given to the last
        [`scan_mark()`](#tkinter.Entry.scan_mark "tkinter.Entry.scan_mark") call, and adjust the view left or right by 10 times
        that difference.
...
:   A `LabelFrame` widget is a container that has the features of a
    [`Frame`](#tkinter.Frame "tkinter.Frame") plus the ability to display a label.
...
:   A `Listbox` widget displays a list of single-line text items, one
    ...
    cursor, set with [`activate()`](#tkinter.Listbox.activate "tkinter.Listbox.activate")), `'anchor'` (the selection anchor, set
    with [`selection_anchor()`](#tkinter.Listbox.selection_anchor "tkinter.Listbox.selection_anchor")), `'end'` (the last item, or for
    [`index()`](#tkinter.Listbox.index "tkinter.Listbox.index") and [`insert()`](#tkinter.Listbox.insert "tkinter.Listbox.insert") the position just after it), or `@x,y`
    ...
    :   Return the total number of items in the listbox.
        ...
        This shadows the inherited `Misc.size()`;
        use [`grid_size()`](#tkinter.Misc.grid_size "tkinter.Misc.grid_size") for the grid size.
    ...
    :   Set the selection anchor to the item given by *index*.
        ...
        [`select_anchor()`](#tkinter.Listbox.select_anchor "tkinter.Listbox.select_anchor") is an alias of `selection_anchor()`.

    selection\_clear(*first*, *last=None*)
    :   Deselect any of the items in the range from *first* to *last* inclusive
        ...
        [`select_clear()`](#tkinter.Listbox.select_clear "tkinter.Listbox.select_clear") is an alias of `selection_clear()`.

        Note

        This shadows the inherited [`Misc.selection_clear()`](#tkinter.Misc.selection_clear "tkinter.Misc.selection_clear"),
        which clears the X selection;
        that method is not available on a `Listbox`.

    selection\_includes(*index*)
    :   Return `True` if the item given by *index* is currently selected,
        `False` otherwise.
        [`select_includes()`](#tkinter.Listbox.select_includes "tkinter.Listbox.select_includes") is an alias of `selection_includes()`.

    selection\_set(*first*, *last=None*)
    :   Select all of the items in the range from *first* to *last* inclusive,
        ...
        [`select_set()`](#tkinter.Listbox.select_set "tkinter.Listbox.select_set") is an alias of `selection_set()`.
    ...
    :   Query or modify the configuration options of the item given by *index*.
        This mirrors [`configure()`](#tkinter.Misc.configure "tkinter.Misc.configure"), except that it applies to an
        ...
        *selectbackground* and *selectforeground*.
        [`itemconfig()`](#tkinter.Listbox.itemconfig "tkinter.Listbox.itemconfig") is an alias of `itemconfigure()`.

    scan\_mark(*x*, *y*)
    :   Record *x*, *y* and the current view, for use with later
        [`scan_dragto()`](#tkinter.Listbox.scan_dragto "tkinter.Listbox.scan_dragto") calls.
        This is typically bound to a mouse button press in the widget.

    scan\_dragto(*x*, *y*)
    :   Scroll the listbox by 10 times the difference between *x*, *y* and the
        coordinates passed to the last [`scan_mark()`](#tkinter.Listbox.scan_mark "tkinter.Listbox.scan_mark") call.
        This is typically bound to mouse motion events in the widget, producing
...
:   A `Menu` widget displays a column of entries, each of which may be a
    ...
    :   Add a new entry to the bottom of the menu.
        *itemType* is one of `'command'`, `'cascade'`, `'checkbutton'`,
        ...
        The `add_command()`, `add_cascade()`, `add_checkbutton()`,
        `add_radiobutton()` and `add_separator()` convenience methods
    ...
    :   Same as [`add()`](#tkinter.Menu.add "tkinter.Menu.add"), except that the new entry is inserted just before
        ...
        *itemType* is one of `'command'`, `'cascade'`, `'checkbutton'`,
        ...
        `insert_separator()` convenience methods call this method with the
        corresponding *itemType*.

    insert\_cascade(*index*, *cnf={}*, *\*\*kw*)
    :   Insert a new cascade entry before the entry given by *index* (see
        [`add_cascade()`](#tkinter.Menu.add_cascade "tkinter.Menu.add_cascade")).

    insert\_checkbutton(*index*, *cnf={}*, *\*\*kw*)
    :   Insert a new checkbutton entry before the entry given by *index* (see
        [`add_checkbutton()`](#tkinter.Menu.add_checkbutton "tkinter.Menu.add_checkbutton")).

    insert\_command(*index*, *cnf={}*, *\*\*kw*)
    :   Insert a new command entry before the entry given by *index* (see
        [`add_command()`](#tkinter.Menu.add_command "tkinter.Menu.add_command")).

    insert\_radiobutton(*index*, *cnf={}*, *\*\*kw*)
    :   Insert a new radiobutton entry before the entry given by *index* (see
        [`add_radiobutton()`](#tkinter.Menu.add_radiobutton "tkinter.Menu.add_radiobutton")).

    insert\_separator(*index*, *cnf={}*, *\*\*kw*)
    :   Insert a separator before the entry given by *index* (see
        [`add_separator()`](#tkinter.Menu.add_separator "tkinter.Menu.add_separator")).
    ...
    :   Query or modify the configuration options of the entry given by *index*.
        ...
        The supported options are those accepted by [`add()`](#tkinter.Menu.add "tkinter.Menu.add") for the entry’s
        type.
        [`entryconfig()`](#tkinter.Menu.entryconfig "tkinter.Menu.entryconfig") is an alias of `entryconfigure()`.
...
:   A `Menubutton` widget displays a textual string, bitmap or image and
    posts an associated [`Menu`](#tkinter.Menu "tkinter.Menu"), given by its *menu* option, when the user
    presses it.
    Like a [`Label`](#tkinter.Label "tkinter.Label") it can show *text*, a *textvariable*, or an *image*,
...
:   A `Message` widget displays a non-interactive textual string, given
    ...
    Unlike a [`Label`](#tkinter.Label "tkinter.Label"), it breaks the string into multiple lines in order
...
:   A helper subclass of [`Menubutton`](#tkinter.Menubutton "tkinter.Menubutton") that displays a pop-up menu of
    mutually exclusive choices.
    *variable* is a [`Variable`](#tkinter.Variable "tkinter.Variable") kept in sync with the selection, *value*
...
:   A `PanedWindow` is a geometry-manager widget that arranges any
    ...
    :   Add *child* to the panedwindow as a new pane, placed after any existing
        ...
        they may be any of the options accepted by [`paneconfigure()`](#tkinter.PanedWindow.paneconfigure "tkinter.PanedWindow.paneconfigure").

    remove(*child*)
    :   Remove the pane containing *child* from the panedwindow.
        All geometry management options for *child* are forgotten.
        [`forget()`](#tkinter.PanedWindow.forget "tkinter.PanedWindow.forget") is an alias of `remove()`.
        This shadows the inherited geometry-manager `forget()`;
        use [`pack_forget()`](#tkinter.Pack.pack_forget "tkinter.Pack.pack_forget"), [`grid_forget()`](#tkinter.Grid.grid_forget "tkinter.Grid.grid_forget") or
        [`place_forget()`](#tkinter.Place.place_forget "tkinter.Place.place_forget") to remove the widget itself from its manager.
    ...
    :   Return the current value of the management option *option* for the pane
        containing *child*.
        *option* may be any value allowed by [`paneconfigure()`](#tkinter.PanedWindow.paneconfigure "tkinter.PanedWindow.paneconfigure").
    ...
    :   Query or modify the management options of the pane containing the widget
        *tagOrId*.
        ...
        [`paneconfig()`](#tkinter.PanedWindow.paneconfig "tkinter.PanedWindow.paneconfig") is an alias of `paneconfigure()`.
    ...
    :   Query or change the position of the sashes in the panedwindow.
        ...
        methods [`sash_coord()`](#tkinter.PanedWindow.sash_coord "tkinter.PanedWindow.sash_coord"), [`sash_mark()`](#tkinter.PanedWindow.sash_mark "tkinter.PanedWindow.sash_mark") and [`sash_place()`](#tkinter.PanedWindow.sash_place "tkinter.PanedWindow.sash_place")
    ...
    :   Query or change the position of the sash proxy, the “ghost” sash shown
        ...
        convenience methods [`proxy_coord()`](#tkinter.PanedWindow.proxy_coord "tkinter.PanedWindow.proxy_coord"), [`proxy_forget()`](#tkinter.PanedWindow.proxy_forget "tkinter.PanedWindow.proxy_forget") and
        [`proxy_place()`](#tkinter.PanedWindow.proxy_place "tkinter.PanedWindow.proxy_place") should normally be used instead.
...
:   A `Scale` widget lets the user select a numerical value by moving a
    ...
    documented in the Tk `scale` manual page, such as *from\_*, *to*,
    *resolution*, *orient*, *tickinterval*, *variable* and *command*.
    As elsewhere in `tkinter`, the leading `-` of the Tk option name is
    dropped; *from* is spelled `from_` because [`from`](../reference/simple_stmts.html#from) is a Python
    keyword.

    With a non-integer *resolution*, see [numeric values and the locale](#tkinter-numeric-locale).
...
:   A `Scrollbar` widget displays a slider and two arrows that let the
    user scroll an associated widget, such as a [`Listbox`](#tkinter.Listbox "tkinter.Listbox"), [`Text`](#tkinter.Text "tkinter.Text"),
    [`Canvas`](#tkinter.Canvas "tkinter.Canvas") or [`Entry`](#tkinter.Entry "tkinter.Entry").
    It is connected to the scrolled widget by setting that widget’s
    *xscrollcommand* or *yscrollcommand* option to the scrollbar’s [`set()`](stdtypes.html#set "set")
    method, and the scrollbar’s *command* option to the scrolled widget’s
    [`xview()`](#tkinter.XView.xview "tkinter.XView.xview") or [`yview()`](#tkinter.YView.yview "tkinter.YView.yview") method.
    Inherits from [`Widget`](#tkinter.Widget "tkinter.Widget").
    ...
    :   Return the current scrollbar settings as a tuple `(first, last)` of two
        ...
        currently visible, as last passed to [`set()`](stdtypes.html#set "set").
...
:   A `Spinbox` widget is an [`Entry`](#tkinter.Entry "tkinter.Entry")-like widget with a pair of
    up/down arrow buttons that let the user step through a range of values in
    addition to editing the value directly.
    The set of values may be a numeric range given by the *from\_*, *to* and
    ...
    *wrap* option controls whether stepping past either end of the range wraps
    ...
    text.
    Inherits from [`Widget`](#tkinter.Widget "tkinter.Widget") and [`XView`](#tkinter.XView "tkinter.XView").

    With a non-integer *increment*, see [numeric values and the locale](#tkinter-numeric-locale).
    ...
    :   A thin wrapper around the Tk `scan` widget subcommand, used to
        ...
        that mark.
        The [`scan_mark()`](#tkinter.Spinbox.scan_mark "tkinter.Spinbox.scan_mark") and [`scan_dragto()`](#tkinter.Spinbox.scan_dragto "tkinter.Spinbox.scan_dragto") methods wrap the two forms.

    scan\_mark(*x*)
    :   Record *x* and the current view in the spinbox window, for use with a
        later [`scan_dragto()`](#tkinter.Spinbox.scan_dragto "tkinter.Spinbox.scan_dragto") call.
    ...
    :   Adjust the view by 10 times the difference between *x* and the *x* passed
        to the last [`scan_mark()`](#tkinter.Spinbox.scan_mark "tkinter.Spinbox.scan_mark") call.
    ...
    :   A thin wrapper around the Tk `selection` widget subcommand, used to
        ...
        `selection('to', index)`.
        The [`selection_adjust()`](#tkinter.Spinbox.selection_adjust "tkinter.Spinbox.selection_adjust"), [`selection_clear()`](#tkinter.Spinbox.selection_clear "tkinter.Spinbox.selection_clear"),
        [`selection_element()`](#tkinter.Spinbox.selection_element "tkinter.Spinbox.selection_element"), [`selection_from()`](#tkinter.Spinbox.selection_from "tkinter.Spinbox.selection_from"),
        [`selection_present()`](#tkinter.Spinbox.selection_present "tkinter.Spinbox.selection_present"), [`selection_range()`](#tkinter.Spinbox.selection_range "tkinter.Spinbox.selection_range") and
        [`selection_to()`](#tkinter.Spinbox.selection_to "tkinter.Spinbox.selection_to") methods wrap these forms.
    ...
    :   Locate the end of the selection nearest to the character given by *index*
        ...
        going beyond *index*).
        The other end becomes the anchor point for future [`selection_to()`](#tkinter.Spinbox.selection_to "tkinter.Spinbox.selection_to")
        calls.
    ...
    :   Clear the selection if it is currently in this widget.
        ...
        This shadows the inherited [`Misc.selection_clear()`](#tkinter.Misc.selection_clear "tkinter.Misc.selection_clear"),
        which clears the X selection;
        that method is not available on a `Spinbox`.

    selection\_element(*element=None*)
    ...
    :   Set the selection between *index* and the anchor point.
        ...
        nothing happens.
        The anchor point is the one set by the most recent [`selection_from()`](#tkinter.Spinbox.selection_from "tkinter.Spinbox.selection_from")
        or [`selection_adjust()`](#tkinter.Spinbox.selection_adjust "tkinter.Spinbox.selection_adjust") call.
...
:   A `Text` widget displays and edits multi-line text.
    ...
    :   Replace the range of characters from *index1* up to but not including
        *index2* with *chars*.
        This is equivalent to a [`delete()`](#tkinter.Text.delete "tkinter.Text.delete") followed by an [`insert()`](#tkinter.Text.insert "tkinter.Text.insert") at
        *index1*; *args* is interpreted as for `insert()`.
    ...
    count(*index1*, *index2*, *\*options*, *return\_ints=False*)
    :   Count the number of items of the requested kinds between *index1* and
        *index2*; the count is negative if *index1* is after *index2*.
        ...
        When *return\_ints* is true and a single counting option is given, return
        a plain integer; otherwise return a tuple with one integer per counting
        option (or `None` if the result is empty).

        Added in version 3.3.

        Changed in version 3.13: Added the *return\_ints* parameter.
    ...
    mark\_gravity(*markName*, *direction=None*)
    ...
    tag\_remove(*tagName*, *index1*, *index2=None*)
    ...
    tag\_nextrange(*tagName*, *index1*, *index2=None*)
    ...
    tag\_prevrange(*tagName*, *index1*, *index2=None*)
    ...
    tag\_raise(*tagName*, *aboveThis=None*)
    ...
    tag\_lower(*tagName*, *belowThis=None*)
    ...
    tag\_bind(*tagName*, *sequence*, *func*, *add=None*)
    :   Bind the event *sequence* on characters tagged with *tagName* to the
        ...
        *sequence*, otherwise it replaces them.
        Works like [`bind()`](#tkinter.Misc.bind "tkinter.Misc.bind") and returns the identifier of the new
        binding.

    tag\_unbind(*tagName*, *sequence*, *funcid=None*)
    :   Remove the bindings of the event *sequence* on characters tagged with
        *tagName*.
        If *funcid* is given, only that binding (as returned by [`tag_bind()`](#tkinter.Text.tag_bind "tkinter.Text.tag_bind"))
        is removed and its callback is unregistered.

        Changed in version 3.13: If *funcid* is given, only that callback is unbound.

    image\_create(*index*, *cnf={}*, *\*\*kw*)
    ...
    image\_cget(*index*, *option*)
    :   Return the current value of the configuration option *option* for the
        embedded image at *index*.

    image\_configure(*index*, *cnf=None*, *\*\*kw*)
    :   Query or modify the configuration options of the embedded image at
        *index*, like [`configure()`](#tkinter.Misc.configure "tkinter.Misc.configure") but applied to that image.
    ...
    :   Return a tuple of the names of all images embedded in the widget.
        ...
        This shadows the inherited [`Misc.image_names()`](#tkinter.Misc.image_names "tkinter.Misc.image_names"),
        which returns the names of all images in the Tcl interpreter;
        that method is not available on a `Text`.

    window\_create(*index*, *cnf={}*, *\*\*kw*)
    ...
    window\_cget(*index*, *option*)
    :   Return the current value of the configuration option *option* for the
        embedded window at *index*.

    window\_configure(*index*, *cnf=None*, *\*\*kw*)
    :   Query or modify the configuration options of the embedded window at
        *index*, like [`configure()`](#tkinter.Misc.configure "tkinter.Misc.configure") but applied to that window.
    ...
    :   Low-level wrapper around the Tk `edit` widget command that controls the
        ...
        The `edit_*()` methods below are thin wrappers around it and are
        usually more convenient.

    edit\_modified(*arg=None*)
    ...
    :   Undo the most recent edit action, that is, all the inserts and deletes
        ...
        the redo stack.
        Raises [`TclError`](#tkinter.TclError "tkinter.TclError") if the undo stack is empty.
    ...
    :   Reapply the most recently undone edit action, provided no further edits
        ...
        Raises [`TclError`](#tkinter.TclError "tkinter.TclError") if the redo stack is empty.
        Has no effect unless the *undo* option is true.
        Since Tk 9.0, returns a tuple of indices delimiting the ranges of text
        that were changed.
    ...
    :   Search for *pattern* starting at *index* and return the index of the
        ...
        *nocase* makes the match case-insensitive; and *elide* causes hidden text
        ...
        If *count* is a [`Variable`](#tkinter.Variable "tkinter.Variable"), the number of index positions in the
        match is stored in it.

    scan\_mark(*x*, *y*)
    :   Record *x*, *y* and the current view, for use with later
        [`scan_dragto()`](#tkinter.Text.scan_dragto "tkinter.Text.scan_dragto") calls.
        This is typically bound to a mouse button press in the widget.

    scan\_dragto(*x*, *y*)
    :   Scroll the widget by 10 times the difference between *x*, *y* and the
        coordinates passed to the last [`scan_mark()`](#tkinter.Text.scan_mark "tkinter.Text.scan_mark") call.
    ...
    peer\_create(*newPathName*, *cnf={}*, *\*\*kw*)
    ...
    yview\_pickplace(*\*what*)
    :   Adjust the view so that the location given by *what* is visible.
        This is an obsolete equivalent of [`see()`](#tkinter.Text.see "tkinter.Text.see"), which should be used
        instead.
...
:   The base class for the Tk variable wrappers.
    ...
    [Coupling widget variables](#coupling-widget-variables)), so that changes propagate both ways:
    ...
    *name* is the name of the variable in the Tcl interpreter; if omitted, a
    ...
    [`StringVar`](#tkinter.StringVar "tkinter.StringVar"), [`IntVar`](#tkinter.IntVar "tkinter.IntVar"), [`DoubleVar`](#tkinter.DoubleVar "tkinter.DoubleVar") or
    [`BooleanVar`](#tkinter.BooleanVar "tkinter.BooleanVar") – rather than `Variable` directly.
    ...
    Changed in version 3.10: Two variables now compare equal (`==`) only when they have the same
    ...
    :   Set the variable to *value*.
        [`initialize()`](#tkinter.Variable.initialize "tkinter.Variable.initialize") is an alias of `set()`.

        Added in version 3.3: The *initialize* spelling.

    trace\_add(*mode*, *callback*)
    :   Register *callback* to be called when the variable is accessed according
        ...
        *mode* is one of the strings `'array'`, `'read'`, `'write'` or
        ...
        to [`trace_remove()`](#tkinter.Variable.trace_remove "tkinter.Variable.trace_remove").

        Added in version 3.6.

    trace\_remove(*mode*, *cbname*)
    :   Remove a trace callback from the variable.
        *mode* must match the *mode* that was passed to [`trace_add()`](#tkinter.Variable.trace_add "tkinter.Variable.trace_add"), and
        *cbname* is the callback name returned by `trace_add()`.
    ...
    trace\_variable(*mode*, *callback*)
    :   Register *callback* to be called when the variable is accessed according
        to *mode*.
        *mode* is one of the strings `'r'`, `'w'` or `'u'`, for read, write
        or unset.
        Return the internal name of the registered callback.
        [`trace()`](trace.html#module-trace "trace: Trace or track Python statement execution.") is an alias of `trace_variable()`.

        Deprecated since version 3.6: Use [`trace_add()`](#tkinter.Variable.trace_add "tkinter.Variable.trace_add") instead. This method wraps a Tcl feature that
        was removed in Tcl 9.0.

    trace\_vdelete(*mode*, *cbname*)
    :   Remove the trace callback named *cbname* registered for *mode* with
        [`trace_variable()`](#tkinter.Variable.trace_variable "tkinter.Variable.trace_variable").

        Deprecated since version 3.6: Use [`trace_remove()`](#tkinter.Variable.trace_remove "tkinter.Variable.trace_remove") instead. This method wraps a Tcl feature
        that was removed in Tcl 9.0.

    trace\_vinfo()
    :   Return a list of `(mode, cbname)` pairs for all traces set on the
        variable with [`trace_variable()`](#tkinter.Variable.trace_variable "tkinter.Variable.trace_variable").

        Deprecated since version 3.6: Use [`trace_info()`](#tkinter.Variable.trace_info "tkinter.Variable.trace_info") instead. This method wraps a Tcl feature that
        was removed in Tcl 9.0.

*class* tkinter.StringVar(*master=None*, *value=None*, *name=None*)
:   A [`Variable`](#tkinter.Variable "tkinter.Variable") subclass that holds a string.
    The default value is `''`.

    get()
    :   Return the value of the variable as a [`str`](stdtypes.html#str "str").

*class* tkinter.IntVar(*master=None*, *value=None*, *name=None*)
:   A [`Variable`](#tkinter.Variable "tkinter.Variable") subclass that holds an integer.
    The default value is `0`.

    get()
    :   Return the value of the variable as an [`int`](functions.html#int "int").

*class* tkinter.DoubleVar(*master=None*, *value=None*, *name=None*)
:   A [`Variable`](#tkinter.Variable "tkinter.Variable") subclass that holds a float.
    The default value is `0.0`.

    get()
    :   Return the value of the variable as a [`float`](functions.html#float "float").

    Note

    A floating-point value is always parsed with a period (`.`) as the
    decimal separator, but [`Spinbox`](#tkinter.Spinbox "tkinter.Spinbox"), [`Scale`](#tkinter.Scale "tkinter.Scale") and
    [`ttk.Spinbox`](tkinter.ttk.html#tkinter.ttk.Spinbox "tkinter.ttk.Spinbox") format it according to the
    `LC_NUMERIC` locale. Under a locale that uses a comma they produce a
    value that [`get()`](#tkinter.DoubleVar.get "tkinter.DoubleVar.get") cannot read, raising [`TclError`](#tkinter.TclError "tkinter.TclError"). Set
    `LC_NUMERIC` to a locale that uses a period (such as `'C'`) to avoid
    this.

*class* tkinter.BooleanVar(*master=None*, *value=None*, *name=None*)
:   A [`Variable`](#tkinter.Variable "tkinter.Variable") subclass that holds a boolean.
    The default value is `False`.

    get()
    :   Return the value of the variable as a [`bool`](functions.html#bool "bool").
        Raise a [`ValueError`](exceptions.html#ValueError "ValueError") if the value cannot be interpreted as a
        boolean.

    set(*value*)
    :   Set the variable to *value*, converting it to a boolean.
        [`initialize()`](#tkinter.BooleanVar.initialize "tkinter.BooleanVar.initialize") is an alias of `set()`.
...
:   Base class for Tk images.
    ...
    *image* option; deleting all references to the `Image` object
    ...
    Usually you create a [`PhotoImage`](#tkinter.PhotoImage "tkinter.PhotoImage") or [`BitmapImage`](#tkinter.BitmapImage "tkinter.BitmapImage") rather than
    an `Image` directly.
    ...
    or with the [`configure()`](#tkinter.Image.configure "tkinter.Image.configure") method.

    configure(*\*\*kw*)
    :   Modify one or more configuration options of the image.
        The valid options depend on the image type; see [`PhotoImage`](#tkinter.PhotoImage "tkinter.PhotoImage") and
        [`BitmapImage`](#tkinter.BitmapImage "tkinter.BitmapImage").
        [`config()`](#tkinter.Image.config "tkinter.Image.config") is an alias of `configure()`.
...
:   A full-color image (the Tk `photo` image type), stored internally with a
    ...
    Inherits from [`Image`](#tkinter.Image "tkinter.Image").
    ...
    *file* (the name of a file to read the contents from), *format* (the name of
    ...
    copy(*\**, *from\_coords=None*, *zoom=None*, *subsample=None*)
    :   Return a new `PhotoImage` with a copy of this image.

        *from\_coords* specifies a rectangular sub-region of the source image to
        be copied.
        ...
        If *from\_coords* is not given, the whole source image is copied.

        If *zoom* or *subsample* are specified, the image is transformed as in
        the [`zoom()`](#tkinter.PhotoImage.zoom "tkinter.PhotoImage.zoom") or [`subsample()`](#tkinter.PhotoImage.subsample "tkinter.PhotoImage.subsample") methods.
        The value must be a single integer or a pair of integers.

        Changed in version 3.13: Added the *from\_coords*, *zoom* and *subsample* parameters.

    copy\_replace(*sourceImage*, *\**, *from\_coords=None*, *to=None*, *shrink=False*, *zoom=None*, *subsample=None*, *compositingrule=None*)
    :   Copy a region from *sourceImage* (which must be a `PhotoImage`)
        ...
        *from\_coords* specifies a rectangular sub-region of the source image to
        be copied, as in the [`copy()`](copy.html#module-copy "copy: Shallow and deep copy operations.") method.
    ...
    data(*format=None*, *\**, *from\_coords=None*, *background=None*, *grayscale=False*)
    :   Return the image data.
        ...
        *from\_coords* specifies a rectangular region of the image to be returned.
        It must be a tuple or a list of 1 to 4 integers `(x1, y1, x2, y2)`.
        ...
        If *from\_coords* is not given, the whole image is returned.
    ...
    read(*filename*, *format=None*, *\**, *from\_coords=None*, *to=None*, *shrink=False*)
    :   Read image data from the file named *filename* into the image.

        *format* specifies the format of the image data in the file.

        *from\_coords* specifies a rectangular sub-region of the image file data
        ...
        If *from\_coords* is not given, the whole of the image in the file is
        read.
    ...
    subsample(*x*, *y=''*, *\**, *from\_coords=None*)
    :   Return a new `PhotoImage` based on this image but using only every
        ...
        *from\_coords* specifies a rectangular sub-region of the source image to
        ...
        Changed in version 3.13: Added the *from\_coords* parameter.

    transparency\_get(*x*, *y*)
    :   Return `True` if the pixel at coordinates (*x*, *y*) is fully
        transparent, `False` otherwise.

        Added in version 3.8.

    transparency\_set(*x*, *y*, *boolean*)
    :   Make the pixel at coordinates (*x*, *y*) fully transparent if *boolean*
        is true, fully opaque otherwise.

        Added in version 3.8.

    write(*filename*, *format=None*, *from\_coords=None*, *\**, *background=None*, *grayscale=False*)
    :   Write image data from the image to the file named *filename*.
        ...
        *from\_coords* specifies a rectangular region of the image to be written.
        It must be a tuple or a list of 1 to 4 integers `(x1, y1, x2, y2)`.
        If only *x1* and *y1* are specified, the region extends from `(x1, y1)`
        to the bottom-right corner of the image.
        If all four coordinates are given, they specify diagonally opposite
        corners of the region.
        If *from\_coords* is not given, the whole image is written.
    ...
    zoom(*x*, *y=''*, *\**, *from\_coords=None*)
    :   Return a new `PhotoImage` with this image magnified by a factor of
...
:   A two-color image (the Tk `bitmap` image type) created from an X11 bitmap.
    ...
    *foreground* and *background* (the two colors).
    ...
    [`Image`](#tkinter.Image "tkinter.Image").

### Other classes

*class* tkinter.Event
:   A container for the attributes of an event passed to a callback bound with
    [`Misc.bind()`](#tkinter.Misc.bind "tkinter.Misc.bind").
    ...
    meaningful.
    See [Bindings and events](#bindings-and-events).
...
:   An [`enum.StrEnum`](enum.html#enum.StrEnum "enum.StrEnum") enumerating the Tk event types, used as the value
    of [`Event.type`](#tkinter.Event.type "tkinter.Event.type").
...
:   Internal helper that wraps a Python callback so that it can be invoked from
    ...
    *func* is the Python function, *subst* is an optional function that
    ...
    reporting.
    Instances are created automatically by [`Misc.register()`](#tkinter.Misc.register "tkinter.Misc.register"); this class is
...
:   The `Tcl()` function is a factory function which creates an object much
    like that created by the [`Tk`](#tkinter.Tk "tkinter.Tk") class, except that it does not
    ...
    created (and the Tk subsystem initialized) by calling its [`loadtk()`](#tkinter.Tk.loadtk "tkinter.Tk.loadtk")
    method.
...
:   Inhibit the creation of an implicit default root window.
    ...
    widget without an explicit *master* — raise a [`RuntimeError`](exceptions.html#RuntimeError "RuntimeError").
...
:   Run the Tk main event loop on the default root window until all windows are
    destroyed.
    Equivalent to calling [`Misc.mainloop()`](#tkinter.Misc.mainloop "tkinter.Misc.mainloop") on the default root.
...
:   Convert the Tcl boolean string *s* (one of `'1'`, `'true'`, `'yes'`,
    ...
    [`bool`](functions.html#bool "bool").
    Raise [`TclError`](#tkinter.TclError "tkinter.TclError") for an invalid value.

tkinter.getdouble(*s*)
:   Convert *s* to a floating-point number.
    This is the built-in [`float`](functions.html#float "float").

tkinter.getint(*s*)
:   Convert *s* to an integer.
    This is the built-in [`int`](functions.html#int "int").

tkinter.image\_names()
:   Return the names of all existing images in the default root’s interpreter.

tkinter.image\_types()
...
want to use the [`BufferedIOBase`](io.html#io.BufferedIOBase "io.BufferedIOBase") or [`TextIOBase`](io.html#io.TextIOBase "io.TextIOBase")
[`read()`](io.html#io.BufferedIOBase.read "io.BufferedIOBase.read") or [`readline()`](io.html#io.IOBase.readline "io.IOBase.readline") methods,
since these will insist on reading a predefined number of bytes.
For sockets, the [`recv()`](socket.html#socket.socket.recv "socket.socket.recv") or
[`recvfrom()`](socket.html#socket.socket.recvfrom "socket.socket.recvfrom") methods will work fine; for other files,
...
:   Registers the file handler callback function *func*. The *file* argument
    may either be an object with a [`fileno()`](io.html#io.IOBase.fileno "io.IOBase.fileno") method (such as
...
:   Compass directions (`'n'`, `'s'`, `'e'`, `'w'` and the diagonals and
    ...
    *sticky* options and by methods such as [`Misc.grid_anchor()`](#tkinter.Misc.grid_anchor "tkinter.Misc.grid_anchor").
...
tkinter.BOTTOM
:   Sides for the *side* option of the packer (see [`Pack.pack_configure()`](#tkinter.Pack.pack_configure "tkinter.Pack.pack_configure")).
...
tkinter.VERTICAL
:   Values for the *orient* option of widgets such as [`Scale`](#tkinter.Scale "tkinter.Scale"),
    [`Scrollbar`](#tkinter.Scrollbar "tkinter.Scrollbar") and [`PanedWindow`](#tkinter.PanedWindow "tkinter.PanedWindow").

tkinter.CHAR

tkinter.WORD
:   Values for the *wrap* option of the [`Text`](#tkinter.Text "tkinter.Text") widget, selecting line
...
:   Values for the *bordermode* option of the placer (see
    [`Place.place_configure()`](#tkinter.Place.place_configure "tkinter.Place.place_configure")).
...
tkinter.SEL\_LAST
:   Symbolic indices used by the [`Text`](#tkinter.Text "tkinter.Text"), [`Entry`](#tkinter.Entry "tkinter.Entry"), [`Listbox`](#tkinter.Listbox "tkinter.Listbox")
    and [`Canvas`](#tkinter.Canvas "tkinter.Canvas") widgets, such as `'insert'` (the insertion cursor),
    `'current'`, `'end'`, `'anchor'` and the bounds of the selection
    (`'sel.first'` and `'sel.last'`).

tkinter.ALL
:   The special tag `'all'`, which matches every item of a [`Canvas`](#tkinter.Canvas "tkinter.Canvas") or
    every character of a [`Text`](#tkinter.Text "tkinter.Text") (for example `canvas.delete(ALL)`).
...
tkinter.SEPARATOR
:   Menu entry types, used as the *itemType* argument of [`Menu.add()`](#tkinter.Menu.add "tkinter.Menu.add") and
    [`Menu.insert()`](#tkinter.Menu.insert "tkinter.Menu.insert").
...
tkinter.EXTENDED
:   Values for the *selectmode* option of the [`Listbox`](#tkinter.Listbox "tkinter.Listbox") widget.
...
tkinter.ARC
:   Values for the *style* option of [`Canvas`](#tkinter.Canvas "tkinter.Canvas") arc items.
...
:   Values for the *capstyle* (`'butt'`, `'projecting'`, `'round'`) and
    *joinstyle* (`'round'`, `'bevel'`, `'miter'`) options of
    [`Canvas`](#tkinter.Canvas "tkinter.Canvas") line items.

tkinter.FIRST

tkinter.LAST
:   Values for the *arrow* option of [`Canvas`](#tkinter.Canvas "tkinter.Canvas") line items, indicating
    which ends have arrowheads.

tkinter.MOVETO

tkinter.SCROLL
:   The first argument passed by a [`Scrollbar`](#tkinter.Scrollbar "tkinter.Scrollbar") to the [`XView.xview()`](#tkinter.XView.xview "tkinter.XView.xview")
    or [`YView.yview()`](#tkinter.YView.yview "tkinter.YView.yview") method of the scrolled widget.

tkinter.UNITS

tkinter.PAGES
:   Values for the *what* argument of [`XView.xview_scroll()`](#tkinter.XView.xview_scroll "tkinter.XView.xview_scroll") and
    [`YView.yview_scroll()`](#tkinter.YView.yview_scroll "tkinter.YView.yview_scroll").
