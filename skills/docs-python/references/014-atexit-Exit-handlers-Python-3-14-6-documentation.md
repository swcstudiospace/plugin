# atexit — Exit handlers — Python 3.14.6 documentation
...
Module [`readline`](readline.html#module-readline "readline: GNU readline support for Python.")
:   Useful example of `atexit` to read and write [`readline`](readline.html#module-readline "readline: GNU readline support for Python.") history
    files.
