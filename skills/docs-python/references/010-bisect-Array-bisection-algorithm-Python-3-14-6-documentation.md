# bisect — Array bisection algorithm — Python 3.14.6 documentation
...
bisect.bisect\_left(*a*, *x*, *lo=0*, *hi=len(a)*, *\**, *key=None*)
...
bisect.bisect\_right(*a*, *x*, *lo=0*, *hi=len(a)*, *\**, *key=None*)
...
bisect.insort\_left(*a*, *x*, *lo=0*, *hi=len(a)*, *\**, *key=None*)
...
bisect.insort\_right(*a*, *x*, *lo=0*, *hi=len(a)*, *\**, *key=None*)
