# cmd — Support for line-oriented command interpreters — Python 3.14.6 documentation

Source: https://docs.python.org/3/library/cmd.html
...
:   A `Cmd` instance or subclass instance is a line-oriented interpreter
    ...
    Specifically, if `readline.backend` is `editline`,
