# Async hooks | Node.js v26.5.0 Documentation

Source: https://nodejs.org/api/async_hooks.html

## Async hooks[#](#async-hooks)

**Source Code:** [lib/async\_hooks.js](https://github.com/nodejs/node/blob/main/lib/async_hooks.js)

[Stability: 1](documentation.html#stability-index) - Experimental. Please migrate away from this API, if you can.
...
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) The [Hook Callbacks](#hook-callbacks) to register
  - `init` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The [`init` callback](#initasyncid-type-triggerasyncid-resource).
  - `before` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The [`before` callback](#beforeasyncid).
  - `after` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The [`after` callback](#afterasyncid).
  - `destroy` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The [`destroy` callback](#destroyasyncid).
  - `promiseResolve` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The [`promiseResolve` callback](#promiseresolveasyncid).
  - `trackPromises` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) Whether the hook should track `Promise`s. Cannot be `false` if
    `promiseResolve` is set. **Default**: `true`.
- Returns: [`<AsyncHook>`](async_hooks.html#async_hookscreatehookoptions) Instance used for disabling and enabling hooks
...
- Returns: [`<AsyncHook>`](async_hooks.html#async_hookscreatehookoptions) A reference to `asyncHook`.
...
- `asyncId` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) A unique ID for the async resource.
- `type` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) The type of the async resource.
- `triggerAsyncId` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The unique ID of the async resource in whose
  execution context this async resource was created.
- `resource` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) Reference to the resource representing the async
...
The context tracking use case is covered by the stable API [`AsyncLocalStorage`](async_context.html#class-asynclocalstorage).
...
- Returns: [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) The resource representing the current execution.
...
Added in: v8.1.0History

| Version | Changes |
| --- | --- |
| v8.2.0 | Renamed from `currentId`. |

- Returns: [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The `asyncId` of the current execution context. Useful to
...
See the section on [promise execution tracking](#promise-execution-tracking).

#### `async_hooks.triggerAsyncId()`[#](#async_hookstriggerasyncid)

- Returns: [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The ID of the resource responsible for calling the callback
...
the section on [promise execution tracking](#promise-execution-tracking).
...
See: [DEP0111](deprecations.html#dep0111-processbinding)
...
#### Disabling promise execution tracking[#](#disabling-promise-execution-tracking)
...
The documentation for this class has moved [`AsyncResource`](async_context.html#class-asyncresource).

### Class: `AsyncLocalStorage`[#](#class-asynclocalstorage)

The documentation for this class has moved [`AsyncLocalStorage`](async_context.html#class-asynclocalstorage).
