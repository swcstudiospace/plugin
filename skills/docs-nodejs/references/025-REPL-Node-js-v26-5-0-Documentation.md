# REPL | Node.js v26.5.0 Documentation

Source: https://nodejs.org/api/repl.html

## REPL[#](#repl)

**Source Code:** [lib/repl.js](https://github.com/nodejs/node/blob/main/lib/repl.js)
...
The `node:repl` module exports the [`repl.REPLServer`](#class-replserver) class. While running,
...
For all other key bindings, see [TTY keybindings](readline.html#tty-keybindings).

#### Default evaluation[#](#default-evaluation)

By default, all instances of [`repl.REPLServer`](#class-replserver) use an evaluation function
that evaluates JavaScript expressions and provides access to Node.js built-in
modules. This default behavior can be overridden by passing in an alternative
evaluation function when the [`repl.REPLServer`](#class-replserver) instance is created.
...
The REPL uses the [`domain`](domain.html) module to catch all uncaught exceptions for that
REPL session.
...
- Trying to use [`process.setUncaughtExceptionCaptureCallback()`](process.html#processsetuncaughtexceptioncapturecallbackfn) throws
  an [`ERR_DOMAIN_CANNOT_SET_UNCAUGHT_EXCEPTION_CAPTURE`](errors.html#err_domain_cannot_set_uncaught_exception_capture) error.
...
[`--no-experimental-repl-await`](cli.html#--no-experimental-repl-await) shall disable top-level await in REPL.
...
When a new [`repl.REPLServer`](#class-replserver) is created, a custom evaluation function may be
provided. This can be used, for instance, to implement fully customized REPL
applications.

An evaluation function accepts the following four arguments:

- `code` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) The code to be executed (e.g. `1 + 1`).
- `context` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) The context in which the code is executed. This can either be the JavaScript `global`
  context or a context specific to the REPL instance, depending on the `useGlobal` option.
- `replResourceName` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) An identifier for the REPL resource associated with the current code
  evaluation. This can be useful for debugging purposes.
- `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) A function to invoke once the code evaluation is complete. The callback takes two parameters:
...
By default, [`repl.REPLServer`](#class-replserver) instances format output using the
...
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) | [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) See [`repl.start()`](#replstartoptions)
- Extends: [`<readline.Interface>`](readline.html#class-readlineinterface)

Instances of `repl.REPLServer` are created using the [`repl.start()`](#replstartoptions) method
...
- `keyword` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) The command keyword (*without* a leading `.` character).
- `cmd` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) | [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The function to invoke when the command is processed.
...
- `help` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) Help text to be displayed when `.help` is entered (Optional).
- `action` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The function to execute, optionally accepting a single
  string argument.
...
#### `replServer.setupHistory(historyConfig, callback)`[#](#replserversetuphistoryhistoryconfig-callback)
...
- `historyConfig` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) | [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) the path to the history file
  If it is a string, it is the path to the history file.
  If it is an object, it can have the following properties:
  - `filePath` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) the path to the history file
  - `size` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Maximum number of history lines retained. To disable
  ...
  - `onHistoryFileLoaded` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) called when history writes are ready or upon error
    - `err` [`<Error>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Error)
    - `repl` [`<repl.REPLServer>`](repl.html#replreplserver)
- `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) called when history writes are ready or upon error
...
Added in: v14.5.0Deprecated in: v24.0.0, v22.16.0

Stability: 0 - Deprecated. Use [`module.builtinModules`](module.html#modulebuiltinmodules) instead.
...
| Version | Changes |
| --- | --- |
| v25.9.0 | The `handleError` parameter has been added. |
...
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) | [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type)
  - `prompt` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) The input prompt to display. **Default:** `'> '`
    (with a trailing space).
  - `input` [`<stream.Readable>`](stream.html#class-streamreadable) The `Readable` stream from which REPL input will
    be read. **Default:** `process.stdin`.
  - `output` [`<stream.Writable>`](stream.html#class-streamwritable) The `Writable` stream to which REPL output will
    be written. **Default:** `process.stdout`.
  - `terminal` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) If `true`, specifies that the `output` should be
    treated as a TTY terminal.
    **Default:** checking the value of the `isTTY` property on the `output`
    stream upon instantiation.
  - `eval` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The function to be used when evaluating each given line
    ...
    [custom evaluation functions](#custom-evaluation-functions) section for more details.
  - `useColors` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) If `true`, specifies that the default `writer`
    ...
    is `true`.
  - `useGlobal` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) If `true`, specifies that the default evaluation
    function will use the JavaScript `global` as the context as opposed to
    creating a new separate context for the REPL instance. The node CLI REPL
    sets this value to `true`. **Default:** `false`.
  - `ignoreUndefined` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) If `true`, specifies that the default writer
    will not output the return value of a command if it evaluates to
    `undefined`. **Default:** `false`.
  - `writer` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The function to invoke to format the output of each
    command before writing to `output`. **Default:** [`util.inspect()`](util.html#utilinspectobject-options).
  - `completer` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) An optional function used for custom Tab auto
    completion. See [`readline.InterfaceCompleter`](readline.html#use-of-the-completer-function) for an example.
  - `replMode` [`<symbol>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#symbol_type) A flag that specifies whether the default evaluator
  ...
  - `breakEvalOnSigint` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) Stop evaluating the current piece of code when `SIGINT` is received, such as when `Ctrl`+`C` is pressed.
    This cannot be used
    together with a custom `eval` function. **Default:** `false`.
  - `preview` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) Defines if the repl prints autocomplete and output
  ...
  - `handleError` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) This function customizes error handling in the REPL.
    ...
    - `'unhandled'` to treat the exception as fully unhandled. In this case,
      ...
      use case.
- Returns: [`<repl.REPLServer>`](repl.html#replreplserver)

The `repl.start()` method creates and starts a [`repl.REPLServer`](#class-replserver) instance.
...
#### Starting multiple REPL instances in the same process[#](#starting-multiple-repl-instances-in-the-same-process)
...
##### Full-featured "terminal" REPL over `net.Server` and `net.Socket`[#](#full-featured-terminal-repl-over-netserver-and-netsocket)
