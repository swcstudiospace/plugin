# Asynchronous context tracking | Node.js v26.5.0 Documentation
...
Added in: v13.10.0, v12.17.0History
...
#### `new AsyncLocalStorage([options])`[#](#new-asynclocalstorageoptions)
...
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `defaultValue` [`<any>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#Data_types) The default value to be used when no store is provided.
  - `name` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) A name for the `AsyncLocalStorage` value.
...
Added in: v19.8.0, v18.16.0History

| Version | Changes |
| --- | --- |
| v23.11.0, v22.15.0 | Marking the API stable. |

- `fn` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The function to bind to the current execution context.
- Returns: [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) A new function that calls `fn` within the captured
  execution context.
...
- Returns: [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) A new function with the signature `(fn: (...args) : R, ...args) : R`.
...
#### `asyncLocalStorage.name`[#](#asynclocalstoragename)
...
#### Usage with `async/await`[#](#usage-with-asyncawait)
...
[`util.promisify()`](util.html#utilpromisifyoriginal) so it starts working with native promises.

If you need to use a callback-based API or your code assumes
a custom thenable implementation, use the [`AsyncResource`](#class-asyncresource) class
...
### Class: `RunScope`[#](#class-runscope)

Added in: v25.9.0

Stability: 1 - Experimental

A disposable scope returned by [`asyncLocalStorage.withScope()`](#asynclocalstoragewithscopestore) that
...
- `type` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) The type of async event.
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
...
- `fn` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The function to bind to the current execution context.
- `type` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) An optional name to associate with the underlying `AsyncResource`.
...
- `fn` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The function to bind to the current `AsyncResource`.
- `thisArg` [`<any>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#Data_types)
...
- `fn` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) The function to call in the execution context of this async
  resource.
...
- Returns: [`<AsyncResource>`](async_hooks.html#class-asyncresource) A reference to `asyncResource`.
...
- Returns: [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The unique `asyncId` assigned to the resource.

#### `asyncResource.triggerAsyncId()`[#](#asyncresourcetriggerasyncid)

- Returns: [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The same `triggerAsyncId` that is passed to the
  `AsyncResource` constructor.

#### Using `AsyncResource` for a `Worker` thread pool[#](#using-asyncresource-for-a-worker-thread-pool)

The following example shows how to use the `AsyncResource` class to properly
provide async tracking for a [`Worker`](worker_threads.html#class-worker) pool. Other resource pools, such as
...
Event listeners triggered by an [`EventEmitter`](events.html#class-eventemitter) may be run in a different
execution context than the one that was active when `eventEmitter.on()` was
called.

The following example shows how to use the `AsyncResource` class to properly
associate an event listener with the correct execution context. The same
approach can be applied to a [`Stream`](stream.html#stream) or a similar event-driven class.
