# Environment Variables | Node.js v26.5.0 Documentation
...
for more details refer to the [CLI Environment Variables documentation](cli.html#environment-variables_1).
...
For more details refer to the [`process.env` documentation](process.html#processenv).
...
##### `export` prefixes[#](#export-prefixes)
...
- [`util.parseEnv`](util.html#utilparseenvcontent) parses the raw content of an `.env` file and returns its value in an object
