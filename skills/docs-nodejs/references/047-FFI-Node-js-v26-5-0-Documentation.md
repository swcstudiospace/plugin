# FFI | Node.js v26.5.0 Documentation

Source: https://nodejs.org/api/ffi.html

## FFI[#](#ffi)

**Source Code:** [lib/ffi.js](https://github.com/nodejs/node/blob/main/lib/ffi.js)Added in: v26.1.0
...
restricted unless the [`--allow-ffi`](cli.html#--allow-ffi) flag is provided.
...
- `return` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) A [type name](#type-names) specifying the return type of the
  function or callback. **Default:** `'void'`.
- `arguments` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type)[] An array of [type names](#type-names) specifying the argument
...
### `ffi.dlopen(path[, definitions])`[#](#ffidlopenpath-definitions)

Added in: v26.1.0

- `path` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) | [`<null>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#null_type) Path to a dynamic library, or `null` to resolve symbols
  from the current process image.
- `definitions` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) Symbol definitions to resolve immediately.
...
- `functions` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) Callable wrappers for the requested symbols.
...
### `ffi.dlclose(handle)`[#](#ffidlclosehandle)
...
### `ffi.dlsym(handle, symbol)`[#](#ffidlsymhandle-symbol)

Added in: v26.1.0

- `handle` {DynamicLibrary}
- `symbol` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type)
...
#### `new DynamicLibrary(path)`[#](#new-dynamiclibrarypath)
...
#### `library[Symbol.dispose]()`[#](#librarysymboldispose)
...
#### `library.getFunction(name, signature)`[#](#librarygetfunctionname-signature)
...
#### `library.getFunctions([definitions])`[#](#librarygetfunctionsdefinitions)
...
#### `library.getSymbol(name)`[#](#librarygetsymbolname)
...
#### `library.getSymbols()`[#](#librarygetsymbols)

- Returns: [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)

Returns an object containing all previously resolved symbol addresses.

#### `library.registerCallback([signature,] callback)`[#](#libraryregistercallbacksignature-callback)
...
#### `library.unregisterCallback(pointer)`[#](#libraryunregistercallbackpointer)

- `pointer` [`<bigint>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#bigint_type)
...
#### `library.refCallback(pointer)`[#](#libraryrefcallbackpointer)

- `pointer` [`<bigint>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#bigint_type)

Keeps the callback strongly referenced by JavaScript.

#### `library.unrefCallback(pointer)`[#](#libraryunrefcallbackpointer)
...
### Primitive memory access helpers[#](#primitive-memory-access-helpers)
...
### `ffi.toString(pointer)`[#](#ffitostringpointer)
...
- `pointer` [`<bigint>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#bigint_type)
- `length` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type)
- `copy` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) When `false`, creates a zero-copy view. **Default:** `true`.
...
### `ffi.toArrayBuffer(pointer, length[, copy])`[#](#ffitoarraybufferpointer-length-copy)
...
### `ffi.exportString(string, pointer, length[, encoding])`[#](#ffiexportstringstring-pointer-length-encoding)
...
### `ffi.exportBuffer(buffer, pointer, length)`[#](#ffiexportbufferbuffer-pointer-length)
...
### `ffi.exportArrayBuffer(arrayBuffer, pointer, length)`[#](#ffiexportarraybufferarraybuffer-pointer-length)

Added in: v26.1.0

- `arrayBuffer` [`<ArrayBuffer>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer)
- `pointer` [`<bigint>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#bigint_type)
- `length` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type)
...
### `ffi.exportArrayBufferView(arrayBufferView, pointer, length)`[#](#ffiexportarraybufferviewarraybufferview-pointer-length)
...
### `ffi.getRawPointer(source)`[#](#ffigetrawpointersource)

Added in: v26.1.0

- `source` [`<Buffer>`](buffer.html#class-buffer) | [`<ArrayBuffer>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) | `<ArrayBufferView>`
- Returns: [`<bigint>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#bigint_type)
