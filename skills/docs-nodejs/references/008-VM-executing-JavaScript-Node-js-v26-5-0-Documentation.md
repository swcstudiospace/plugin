# VM (executing JavaScript) | Node.js v26.5.0 Documentation

Source: https://nodejs.org/api/vm.html

## VM (executing JavaScript)[#](#vm-executing-javascript)

**Source Code:** [lib/vm.js](https://github.com/nodejs/node/blob/main/lib/vm.js)
...
- `code` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) The JavaScript code to compile.
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) | [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type)
  ...
  - `cachedData` [`<Buffer>`](buffer.html#class-buffer) | [`<TypedArray>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`<DataView>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DataView) Provides an optional `Buffer` or
    `TypedArray`, or `DataView` with V8's code cache data for the supplied
    source. When supplied, the `cachedDataRejected` value will be set to
    either `true` or `false` depending on acceptance of the data by V8.
  - `produceCachedData` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) When `true` and no `cachedData` is present, V8
    ...
    **Default:** `false`.
  - `importModuleDynamically` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) | [`<vm.constants.USE_MAIN_CONTEXT_DEFAULT_LOADER>`](vm.html#vmconstantsuse_main_context_default_loader)
...
- `contextifiedObject` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) A [contextified](#what-does-it-mean-to-contextify-an-object) object as returned by the
  `vm.createContext()` method.
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `displayErrors` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) When `true`, if an [`Error`](errors.html#class-error) occurs
...
- `contextObject` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) | [`<vm.constants.DONT_CONTEXTIFY>`](vm.html#vmconstantsdont_contextify) | [`<undefined>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#undefined_type)
  Either [`vm.constants.DONT_CONTEXTIFY`](#vmconstantsdont_contextify) or an object that will be [contextified](#what-does-it-mean-to-contextify-an-object).
...
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `breakOnSigint` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) If `true`, receiving `SIGINT`
    ...
    `process.on('SIGINT')` are disabled during script execution, but continue to
    work after that. **Default:** `false`.
  - `contextName` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) Human-readable name of the newly created context. **Default:** `'VM Context i'`, where `i` is an ascending numerical index of
    the created context.
  - `contextOrigin` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) [Origin](https://developer.mozilla.org/en-US/docs/Glossary/Origin) corresponding to the newly
...
### Class: `vm.Module`[#](#class-vmmodule)
...
- `linker` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function)
  - `specifier` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) The specifier of the requested module:
    ...
    mjscopy
    ```
  - `referencingModule` [`<vm.Module>`](vm.html#class-vmmodule) The `Module` object `link()` is called on.
  ...
  - Returns: [`<vm.Module>`](vm.html#class-vmmodule) | [`<Promise>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)
...
- Extends: [`<vm.Module>`](vm.html#class-vmmodule)
...
- `options`
  - `identifier` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) String used in stack traces. **Default:** `'vm:module(i)'` where `i` is a context-specific ascending
    index.
  - `cachedData` [`<Buffer>`](buffer.html#class-buffer) | [`<TypedArray>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`<DataView>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DataView) Provides an optional `Buffer` or
    `TypedArray`, or `DataView` with V8's code cache data for the supplied
    source. The `code` must be the same as the module from which this
    `cachedData` was created.
  - `context` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) The [contextified](#what-does-it-mean-to-contextify-an-object) object as returned by the
  ...
  - `initializeImportMeta` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) Called during evaluation of this `Module`
    ...
    - `meta` [`<import.meta>`](esm.html#importmeta)
    - `module` [`<vm.SourceTextModule>`](vm.html#class-vmsourcetextmodule)
...
#### `sourceTextModule.dependencySpecifiers`[#](#sourcetextmoduledependencyspecifiers)
...
Stability: 0 - Deprecated: Use [`sourceTextModule.moduleRequests`](#sourcetextmodulemodulerequests) instead.
...
#### `sourceTextModule.hasAsyncGraph()`[#](#sourcetextmodulehasasyncgraph)
...
#### `sourceTextModule.hasTopLevelAwait()`[#](#sourcetextmodulehastoplevelawait)
...
Added in: v24.8.0, v22.21.0

- Returns: [`<undefined>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#undefined_type)
...
- `modules` [`<vm.Module>`](vm.html#class-vmmodule)[] Array of `vm.Module` objects that this module depends on.
...
- Type: [`<ModuleRequest>`](vm.html#type-modulerequest)[] Dependencies of this module.
...
| Version | Changes |
| --- | --- |
| v24.8.0, v22.21.0 | No longer need to call `syntheticModule.link()` before calling this method. |
...
### Type: `ModuleRequest`[#](#type-modulerequest)
...
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `produceCachedData` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) Specifies whether to produce new cache data. **Default:** `false`.
  - `parsingContext` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) The [contextified](#what-does-it-mean-to-contextify-an-object) object in which the said
...
- `contextObject` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) | [`<vm.constants.DONT_CONTEXTIFY>`](vm.html#vmconstantsdont_contextify) | [`<undefined>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#undefined_type)
  ...
  If `undefined`, an empty contextified object will be created for backwards compatibility.
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `name` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) Human-readable name of the newly created context. **Default:** `'VM Context i'`, where `i` is an ascending numerical index of
    the created context.
  - `origin` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) [Origin](https://developer.mozilla.org/en-US/docs/Glossary/Origin) corresponding to the newly created
  ...
  - `importModuleDynamically` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) | [`<vm.constants.USE_MAIN_CONTEXT_DEFAULT_LOADER>`](vm.html#vmconstantsuse_main_context_default_loader)
    ...
    [Support of dynamic `import()` in compilation APIs](#support-of-dynamic-import-in-compilation-apis).
- Returns: [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) contextified object.
...
Returns `true` if the given `object` object has been [contextified](#what-does-it-mean-to-contextify-an-object) using
...
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) Optional.
  ...
  - `execution` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) Either `'default'` or `'eager'`. With default
    ...
    **Default:** `'default'`
- Returns: [`<Promise>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise) If the memory is successfully measured, the promise will
...
- `contextifiedObject` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) The [contextified](#what-does-it-mean-to-contextify-an-object) object that will be used
...
When using either [`script.runInThisContext()`](#scriptruninthiscontextoptions) or
...
### Timeout interactions with asynchronous tasks and Promises[#](#timeout-interactions-with-asynchronous-tasks-and-promises)
...
#### When `microtaskMode` is `'afterEvaluate'`, beware sharing Promises between Contexts[#](#when-microtaskmode-is-afterevaluate-beware-sharing-promises-between-contexts)
...
- `referrer` [`<vm.Script>`](vm.html#class-vmscript) | [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) | [`<vm.SourceTextModule>`](vm.html#class-vmsourcetextmodule) | [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
...
- Returns: [`<Module Namespace Object>`](https://tc39.github.io/ecma262/#sec-module-namespace-exotic-objects) | [`<vm.Module>`](vm.html#class-vmmodule) Returning a `vm.Module` is
