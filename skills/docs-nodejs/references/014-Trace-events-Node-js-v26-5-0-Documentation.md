# Trace events | Node.js v26.5.0 Documentation

Source: https://nodejs.org/api/tracing.html

## Trace events[#](#trace-events)

**Source Code:** [lib/trace\_events.js](https://github.com/nodejs/node/blob/main/lib/trace_events.js)
...
The features from this module are not available in [`Worker`](worker_threads.html#class-worker) threads.
...
- Type: [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) `true` only if the `Tracing` object has been enabled.
...
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `categories` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type)[] An array of trace category names. Values included
    in the array are coerced to a string when possible. An error will be
    thrown if the value cannot be coerced.
- Returns: [`<Tracing>`](tracing.html#tracing-object).
...
#### Collect trace events data by inspector[#](#collect-trace-events-data-by-inspector)
