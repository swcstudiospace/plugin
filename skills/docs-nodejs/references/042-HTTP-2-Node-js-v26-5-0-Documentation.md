# HTTP/2 | Node.js v26.5.0 Documentation

Source: https://nodejs.org/api/http2.html

## HTTP/2[#](#http2)

**Source Code:** [lib/http2.js](https://github.com/nodejs/node/blob/main/lib/http2.js)Added in: v8.4.0History
...
the [Compatibility API](#compatibility-api) is.
...
[`http2.createSecureServer()`](#http2createsecureserveroptions-onrequesthandler) is necessary when communicating
...
Every `Http2Session` instance is associated with exactly one [`net.Socket`](net.html#class-netsocket) or
[`tls.TLSSocket`](tls.html#class-tlstlssocket) when it is created. When either the `Socket` or the
...
- `session` [`<Http2Session>`](http2.html#class-http2session)
...
- `errorCode` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The HTTP/2 error code specified in the `GOAWAY` frame.
- `lastStreamID` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The ID of the last stream the remote peer successfully
  processed (or `0` if no ID is specified).
- `opaqueData` [`<Buffer>`](buffer.html#class-buffer) If additional opaque data was included in the `GOAWAY`
...
- `settings` [`<HTTP/2 Settings Object>`](http2.html#settings-object) A copy of the `SETTINGS` frame received.
...
- `payload` [`<Buffer>`](buffer.html#class-buffer) The `PING` frame 8-byte payload
...
- `stream` [`<Http2Stream>`](http2.html#class-http2stream) A reference to the stream
- `headers` [`<HTTP/2 Headers Object>`](http2.html#headers-object) An object describing the headers
...
- `error` [`<Error>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Error) An `Error` object if the `Http2Session` is being destroyed
  due to an error.
- `code` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The HTTP/2 error code to send in the final `GOAWAY` frame.
...
- Type: [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) | [`<undefined>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#undefined_type)
...
- `code` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) An HTTP/2 error code
- `lastStreamID` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The numeric ID of the last processed `Http2Stream`
- `opaqueData` [`<Buffer>`](buffer.html#class-buffer) | [`<TypedArray>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`<DataView>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DataView) A `TypedArray` or `DataView`
...
- Type: [`<HTTP/2 Settings Object>`](http2.html#settings-object)
...
Added in: v8.9.3History

| Version | Changes |
| --- | --- |
| v18.0.0 | Passing an invalid callback to the `callback` argument now throws `ERR_INVALID_ARG_TYPE` instead of `ERR_INVALID_CALLBACK`. |

- `payload` [`<Buffer>`](buffer.html#class-buffer) | [`<TypedArray>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`<DataView>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DataView) Optional ping payload.
- `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function)
...
Calls [`ref()`](net.html#socketref) on this `Http2Session`
instance's underlying [`net.Socket`](net.html#class-netsocket).
...
- Type: [`<net.Socket>`](net.html#class-netsocket) | [`<tls.TLSSocket>`](tls.html#tlstlssocket)
...
[`Http2Session` and Sockets](#http2session-and-sockets) for more information.
...
- Type: [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `effectiveLocalWindowSize` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The current local (receive)
    flow control window size for the `Http2Session`.
  - `effectiveRecvDataLength` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The current number of bytes
    that have been received since the last flow control `WINDOW_UPDATE`.
  - `nextStreamID` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The numeric identifier to be used the
    next time a new `Http2Stream` is created by this `Http2Session`.
  - `localWindowSize` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The number of bytes that the remote peer can
    send without receiving a `WINDOW_UPDATE`.
  - `lastProcStreamID` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The numeric id of the `Http2Stream`
    for which a `HEADERS` or `DATA` frame was most recently received.
  - `remoteWindowSize` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The number of bytes that this `Http2Session`
    may send without receiving a `WINDOW_UPDATE`.
  - `outboundQueueSize` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The number of frames currently within the
    outbound queue for this `Http2Session`.
  - `deflateDynamicTableSize` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The current size in bytes of the
    outbound header compression state table.
  - `inflateDynamicTableSize` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The current size in bytes of the
...
- `settings` [`<HTTP/2 Settings Object>`](http2.html#settings-object)
- `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) Callback that is called once the session is connected or
  right away if the session is already connected.
  - `err` [`<Error>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Error) | [`<null>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#null_type)
  - `settings` [`<HTTP/2 Settings Object>`](http2.html#settings-object) The updated `settings` object.
...
Calls [`unref()`](net.html#socketunref) on this `Http2Session`
instance's underlying [`net.Socket`](net.html#class-netsocket).
...
- Extends: [`<Http2Session>`](http2.html#class-http2session)

##### `serverhttp2session.altsvc(alt, originOrStream)`[#](#serverhttp2sessionaltsvcalt-originorstream)

Added in: v9.4.0

- `alt` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) A description of the alternative service configuration as
  defined by [RFC 7838](https://tools.ietf.org/html/rfc7838).
- `originOrStream` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) | [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) | [`<URL>`](url.html#the-whatwg-url-api) | [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) Either a URL string specifying
...
The format of the `alt` parameter is strictly defined by [RFC 7838](https://tools.ietf.org/html/rfc7838) as an
...
| v24.2.0, v22.17.0, v20.19.6 | Following the deprecation of priority signaling as of RFC 9113, `weight` option is deprecated. |
| v24.0.0, v22.17.0 | Allow passing headers in raw array format. |

- `headers` [`<HTTP/2 Headers Object>`](http2.html#headers-object) | `<HTTP/2 Raw Headers>`
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)

  - `endStream` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) `true` if the `Http2Stream` *writable* side should
  ...
  - `signal` [`<AbortSignal>`](globals.html#class-abortsignal) An AbortSignal that may be used to abort an ongoing
    request.
- Returns: [`<ClientHttp2Stream>`](http2.html#class-clienthttp2stream)
...
The `Http2Stream` class is a base for the [`ServerHttp2Stream`](#class-serverhttp2stream) and
[`ClientHttp2Stream`](#class-clienthttp2stream) classes, each of which is used specifically by either
the Server or Client side, respectively.

All `Http2Stream` instances are [`Duplex`](stream.html#class-streamduplex) streams. The `Writable` side of the
...
On the server side, instances of [`ServerHttp2Stream`](#class-serverhttp2stream) are created either
when:

- A new HTTP/2 `HEADERS` frame with a previously unused stream ID is received;
- The `http2stream.pushStream()` method is called.

On the client side, instances of [`ClientHttp2Stream`](#class-clienthttp2stream) are created when the
...
All [`Http2Stream`](#class-http2stream) instances are destroyed either when:
...
##### Event: `'frameError'`[#](#event-frameerror-1)
...
trailing header fields is received. The listener callback is passed the [HTTP/2 Headers Object](#headers-object), flags associated
with the headers, and the headers in raw format (see [HTTP/2 Raw Headers](#raw-headers)).
...
See [`net.Socket.bufferSize`](net.html#socketbuffersize) for details.
...
- `code` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Unsigned 32-bit integer identifying the error code. **Default:** `http2.constants.NGHTTP2_NO_ERROR` (`0x00`).
- `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) An optional function registered to listen for the `'close'` event.
...
Added in: v8.4.0Deprecated in: v24.2.0, v22.17.0, v20.19.6History
...
in the [RFC 9113](https://datatracker.ietf.org/doc/html/rfc9113#section-5.3.1) and is no longer supported in Node.js.
...
Set to the `RST_STREAM` [error code](#error-codes-for-rst_stream-and-goaway) reported when the `Http2Stream` is
...
- Type: [`<HTTP/2 Headers Object>`](http2.html#headers-object)
...
- Type: [`<Http2Session>`](http2.html#class-http2session)
...
| v24.2.0, v22.17.0, v20.19.6 | Following the deprecation of priority signaling as of RFC 9113, `weight` and `sumDependencyWeight` options are deprecated. |
...
- Type: [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `state` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) A flag indicating the low-level current state of the `Http2Stream` as determined by `nghttp2`.
...
- Extends [`<Http2Stream>`](http2.html#class-http2stream)
...
The listener callback is passed the [HTTP/2 Headers Object](#headers-object), flags associated
with the headers, and the headers in raw format (see [HTTP/2 Raw Headers](#raw-headers)).
...
are received. The listener callback is passed the [HTTP/2 Headers Object](#headers-object), flags associated
with the headers, and the headers in raw format (see [HTTP/2 Raw Headers](#raw-headers)).
...
[HTTP/2 Headers Object](#headers-object), flags associated with the headers, and the headers
in raw format (see [HTTP/2 Raw Headers](#raw-headers)).
...
The `ServerHttp2Stream` class is an extension of [`Http2Stream`](#class-http2stream) that is
...
- `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) Callback that is called once the push stream has been
  ...
  - `pushStream` [`<ServerHttp2Stream>`](http2.html#class-serverhttp2stream) The returned `pushStream` object.
  - `headers` [`<HTTP/2 Headers Object>`](http2.html#headers-object) Headers object the `pushStream` was
    initiated with.
...
- `fd` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) | [`<FileHandle>`](fs.html#class-filehandle) A readable file descriptor.
- `headers` [`<HTTP/2 Headers Object>`](http2.html#headers-object)
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
...
- `request` [`<http2.Http2ServerRequest>`](http2.html#class-http2http2serverrequest)
- `response` [`<http2.Http2ServerResponse>`](http2.html#class-http2http2serverresponse)

If a [`'request'`](#event-request) listener is registered or [`http2.createServer()`](#http2createserveroptions-onrequesthandler) is
...
- `session` [`<ServerHttp2Session>`](http2.html#class-serverhttp2session)
...
See also [`Http2Session`'s `'stream'` event](#event-stream).
...
[`net.Server.close()`](net.html#serverclosecallback) for more details.
...
- `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function)
- Returns: [`<Http2Server>`](http2.html#class-http2server)
...
##### Event: `'checkContinue'`[#](#event-checkcontinue-1)
...
If a [`'request'`](#event-request) listener is registered or [`http2.createSecureServer()`](#http2createsecureserveroptions-onrequesthandler)
...
handshake begins. `socket` is typically an object of type [`net.Socket`](net.html#class-netsocket).
...
##### Event: `'sessionError'`[#](#event-sessionerror-1)
...
`'unknownProtocolTimeout'` option passed to [`http2.createSecureServer()`](#http2createsecureserveroptions-onrequesthandler).
...
##### `server.close([callback])`[#](#serverclosecallback-1)
...
If `callback` is provided, it is not invoked until all active sessions have been
closed, although the server has already stopped allowing new sessions. See
[`tls.Server.close()`](tls.html#serverclosecallback) for more details.

##### `server.setTimeout([msecs][, callback])`[#](#serversettimeoutmsecs-callback-1)
...
- `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function)
- Returns: [`<Http2SecureServer>`](http2.html#class-http2secureserver)
...
##### `server.timeout`[#](#servertimeout-1)
...
##### `server.updateSettings([settings])`[#](#serverupdatesettingssettings-1)
...
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `maxSettings` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Sets the maximum number of settings entries per `SETTINGS` frame. The minimum value allowed is `1`. **Default:** `32`.
  ...
  - `maxHeaderListPairs` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Sets the maximum number of header entries.
    This is similar to [`server.maxHeadersCount`](http.html#servermaxheaderscount) or
    [`request.maxHeadersCount`](http.html#requestmaxheaderscount) in the `node:http` module. The minimum value
    is `4`. **Default:** `128`.
  ...
  - `maxSessionInvalidFrames` [`<integer>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Sets the maximum number of invalid
    frames that will be tolerated before the session is closed. **Default:** `1000`.
  - `maxSessionRejectedStreams` [`<integer>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Sets the maximum number of rejected
    ...
    **Default:** `100`.
  - `settings` [`<HTTP/2 Settings Object>`](http2.html#settings-object) The initial settings to send to the
  ...
  - `Http1IncomingMessage` [`<http.IncomingMessage>`](http.html#class-httpincomingmessage) Specifies the `IncomingMessage` class to used for HTTP/1 fallback. Useful for extending
    the original `http.IncomingMessage`. **Default:** `http.IncomingMessage`.
    **Deprecated.** Use `http1Options.IncomingMessage` instead. See
    [DEP0202](deprecations.html#dep0202-http1incomingmessage-and-http1serverresponse-options-of-http2-servers).
  - `Http1ServerResponse` [`<http.ServerResponse>`](http.html#class-httpserverresponse) Specifies the `ServerResponse`
  ...
  - `http1Options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) An options object for configuring the HTTP/1
    ...
    underlying HTTP/1 server. See [`http.createServer()`](http.html#httpcreateserveroptions-requestlistener) for available
    options. Among others, the following are supported:
    - `IncomingMessage` [`<http.IncomingMessage>`](http.html#class-httpincomingmessage) Specifies the `IncomingMessage` class to use for HTTP/1 fallback.
      **Default:** `http.IncomingMessage`.
    - `ServerResponse` [`<http.ServerResponse>`](http.html#class-httpserverresponse) Specifies the `ServerResponse`
    ...
    - `keepAliveTimeout` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) The number of milliseconds of inactivity
      ...
      finished writing the last response, before a socket will be destroyed. **Default:** `5000`.
  - `Http2ServerRequest` [`<http2.Http2ServerRequest>`](http2.html#class-http2http2serverrequest) Specifies the `Http2ServerRequest` class to use.
    Useful for extending the original `Http2ServerRequest`.
    **Default:** `Http2ServerRequest`.
  - `Http2ServerResponse` [`<http2.Http2ServerResponse>`](http2.html#class-http2http2serverresponse) Specifies the `Http2ServerResponse` class to use.
  ...
  - `unknownProtocolTimeout` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Specifies a timeout in milliseconds that
    a server should wait when an [`'unknownProtocol'`](#event-unknownprotocol) is emitted. If the
  ...
  - `strictSingleValueFields` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) If `true`, strict validation is used
    ...
    **Default:** `true`.
  - `...options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) Any [`net.createServer()`](net.html#netcreateserveroptions-connectionlistener) option can be provided.
...
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `allowHTTP1` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) Incoming client connections that do not support
    ...
    See the [`'unknownProtocol'`](#event-unknownprotocol) event. See [ALPN negotiation](#alpn-negotiation).
    **Default:** `false`.
  - `maxDeflateDynamicTableSize` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Sets the maximum dynamic table size
    for deflating header fields. **Default:** `4Kib`.
  - `maxSettings` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Sets the maximum number of settings entries per `SETTINGS` frame. The minimum value allowed is `1`. **Default:** `32`.
  ...
  - `...options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) Any [`tls.createServer()`](tls.html#tlscreateserveroptions-secureconnectionlistener) options can be provided.
  ...
  - `unknownProtocolTimeout` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Specifies a timeout in milliseconds that
    a server should wait when an [`'unknownProtocol'`](#event-unknownprotocol) event is emitted. If
...
- `authority` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) | [`<URL>`](url.html#the-whatwg-url-api) The remote HTTP/2 server to connect to. This must
...
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `maxHeaderListPairs` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Sets the maximum number of header entries.
    ...
    [`request.maxHeadersCount`](http.html#requestmaxheaderscount) in the `node:http` module. The minimum value
    is `1`. **Default:** `128`.
  - `maxOriginSetSize` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Sets the maximum number of uniq origin the sever
  ...
  - `peerMaxConcurrentStreams` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Sets the maximum number of concurrent
    ...
    be overridden if the remote peer sets its own value for
    `maxConcurrentStreams`. **Default:** `100`.
  - `protocol` [`<string>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#string_type) The protocol to connect with, if not set in the `authority`. Value may be either `'http:'` or `'https:'`. **Default:**
    `'https:'`
  - `settings` [`<HTTP/2 Settings Object>`](http2.html#settings-object) The initial settings to send to the
    remote peer upon connection.
  - `remoteCustomSettings` [`<Array>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array) The array of integer values determines the
  ...
  - `createConnection` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) An optional callback that receives the `URL`
    ...
    [`Duplex`](stream.html#class-streamduplex) stream that is to be used as the connection for this session.
  - `...options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) Any [`net.connect()`](net.html#netconnect) or [`tls.connect()`](tls.html#tlsconnectoptions-callback) options
    can be provided.
  - `unknownProtocolTimeout` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Specifies a timeout in milliseconds that
    a server should wait when an [`'unknownProtocol'`](#event-unknownprotocol) event is emitted. If
    the socket has not been destroyed by that time the server will destroy it.
  ...
  - `strictFieldWhitespaceValidation` [`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) If `true`, it turns on strict leading
    ...
    as per [RFC-9113](https://www.rfc-editor.org/rfc/rfc9113.html#section-8.2.1).
    **Default:** `true`.
- `listener` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) Will be registered as a one-time listener of the [`'connect'`](#event-connect) event.
- Returns: [`<ClientHttp2Session>`](http2.html#class-clienthttp2session)
...
- Returns: [`<HTTP/2 Settings Object>`](http2.html#settings-object)
...
- `buf` [`<Buffer>`](buffer.html#class-buffer) | [`<TypedArray>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) The packed settings.
- Returns: [`<HTTP/2 Settings Object>`](http2.html#settings-object)

Returns a [HTTP/2 Settings Object](#settings-object) containing the deserialized settings from
...
- `socket` [`<stream.Duplex>`](stream.html#class-streamduplex)
- `options` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) Any [`http2.createServer()`](#http2createserveroptions-onrequesthandler) option can be provided.
- Returns: [`<ServerHttp2Session>`](http2.html#class-serverhttp2session)
...
- `initialWindowSize` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) Specifies the *sender's* initial window size in
...
- `enableConnectProtocol`[`<boolean>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#boolean_type) Specifies `true` if the "Extended Connect
  Protocol" defined by [RFC 8441](https://tools.ietf.org/html/rfc8441) is to be enabled. This setting is only
...
[RFC 8441](https://tools.ietf.org/html/rfc8441) defines an "Extended CONNECT Protocol" extension to HTTP/2 that
...
that support both [HTTP/1](http.html) and HTTP/2. This API targets only the
...
The HTTP/2 compatibility API is composed of [`Http2ServerRequest`](#class-http2http2serverrequest) and
[`Http2ServerResponse`](#class-http2http2serverresponse). They aim at API compatibility with HTTP/1, but
...
A `Http2ServerRequest` object is created by [`http2.Server`](#class-http2server) or
[`http2.SecureServer`](#class-http2secureserver) and passed as the first argument to the
[`'request'`](#event-request) event. It may be used to access a request status, headers, and
data.
...
Indicates that the underlying [`Http2Stream`](#class-http2stream) was closed.
...
Calls `destroy()` on the [`Http2Stream`](#class-http2stream) that received
the [`Http2ServerRequest`](#class-http2http2serverrequest). If `error` is provided, an `'error'` event
...
See [HTTP/2 Headers Object](#headers-object).
...
- `msecs` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type)
- `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function)
- Returns: [`<http2.Http2ServerRequest>`](http2.html#class-http2http2serverrequest)

Sets the [`Http2Stream`](#class-http2stream)'s timeout value to `msecs`. If a callback is
provided, then it is added as a listener on the `'timeout'` event on
the response object.

If no `'timeout'` listener is added to the request, the response, or
the server, then [`Http2Stream`](#class-http2stream)s are destroyed when they time out. If a
...
use [`request.socket.getPeerCertificate()`](tls.html#tlssocketgetpeercertificatedetailed) to obtain the client's
...
- Type: [`<Http2Stream>`](http2.html#class-http2stream)

The [`Http2Stream`](#class-http2stream) object backing the request.
...
Indicates that the underlying [`Http2Stream`](#class-http2stream) was terminated before
[`response.end()`](#responseenddata-encoding-callback) was called or able to flush.
...
- `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function) Called once `http2stream.pushStream()` is finished,
  ...
  - `err` [`<Error>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Error)
  - `res` [`<http2.Http2ServerResponse>`](http2.html#class-http2http2serverresponse) The newly-created `Http2ServerResponse`
    object

Call [`http2stream.pushStream()`](#http2streampushstreamheaders-options-callback) with the given headers, and wrap the
given [`Http2Stream`](#class-http2stream) on a newly created `Http2ServerResponse` as the callback
...
[`response.write(data, encoding)`](http.html#responsewritechunk-encoding-callback) followed by `response.end(callback)`.
...
as `false`. After [`response.end()`](#responseenddata-encoding-callback) executes, the value will be `true`.
...
- Type: [`<http2.Http2ServerRequest>`](http2.html#class-http2http2serverrequest)
...
- `msecs` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type)
- `callback` [`<Function>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function)
- Returns: [`<http2.Http2ServerResponse>`](http2.html#class-http2http2serverresponse)
...
The [`Http2Stream`](#class-http2stream) object backing the response.
...
[`writable.writableFinished`](stream.html#writablewritablefinished) instead.
...
should be sent. See the [`'checkContinue'`](#event-checkcontinue) event on `Http2Server` and
`Http2SecureServer`.
...
- `statusCode` [`<number>`](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#number_type) An HTTP 1xx informational status code, between `100`
  ...
  allowed in HTTP/2.
- `headers` [`<Object>`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object) An optional object of headers to send with the
...
This is the generic equivalent of [`response.writeContinue()`](#responsewritecontinue) and
...
For compatibility with [HTTP/1](http.html), a human-readable `statusMessage` may be
...
[`response.end()`](#responseenddata-encoding-callback) is called.
...
### Collecting HTTP/2 performance metrics[#](#collecting-http2-performance-metrics)

The [Performance Observer](perf_hooks.html) API can be used to collect basic performance
...
present. See [`request.authority`](#requestauthority) for more information. However,
