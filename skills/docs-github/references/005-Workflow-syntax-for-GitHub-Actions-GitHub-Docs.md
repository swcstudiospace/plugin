...
## [`jobs.<job_id>.steps[*].background`](#jobsjob_idstepsbackground)
...
### [Example: Running a step in the background](#example-running-a-step-in-the-background)
...
## [`jobs.<job_id>.steps[*].wait`](#jobsjob_idstepswait)
...
### [Example: Waiting for specific background steps](#example-waiting-for-specific-background-steps)
...
## [`jobs.<job_id>.steps[*].wait-all`](#jobsjob_idstepswait-all)
...
### [Example: Waiting for all background steps](#example-waiting-for-all-background-steps)
...
## [`jobs.<job_id>.steps[*].cancel`](#jobsjob_idstepscancel)
...
### [Example: Canceling a background step](#example-canceling-a-background-step)
...
## [`jobs.<job_id>.steps[*].parallel`](#jobsjob_idstepsparallel)
...
### [Example: Running steps in parallel](#example-running-steps-in-parallel)
