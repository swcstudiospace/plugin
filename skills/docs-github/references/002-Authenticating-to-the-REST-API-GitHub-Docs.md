...
### [Personal access tokens and SAML SSO](#personal-access-tokens-and-saml-sso)
...
## [Authenticating with a token generated by an app](#authenticating-with-a-token-generated-by-an-app)
...
### [Authenticating in a GitHub Actions workflow using GitHub CLI](#authenticating-in-a-github-actions-workflow-using-github-cli)
...
### [Authenticating in a GitHub Actions workflow using `curl`](#authenticating-in-a-github-actions-workflow-using-curl)
...
### [Authenticating in a GitHub Actions workflow using JavaScript](#authenticating-in-a-github-actions-workflow-using-javascript)
