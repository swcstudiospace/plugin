...
![Diagram of the two branches. The "feature" branch diverges from the "main" branch and is then merged back into main.](/assets/cb-23923/images/help/repository/branching.png)
...
2. Above the file list, click the dropdown menu that says **main**.
   ...
   ![Screenshot of the repository page. A dropdown menu, labeled with a branch icon and "main", is highlighted with an orange outline.](/assets/cb-16584/images/help/branches/branch-selection-dropdown-global-nav-update.png)
3. Type a branch name, `readme-edits`, into the text box.
4. Click **Create branch: readme-edits from main**.

   ![Screenshot of the branch dropdown for a repository. "Create branch: readme-edits from 'main'" is outlined in dark orange.](/assets/cb-31023/images/help/repository/new-branch.png)
...
## [Step 3: Make and commit changes](#step-3-make-and-commit-changes)
...
4. Look over your changes in the diffs on the Compare page, make sure they're what you want to submit.
   ...
   ![Screenshot of a diff for the README.md file. 3 red lines list the text that's being removed, and 3 green lines list the text being added.](/assets/cb-32937/images/help/repository/diffs.png)
