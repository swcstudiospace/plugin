...
## [Determining the location of your license](#determining-the-location-of-your-license)
...
## [Searching GitHub by license type](#searching-github-by-license-type)
...
## [Detecting a license](#detecting-a-license)
...
## [Applying a license to a repository with an existing license](#applying-a-license-to-a-repository-with-an-existing-license)

The license picker is only available when you create a new project on GitHub.

![Screenshot the "Choose a license" section of the new repository page, including a dropdown menu labeled "License."](/assets/cb-13570/images/help/repository/repository-license-picker.png)
