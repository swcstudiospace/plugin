...
Supported Versions:
[Current](/docs/current/sql-merge.html "PostgreSQL 18 - MERGE")
([18](/docs/18/sql-merge.html "PostgreSQL 18 - MERGE"))
/
[17](/docs/17/sql-merge.html "PostgreSQL 17 - MERGE")
/
[16](/docs/16/sql-merge.html "PostgreSQL 16 - MERGE")
/
[15](/docs/15/sql-merge.html "PostgreSQL 15 - MERGE")

Development Versions:
[19](/docs/19/sql-merge.html "PostgreSQL 19 - MERGE")
/
...
*`with_query`*
:   The `WITH` clause allows you to specify one or more subqueries that can be referenced by name in the `MERGE` query. See [Section 7.8](queries-with.html "7.8. WITH Queries (Common Table Expressions)") and [SELECT](sql-select.html "SELECT") for details. Note that `WITH RECURSIVE` is not supported by `MERGE`.
...
*`source_query`*
:   A query (`SELECT` statement or `VALUES` statement) that supplies the rows to be merged into the target table. Refer to the [SELECT](sql-select.html "SELECT") statement or [VALUES](sql-values.html "VALUES") statement for a description of the syntax.
...
*`merge_delete`*
:   Specifies a `DELETE` action that deletes the current row of the target table. Do not include the table name or any other clauses, as you would normally do with a [DELETE](sql-delete.html "DELETE") command.
...
please use
[this form](/account/comments/new/18/sql-merge.html/)
