# PostgreSQL: Documentation: 18: 58.5. Row Locking in Foreign Data Wrappers

Source: https://www.postgresql.org/docs/current/fdw-row-locking.html
...
Supported Versions:
[Current](/docs/current/fdw-row-locking.html "PostgreSQL 18 - 58.5. Row Locking in Foreign Data Wrappers")
([18](/docs/18/fdw-row-locking.html "PostgreSQL 18 - 58.5. Row Locking in Foreign Data Wrappers"))
/
[17](/docs/17/fdw-row-locking.html "PostgreSQL 17 - 58.5. Row Locking in Foreign Data Wrappers")
/
[16](/docs/16/fdw-row-locking.html "PostgreSQL 16 - 58.5. Row Locking in Foreign Data Wrappers")
/
[15](/docs/15/fdw-row-locking.html "PostgreSQL 15 - 58.5. Row Locking in Foreign Data Wrappers")
/
[14](/docs/14/fdw-row-locking.html "PostgreSQL 14 - 58.5. Row Locking in Foreign Data Wrappers")

Development Versions:
[19](/docs/19/fdw-row-locking.html "PostgreSQL 19 - 58.5. Row Locking in Foreign Data Wrappers")
/
[devel](/docs/devel/fdw-row-locking.html "PostgreSQL devel - 58.5. Row Locking in Foreign Data Wrappers")

Unsupported versions:
[13](/docs/13/fdw-row-locking.html "PostgreSQL 13 - 58.5. Row Locking in Foreign Data Wrappers")
/
[12](/docs/12/fdw-row-locking.html "PostgreSQL 12 - 58.5. Row Locking in Foreign Data Wrappers")
/
[11](/docs/11/fdw-row-locking.html "PostgreSQL 11 - 58.5. Row Locking in Foreign Data Wrappers")
/
[10](/docs/10/fdw-row-locking.html "PostgreSQL 10 - 58.5. Row Locking in Foreign Data Wrappers")
/
[9.6](/docs/9.6/fdw-row-locking.html "PostgreSQL 9.6 - 58.5. Row Locking in Foreign Data Wrappers")
/
[9.5](/docs/9.5/fdw-row-locking.html "PostgreSQL 9.5 - 58.5. Row Locking in Foreign Data Wrappers")
...
please use
[this form](/account/comments/new/18/fdw-row-locking.html/)
