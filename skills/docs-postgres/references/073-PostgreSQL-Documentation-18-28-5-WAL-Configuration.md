...
Supported Versions:
[Current](/docs/current/wal-configuration.html "PostgreSQL 18 - 28.5. WAL Configuration")
([18](/docs/18/wal-configuration.html "PostgreSQL 18 - 28.5. WAL Configuration"))
/
[17](/docs/17/wal-configuration.html "PostgreSQL 17 - 28.5. WAL Configuration")
/
[16](/docs/16/wal-configuration.html "PostgreSQL 16 - 28.5. WAL Configuration")
/
[15](/docs/15/wal-configuration.html "PostgreSQL 15 - 28.5. WAL Configuration")
/
[14](/docs/14/wal-configuration.html "PostgreSQL 14 - 28.5. WAL Configuration")

Development Versions:
[19](/docs/19/wal-configuration.html "PostgreSQL 19 - 28.5. WAL Configuration")
/
[devel](/docs/devel/wal-configuration.html "PostgreSQL devel - 28.5. WAL Configuration")

Unsupported versions:
[13](/docs/13/wal-configuration.html "PostgreSQL 13 - 28.5. WAL Configuration")
/
[12](/docs/12/wal-configuration.html "PostgreSQL 12 - 28.5. WAL Configuration")
/
[11](/docs/11/wal-configuration.html "PostgreSQL 11 - 28.5. WAL Configuration")
/
[10](/docs/10/wal-configuration.html "PostgreSQL 10 - 28.5. WAL Configuration")
/
[9.6](/docs/9.6/wal-configuration.html "PostgreSQL 9.6 - 28.5. WAL Configuration")
/
[9.5](/docs/9.5/wal-configuration.html "PostgreSQL 9.5 - 28.5. WAL Configuration")
/
[9.4](/docs/9.4/wal-configuration.html "PostgreSQL 9.4 - 28.5. WAL Configuration")
/
[9.3](/docs/9.3/wal-configuration.html "PostgreSQL 9.3 - 28.5. WAL Configuration")
/
[9.2](/docs/9.2/wal-configuration.html "PostgreSQL 9.2 - 28.5. WAL Configuration")
/
[9.1](/docs/9.1/wal-configuration.html "PostgreSQL 9.1 - 28.5. WAL Configuration")
/
[9.0](/docs/9.0/wal-configuration.html "PostgreSQL 9.0 - 28.5. WAL Configuration")
/
[8.4](/docs/8.4/wal-configuration.html "PostgreSQL 8.4 - 28.5. WAL Configuration")
/
[8.3](/docs/8.3/wal-configuration.html "PostgreSQL 8.3 - 28.5. WAL Configuration")
/
[8.2](/docs/8.2/wal-configuration.html "PostgreSQL 8.2 - 28.5. WAL Configuration")
/
[8.1](/docs/8.1/wal-configuration.html "PostgreSQL 8.1 - 28.5. WAL Configuration")
/
[8.0](/docs/8.0/wal-configuration.html "PostgreSQL 8.0 - 28.5. WAL Configuration")
/
[7.4](/docs/7.4/wal-configuration.html "PostgreSQL 7.4 - 28.5. WAL Configuration")
/
[7.3](/docs/7.3/wal-configuration.html "PostgreSQL 7.3 - 28.5. WAL Configuration")
/
[7.2](/docs/7.2/wal-configuration.html "PostgreSQL 7.2 - 28.5. WAL Configuration")
/
[7.1](/docs/7.1/wal-configuration.html "PostgreSQL 7.1 - 28.5. WAL Configuration")

## 28.5. WAL Configuration [#](#WAL-CONFIGURATION)

There are several WAL-related configuration parameters that affect database performance. This section explains their use. Consult [Chapter 19](runtime-config.html "Chapter 19. Server Configuration") for general information about setting server configuration parameters.
...
please use
[this form](/account/comments/new/18/wal-configuration.html/)
