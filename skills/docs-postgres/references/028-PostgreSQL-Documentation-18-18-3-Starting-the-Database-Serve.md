...
Supported Versions:
[Current](/docs/current/server-start.html "PostgreSQL 18 - 18.3. Starting the Database Server")
([18](/docs/18/server-start.html "PostgreSQL 18 - 18.3. Starting the Database Server"))
/
[17](/docs/17/server-start.html "PostgreSQL 17 - 18.3. Starting the Database Server")
/
[16](/docs/16/server-start.html "PostgreSQL 16 - 18.3. Starting the Database Server")
/
[15](/docs/15/server-start.html "PostgreSQL 15 - 18.3. Starting the Database Server")
/
[14](/docs/14/server-start.html "PostgreSQL 14 - 18.3. Starting the Database Server")

Development Versions:
[19](/docs/19/server-start.html "PostgreSQL 19 - 18.3. Starting the Database Server")
/
[devel](/docs/devel/server-start.html "PostgreSQL devel - 18.3. Starting the Database Server")

Unsupported versions:
[13](/docs/13/server-start.html "PostgreSQL 13 - 18.3. Starting the Database Server")
/
[12](/docs/12/server-start.html "PostgreSQL 12 - 18.3. Starting the Database Server")
/
[11](/docs/11/server-start.html "PostgreSQL 11 - 18.3. Starting the Database Server")
/
[10](/docs/10/server-start.html "PostgreSQL 10 - 18.3. Starting the Database Server")
/
[9.6](/docs/9.6/server-start.html "PostgreSQL 9.6 - 18.3. Starting the Database Server")
/
[9.5](/docs/9.5/server-start.html "PostgreSQL 9.5 - 18.3. Starting the Database Server")
/
[9.4](/docs/9.4/server-start.html "PostgreSQL 9.4 - 18.3. Starting the Database Server")
/
[9.3](/docs/9.3/server-start.html "PostgreSQL 9.3 - 18.3. Starting the Database Server")
/
[9.2](/docs/9.2/server-start.html "PostgreSQL 9.2 - 18.3. Starting the Database Server")
/
[9.1](/docs/9.1/server-start.html "PostgreSQL 9.1 - 18.3. Starting the Database Server")
/
[9.0](/docs/9.0/server-start.html "PostgreSQL 9.0 - 18.3. Starting the Database Server")
/
[8.4](/docs/8.4/server-start.html "PostgreSQL 8.4 - 18.3. Starting the Database Server")
/
[8.3](/docs/8.3/server-start.html "PostgreSQL 8.3 - 18.3. Starting the Database Server")
/
[8.2](/docs/8.2/server-start.html "PostgreSQL 8.2 - 18.3. Starting the Database Server")

## 18.3. Starting the Database Server [#](#SERVER-START)

[18.3.1. Server Start-up Failures](server-start.html#SERVER-START-FAILURES)

[18.3.2. Client Connection Problems](server-start.html#CLIENT-CONNECTION-PROBLEMS)
...
It is important to store the server's stdout and stderr output somewhere, as shown above. It will help for auditing purposes and to diagnose problems. (See [Section 24.3](logfile-maintenance.html "24.3. Log File Maintenance") for a more thorough discussion of log file handling.)

The `postgres` program also takes a number of other command-line options. For more information, see the [postgres](app-postgres.html "postgres") reference page and [Chapter 19](runtime-config.html "Chapter 19. Server Configuration") below.
...
Details about configuring System V IPC facilities are given in [Section 18.4.1](kernel-resources.html#SYSVIPC "18.4.1. Shared Memory and Semaphores").
...
This is the generic “I couldn't find a server to talk to” failure. It looks like the above when TCP/IP communication is attempted. A common mistake is to forget to configure [listen\_addresses](runtime-config-connection.html#GUC-LISTEN-ADDRESSES) so that the server accepts remote TCP connections.
...
please use
[this form](/account/comments/new/18/server-start.html/)
