...
Supported Versions:
[Current](/docs/current/extend-pgxs.html "PostgreSQL 18 - 36.18. Extension Building Infrastructure")
([18](/docs/18/extend-pgxs.html "PostgreSQL 18 - 36.18. Extension Building Infrastructure"))
/
[17](/docs/17/extend-pgxs.html "PostgreSQL 17 - 36.18. Extension Building Infrastructure")
/
[16](/docs/16/extend-pgxs.html "PostgreSQL 16 - 36.18. Extension Building Infrastructure")
/
[15](/docs/15/extend-pgxs.html "PostgreSQL 15 - 36.18. Extension Building Infrastructure")
/
[14](/docs/14/extend-pgxs.html "PostgreSQL 14 - 36.18. Extension Building Infrastructure")

Development Versions:
[19](/docs/19/extend-pgxs.html "PostgreSQL 19 - 36.18. Extension Building Infrastructure")
/
[devel](/docs/devel/extend-pgxs.html "PostgreSQL devel - 36.18. Extension Building Infrastructure")

Unsupported versions:
[13](/docs/13/extend-pgxs.html "PostgreSQL 13 - 36.18. Extension Building Infrastructure")
/
[12](/docs/12/extend-pgxs.html "PostgreSQL 12 - 36.18. Extension Building Infrastructure")
/
[11](/docs/11/extend-pgxs.html "PostgreSQL 11 - 36.18. Extension Building Infrastructure")
/
[10](/docs/10/extend-pgxs.html "PostgreSQL 10 - 36.18. Extension Building Infrastructure")
/
[9.6](/docs/9.6/extend-pgxs.html "PostgreSQL 9.6 - 36.18. Extension Building Infrastructure")
/
[9.5](/docs/9.5/extend-pgxs.html "PostgreSQL 9.5 - 36.18. Extension Building Infrastructure")
/
[9.4](/docs/9.4/extend-pgxs.html "PostgreSQL 9.4 - 36.18. Extension Building Infrastructure")
/
[9.3](/docs/9.3/extend-pgxs.html "PostgreSQL 9.3 - 36.18. Extension Building Infrastructure")
/
[9.2](/docs/9.2/extend-pgxs.html "PostgreSQL 9.2 - 36.18. Extension Building Infrastructure")
/
[9.1](/docs/9.1/extend-pgxs.html "PostgreSQL 9.1 - 36.18. Extension Building Infrastructure")
...
then `postgresql` will be appended to the directory names, installing the control and SQL files into `/usr/local/extras/share/postgresql/extension` and the shared modules into `/usr/local/extras/lib/postgresql`. Either way, you'll need to set [extension\_control\_path](runtime-config-client.html#GUC-EXTENSION-CONTROL-PATH) and [dynamic\_library\_path](runtime-config-client.html#GUC-DYNAMIC-LIBRARY-PATH) to enable the PostgreSQL server to find the files:
...
`TAP_TESTS` enables the use of TAP tests. Data from each run is present in a subdirectory named `tmp_check/`. See also [Section 31.4](regress-tap.html "31.4. TAP Tests") for more details.
...
please use
[this form](/account/comments/new/18/extend-pgxs.html/)
