...
```
```tsx filename="\_\_tests\_\_/page.test.tsx" switcher
...
```
```jsx filename="\_\_tests\_\_/page.test.jsx" switcher
import { expect, test } from 'vitest'
import { render, screen } from '@testing-library/react'
import Page from '../app/page'
test('Page', () => {
...
```
> \*\*Good to know\*\*: The example above uses the common `\_\_tests\_\_` convention, but test files can also be colocated inside the `app` router.
## Running your tests
