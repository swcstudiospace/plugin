...
| `auth` | Optional | Value of authentication parameter (`gtm\_auth`) for environment snippets. |
| `preview` | Optional | Value of preview parameter (`gtm\_preview`) for environment snippets. |
...
Measurement”\*](https://support.google.com/analytics/answer/9216061#enable\_disable) property is
...
> documentation](https://developers.google.com/analytics/devguides/collection/ga4/views?client\_type=gtag#manual\_pageviews)
> to learn more.
#### Options
...
| `mode` | Required | [Map mode](https://developers.google.com/maps/documentation/embed/embedding-map#choosing\_map\_modes) |
...
| `params` | Optional | The video player params defined [here](https://developers.google.com/youtube/player\_parameters#Parameters). Params are passed as a query param string. Eg: `params="controls=0&start=10&end=30"` |
