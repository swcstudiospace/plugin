...
\* Use a data lookup strategy such as a [Bloom filter](https://en.wikipedia.org/wiki/Bloom\_filter) to efficiently check if a redirect exists \*\*before\*\* reading the larger redirects file or database.
