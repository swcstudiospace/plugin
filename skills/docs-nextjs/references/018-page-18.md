...
process.env.NEXT\_PUBLIC\_VAPID\_PUBLIC\_KEY!
),
})
setSubscription(sub)
...
```
NEXT\_PUBLIC\_VAPID\_PUBLIC\_KEY=your\_public\_key\_here
VAPID\_PRIVATE\_KEY=your\_private\_key\_here
```
