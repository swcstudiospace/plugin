...
In VS Code 1.88+ or Cursor, add [custom editor labels](https://code.visualstudio.com/updates/v1\_88#\_customize-editor-labels) to `.vscode/settings.json`. Labeling two folders deep keeps dynamic routes like `blog/[id]/page.tsx` from all collapsing to the same `[id]` label:
